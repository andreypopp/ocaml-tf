...
let _ = fun (_ : kubernetes_horizontal_pod_autoscaler_v2) -> ()

let yojson_of_kubernetes_horizontal_pod_autoscaler_v2 =
  (function
...
let _ = yojson_of_kubernetes_horizontal_pod_autoscaler_v2
...
let kubernetes_horizontal_pod_autoscaler_v2 ?id ~metadata ~spec () :
    kubernetes_horizontal_pod_autoscaler_v2 =
  { id; metadata; spec }
...
let make ?id ~metadata ~spec __id =
  let __type = "kubernetes_horizontal_pod_autoscaler_v2" in
  let __attrs =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_kubernetes_horizontal_pod_autoscaler_v2
        (kubernetes_horizontal_pod_autoscaler_v2 ?id ~metadata ~spec
           ());
    attrs = __attrs;
  }
