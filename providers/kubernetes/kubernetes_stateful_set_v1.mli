...
val spec__persistent_volume_claim_retention_policy :
  ?when_deleted:string prop ->
  ?when_scaled:string prop ->
  unit ->
...
val spec__update_strategy__rolling_update :
  ?partition:float prop ->
  unit ->
...
val spec__volume_claim_template__metadata :
  ?annotations:(string * string prop) list ->
  ?generate_name:string prop ->
  ?labels:(string * string prop) list ->
  ?name:string prop ->
...
val spec__volume_claim_template__spec__resources :
  ?limits:(string * string prop) list ->
  ?requests:(string * string prop) list ->
  unit ->
...
val spec__volume_claim_template__spec__selector__match_expressions :
  ?key:string prop ->
  ?operator:string prop ->
  ?values:string prop list ->
  unit ->
...
val spec__volume_claim_template__spec__selector :
  ?match_labels:(string * string prop) list ->
  ?match_expressions:
    spec__volume_claim_template__spec__selector__match_expressions
    list ->
...
val spec__volume_claim_template__spec :
  ?storage_class_name:string prop ->
  ?volume_mode:string prop ->
  ?volume_name:string prop ->
...
val spec__volume_claim_template :
...
val spec :
  ?pod_management_policy:string prop ->
  ?replicas:string prop ->
  ?revision_history_limit:float prop ->
...
val kubernetes_stateful_set_v1 :
  ?id:string prop ->
...
val yojson_of_kubernetes_stateful_set_v1 :
  kubernetes_stateful_set_v1 -> json
