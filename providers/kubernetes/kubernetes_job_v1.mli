...
val spec__pod_failure_policy__rule__on_exit_codes :
...
val spec__pod_failure_policy__rule__on_pod_condition :
  ?status:string prop ->
  ?type_:string prop ->
  unit ->
...
val spec__pod_failure_policy__rule :
  ?action:string prop ->
...
val spec__pod_failure_policy :
  rule:spec__pod_failure_policy__rule list ->
  unit ->
  spec__pod_failure_policy
...
val yojson_of_kubernetes_job_v1 : kubernetes_job_v1 -> json
