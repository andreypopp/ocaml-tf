...
let _ =
 fun (_ : kubernetes_validating_webhook_configuration_v1) -> ()

let yojson_of_kubernetes_validating_webhook_configuration_v1 =
  (function
...
let _ = yojson_of_kubernetes_validating_webhook_configuration_v1
  ...
  in
  {
    ...
    json =
      yojson_of_kubernetes_validating_webhook_configuration_v1
        (kubernetes_validating_webhook_configuration_v1 ?id ~metadata
           ~webhook ());
    attrs = __attrs;
  }
