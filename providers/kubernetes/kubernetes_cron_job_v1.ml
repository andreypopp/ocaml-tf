  ...
  (function
   | {
       ...
       let bnds =
         let arg =
           yojson_of_list
             yojson_of_spec__job_template__spec__template v_template
         in
         ("template", arg) :: bnds
       in
       let bnds =
         let arg =
           yojson_of_list
             yojson_of_spec__job_template__spec__selector v_selector
         in
         ("selector", arg) :: bnds
       in
       let bnds =
...
let yojson_of_spec__job_template =
  (function
   | { metadata = v_metadata; spec = v_spec } ->
       ...
       let bnds =
         let arg =
           yojson_of_list yojson_of_spec__job_template__spec v_spec
         in
         ("spec", arg) :: bnds
       in
       let bnds =
...
let yojson_of_spec =
  (function
   | {
       ...
       let bnds =
         let arg =
           yojson_of_list yojson_of_spec__job_template v_job_template
         in
         ("job_template", arg) :: bnds
       in
       let bnds =
...
let _ = fun (_ : kubernetes_cron_job_v1) -> ()

let yojson_of_kubernetes_cron_job_v1 =
  (function
   | {
       id = v_id;
       metadata = v_metadata;
       ...
       in
       `Assoc bnds
    : kubernetes_cron_job_v1 -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_kubernetes_cron_job_v1
...
let spec ?concurrency_policy ?failed_jobs_history_limit
    ...
    ?suspend ?timezone ~schedule ~job_template () : spec =
  {
    concurrency_policy;
...
let make ?id ?timeouts ~metadata ~spec __id =
  let __type = "kubernetes_cron_job_v1" in
  let __attrs = ({ id = Prop.computed __type __id "id" } : t) in
  {
    Tf_core.id = __id;
    type_ = __type;
    json =
      yojson_of_kubernetes_cron_job_v1
        (kubernetes_cron_job_v1 ?id ?timeouts ~metadata ~spec ());
    attrs = __attrs;
  }
