...
[@@deriving yojson_of]
(** kubernetes_ingress_class_v1__spec__parameters *)
...
type kubernetes_ingress_class_v1__spec = {
  ...
  parameters : kubernetes_ingress_class_v1__spec__parameters list;
}
[@@deriving yojson_of]
...
let kubernetes_ingress_class_v1 ?id ~metadata ~spec __resource_id =
  let __resource_type = "kubernetes_ingress_class_v1" in
  let __resource =
    ({ id; metadata; spec } : kubernetes_ingress_class_v1)
  in
  Resource.add ~type_:__resource_type ~id:__resource_id
    (yojson_of_kubernetes_ingress_class_v1 __resource);
