...
let _ = fun (_ : kubernetes_stateful_set) -> ()

let yojson_of_kubernetes_stateful_set =
  (function
   | {
       id = v_id;
       ...
       in
       `Assoc bnds
    : kubernetes_stateful_set -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_kubernetes_stateful_set
