...
let _ = fun (_ : kubernetes_validating_webhook_configuration) -> ()

let yojson_of_kubernetes_validating_webhook_configuration =
  (function
...
let _ = yojson_of_kubernetes_validating_webhook_configuration
...
let make ?id ~metadata ~webhook __id =
  let __type = "kubernetes_validating_webhook_configuration" in
  let __attrs =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_kubernetes_validating_webhook_configuration
