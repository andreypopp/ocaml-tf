...
type spec__persistent_volume_claim_retention_policy = {
...
let _ =
 fun (_ : spec__persistent_volume_claim_retention_policy) -> ()

let yojson_of_spec__persistent_volume_claim_retention_policy =
  (function
   | { when_deleted = v_when_deleted; when_scaled = v_when_scaled }
     ->
       let bnds : (string * Ppx_yojson_conv_lib.Yojson.Safe.t) list =
         []
       in
       let bnds =
         match v_when_scaled with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "when_scaled", arg in
             bnd :: bnds
       in
       let bnds =
         match v_when_deleted with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "when_deleted", arg in
             bnd :: bnds
       in
       `Assoc bnds
    : spec__persistent_volume_claim_retention_policy ->
      Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_spec__persistent_volume_claim_retention_policy
   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_port then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__template__spec__container__port)
               v_port
           in
           let bnd = "port", arg in
           bnd :: bnds
       ...
       let bnds =
         if Stdlib.( = ) [] v_env then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__template__spec__container__env)
               v_env
           in
           let bnd = "env", arg in
           bnd :: bnds
   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_secret then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__template__spec__volume__secret)
               v_secret
           in
           let bnd = "secret", arg in
           bnd :: bnds
       ...
       let bnds =
         if Stdlib.( = ) [] v_rbd then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__template__spec__volume__rbd)
               v_rbd
           in
           let bnd = "rbd", arg in
           bnd :: bnds
       ...
       let bnds =
         if Stdlib.( = ) [] v_nfs then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__template__spec__volume__nfs)
               v_nfs
           in
           let bnd = "nfs", arg in
           bnd :: bnds
       ...
       let bnds =
         if Stdlib.( = ) [] v_local then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__template__spec__volume__local)
               v_local
           in
       ...
       let bnds =
         if Stdlib.( = ) [] v_iscsi then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__template__spec__volume__iscsi)
               v_iscsi
           in
       ...
       let bnds =
         if Stdlib.( = ) [] v_fc then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__template__spec__volume__fc)
               v_fc
           in
           let bnd = "fc", arg in
           bnd :: bnds
       ...
       let bnds =
         if Stdlib.( = ) [] v_csi then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__template__spec__volume__csi)
               v_csi
           in
           let bnd = "csi", arg in
           bnd :: bnds
       ...
       let bnds =
         if Stdlib.( = ) [] v_cinder then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__template__spec__volume__cinder)
               v_cinder
           in
   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_toleration then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__template__spec__toleration)
               v_toleration
           in
       ...
       let bnds =
         if Stdlib.( = ) [] v_dns_config then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__template__spec__dns_config)
               v_dns_config
           in
       ...
       let bnds =
         if Stdlib.( = ) [] v_container then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__template__spec__container)
               v_container
           in
...
type spec__update_strategy__rolling_update = {
  partition : float prop option; [@option]
}
[@@deriving_inline yojson_of]

let _ = fun (_ : spec__update_strategy__rolling_update) -> ()

let yojson_of_spec__update_strategy__rolling_update =
  (function
   | { partition = v_partition } ->
       let bnds : (string * Ppx_yojson_conv_lib.Yojson.Safe.t) list =
         []
       ...
       in
       `Assoc bnds
    : spec__update_strategy__rolling_update ->
      Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_spec__update_strategy__rolling_update

[@@@deriving.end]

type spec__update_strategy = {
  type_ : string prop option; [@option] [@key "type"]
  rolling_update : spec__update_strategy__rolling_update list;
      [@default []] [@yojson_drop_default Stdlib.( = )]
}
[@@deriving_inline yojson_of]

let _ = fun (_ : spec__update_strategy) -> ()

let yojson_of_spec__update_strategy =
  (function
   | { type_ = v_type_; rolling_update = v_rolling_update } ->
       let bnds : (string * Ppx_yojson_conv_lib.Yojson.Safe.t) list =
         []
       in
       let bnds =
         if Stdlib.( = ) [] v_rolling_update then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_spec__update_strategy__rolling_update)
               v_rolling_update
           in
           let bnd = "rolling_update", arg in
           bnd :: bnds
       in
       let bnds =
         match v_type_ with
       ...
       in
       `Assoc bnds
    : spec__update_strategy -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_spec__update_strategy

[@@@deriving.end]

type spec__volume_claim_template__metadata = {
  annotations : string prop Tf_core.assoc option; [@option]
  generate_name : string prop option; [@option]
  labels : string prop Tf_core.assoc option; [@option]
  name : string prop option; [@option]
...
let _ = fun (_ : spec__volume_claim_template__metadata) -> ()

let yojson_of_spec__volume_claim_template__metadata =
  (function
   | {
       annotations = v_annotations;
       generate_name = v_generate_name;
       ...
       in
       `Assoc bnds
    : spec__volume_claim_template__metadata ->
      Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_spec__volume_claim_template__metadata

[@@@deriving.end]

type spec__volume_claim_template__spec__resources = {
  limits : string prop Tf_core.assoc option; [@option]
  requests : string prop Tf_core.assoc option; [@option]
}
[@@deriving_inline yojson_of]

let _ = fun (_ : spec__volume_claim_template__spec__resources) -> ()

let yojson_of_spec__volume_claim_template__spec__resources =
  (function
   | { limits = v_limits; requests = v_requests } ->
       let bnds : (string * Ppx_yojson_conv_lib.Yojson.Safe.t) list =
         []
       ...
       in
       `Assoc bnds
    : spec__volume_claim_template__spec__resources ->
      Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_spec__volume_claim_template__spec__resources

[@@@deriving.end]

type spec__volume_claim_template__spec__selector__match_expressions = {
  key : string prop option; [@option]
  operator : string prop option; [@option]
  values : string prop list option; [@option]
}
...
let _ =
 fun (_ :
       spec__volume_claim_template__spec__selector__match_expressions) ->
  ()

let yojson_of_spec__volume_claim_template__spec__selector__match_expressions
    =
  (function
   | { key = v_key; operator = v_operator; values = v_values } ->
       let bnds : (string * Ppx_yojson_conv_lib.Yojson.Safe.t) list =
...
let _ =
  yojson_of_spec__volume_claim_template__spec__selector__match_expressions

[@@@deriving.end]

type spec__volume_claim_template__spec__selector = {
  match_labels : string prop Tf_core.assoc option; [@option]
  match_expressions :
    spec__volume_claim_template__spec__selector__match_expressions
    list;
...
let _ = fun (_ : spec__volume_claim_template__spec__selector) -> ()

let yojson_of_spec__volume_claim_template__spec__selector =
  (function
   | {
       match_labels = v_match_labels;
       match_expressions = v_match_expressions;
       ...
       in
       `Assoc bnds
    : spec__volume_claim_template__spec__selector ->
      Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_spec__volume_claim_template__spec__selector

[@@@deriving.end]

type spec__volume_claim_template__spec = {
  access_modes : string prop list;
      [@default []] [@yojson_drop_default Stdlib.( = )]
  storage_class_name : string prop option; [@option]
  volume_mode : string prop option; [@option]
  volume_name : string prop option; [@option]
  resources : spec__volume_claim_template__spec__resources list;
      [@default []] [@yojson_drop_default Stdlib.( = )]
  selector : spec__volume_claim_template__spec__selector list;
      [@default []] [@yojson_drop_default Stdlib.( = )]
}
[@@deriving_inline yojson_of]

let _ = fun (_ : spec__volume_claim_template__spec) -> ()

let yojson_of_spec__volume_claim_template__spec =
  (function
   | {
       access_modes = v_access_modes;
       storage_class_name = v_storage_class_name;
       ...
       let bnds =
         if Stdlib.( = ) [] v_selector then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__volume_claim_template__spec__selector)
               v_selector
           in
           let bnd = "selector", arg in
           bnd :: bnds
       ...
       let bnds =
         if Stdlib.( = ) [] v_resources then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__volume_claim_template__spec__resources)
               v_resources
           in
           let bnd = "resources", arg in
           bnd :: bnds
       ...
       in
       `Assoc bnds
    : spec__volume_claim_template__spec ->
      Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_spec__volume_claim_template__spec

[@@@deriving.end]

type spec__volume_claim_template = {
  metadata : spec__volume_claim_template__metadata list;
      [@default []] [@yojson_drop_default Stdlib.( = )]
  spec : spec__volume_claim_template__spec list;
      [@default []] [@yojson_drop_default Stdlib.( = )]
}
[@@deriving_inline yojson_of]

let _ = fun (_ : spec__volume_claim_template) -> ()

let yojson_of_spec__volume_claim_template =
  (function
   | { metadata = v_metadata; spec = v_spec } ->
       let bnds : (string * Ppx_yojson_conv_lib.Yojson.Safe.t) list =
         []
       ...
       let bnds =
         if Stdlib.( = ) [] v_spec then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__volume_claim_template__spec)
               v_spec
           in
           let bnd = "spec", arg in
           bnd :: bnds
       ...
       let bnds =
         if Stdlib.( = ) [] v_metadata then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_spec__volume_claim_template__metadata)
               v_metadata
           in
           let bnd = "metadata", arg in
           bnd :: bnds
       in
       `Assoc bnds
    : spec__volume_claim_template ->
      Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_spec__volume_claim_template
...
type spec = {
  ...
  persistent_volume_claim_retention_policy :
    spec__persistent_volume_claim_retention_policy list;
      [@default []] [@yojson_drop_default Stdlib.( = )]
  selector : spec__selector list;
      [@default []] [@yojson_drop_default Stdlib.( = )]
  template : spec__template list;
      [@default []] [@yojson_drop_default Stdlib.( = )]
  update_strategy : spec__update_strategy list;
      [@default []] [@yojson_drop_default Stdlib.( = )]
  volume_claim_template : spec__volume_claim_template list;
      [@default []] [@yojson_drop_default Stdlib.( = )]
}
[@@deriving_inline yojson_of]
...
let yojson_of_spec =
  (function
   | {
       pod_management_policy = v_pod_management_policy;
       replicas = v_replicas;
       revision_history_limit = v_revision_history_limit;
       service_name = v_service_name;
       persistent_volume_claim_retention_policy =
         v_persistent_volume_claim_retention_policy;
       selector = v_selector;
       template = v_template;
       ...
       let bnds =
         if Stdlib.( = ) [] v_volume_claim_template then bnds
           ...
           let arg =
             (yojson_of_list yojson_of_spec__volume_claim_template)
               v_volume_claim_template
           in
           let bnd = "volume_claim_template", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_update_strategy then bnds
         else
           let arg =
             (yojson_of_list yojson_of_spec__update_strategy)
               v_update_strategy
           in
           let bnd = "update_strategy", arg in
           bnd :: bnds
       in
       let bnds =
       ...
       let bnds =
         if
           Stdlib.( = ) [] v_persistent_volume_claim_retention_policy
         then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_spec__persistent_volume_claim_retention_policy)
               v_persistent_volume_claim_retention_policy
           in
           let bnd =
             "persistent_volume_claim_retention_policy", arg
           in
           bnd :: bnds
       in
       let bnds =
       ...
       in
       let bnds =
         match v_revision_history_limit with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_float v in
             let bnd = "revision_history_limit", arg in
             bnd :: bnds
       in
       let bnds =
       ...
       in
       let bnds =
         match v_pod_management_policy with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "pod_management_policy", arg in
             bnd :: bnds
       in
       `Assoc bnds
...
let _ = fun (_ : kubernetes_stateful_set_v1) -> ()

let yojson_of_kubernetes_stateful_set_v1 =
  (function
   | {
       id = v_id;
       wait_for_rollout = v_wait_for_rollout;
       metadata = v_metadata;
       spec = v_spec;
       timeouts = v_timeouts;
     } ->
       ...
       in
       let bnds =
         match v_wait_for_rollout with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_bool v in
             let bnd = "wait_for_rollout", arg in
             bnd :: bnds
       in
       let bnds =
         match v_id with
       ...
       in
       `Assoc bnds
    : kubernetes_stateful_set_v1 -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_kubernetes_stateful_set_v1
...
let spec__persistent_volume_claim_retention_policy ?when_deleted
    ?when_scaled () : spec__persistent_volume_claim_retention_policy
    =
  { when_deleted; when_scaled }
...
let spec__template__spec__affinity ?(node_affinity = [])
...
let spec__template__spec__container__env ?value ?(value_from = [])
    ~name () : spec__template__spec__container__env =
...
let spec__template__spec__container__env_from ?prefix
...
let spec__template__spec__container__lifecycle__post_start
...
let spec__template__spec__container__lifecycle ?(post_start = [])
    ?(pre_stop = []) () : spec__template__spec__container__lifecycle
    =
  { post_start; pre_stop }
...
let spec__template__spec__container ?args ?command ?image
    ...
    ?(volume_mount = []) ~name () : spec__template__spec__container =
  {
    args;
    command;
    image;
...
let spec__template__spec__dns_config ?nameservers ?searches
    ?(option_ = []) () : spec__template__spec__dns_config =
...
let spec__template__spec__init_container__env ?value
    ?(value_from = []) ~name () :
    spec__template__spec__init_container__env =
  { name; value; value_from }
...
let spec__template__spec__init_container__lifecycle__post_start
    ?(exec = []) ?(http_get = []) ?(tcp_socket = []) () :
    spec__template__spec__init_container__lifecycle__post_start =
  { exec; http_get; tcp_socket }
...
let spec__template__spec__init_container__lifecycle__pre_stop
    ?(exec = []) ?(http_get = []) ?(tcp_socket = []) () :
    spec__template__spec__init_container__lifecycle__pre_stop =
  { exec; http_get; tcp_socket }

let spec__template__spec__init_container__lifecycle
    ?(post_start = []) ?(pre_stop = []) () :
    spec__template__spec__init_container__lifecycle =
  { post_start; pre_stop }
...
let spec__template__spec__toleration ?effect_ ?key ?operator
...
let spec__template__spec__volume__csi ?fs_type ?read_only
    ?volume_attributes ?(node_publish_secret_ref = []) ~driver () :
    spec__template__spec__volume__csi =
  {
    driver;
    fs_type;
...
let spec__template__spec__volume__downward_api__items ?mode
    ?(resource_field_ref = []) ~path ~field_ref () :
    spec__template__spec__volume__downward_api__items =
  { mode; path; field_ref; resource_field_ref }

let spec__template__spec__volume__downward_api ?default_mode
    ?(items = []) () : spec__template__spec__volume__downward_api =
  { default_mode; items }
...
let spec__template__spec__volume__projected__sources
...
let spec__template__spec__volume ?name
    ...
    ?(vsphere_volume = []) () : spec__template__spec__volume =
  {
    name;
    aws_elastic_block_store;
    azure_disk;
...
let spec__template ?(spec = []) ~metadata () : spec__template =
  { metadata; spec }

let spec__update_strategy__rolling_update ?partition () :
    spec__update_strategy__rolling_update =
  { partition }

let spec__update_strategy ?type_ ?(rolling_update = []) () :
    spec__update_strategy =
  { type_; rolling_update }

let spec__volume_claim_template__metadata ?annotations ?generate_name
    ?labels ?name ?namespace () :
    spec__volume_claim_template__metadata =
  { annotations; generate_name; labels; name; namespace }

let spec__volume_claim_template__spec__resources ?limits ?requests ()
    : spec__volume_claim_template__spec__resources =
  { limits; requests }

let spec__volume_claim_template__spec__selector__match_expressions
    ?key ?operator ?values () :
    spec__volume_claim_template__spec__selector__match_expressions =
  { key; operator; values }

let spec__volume_claim_template__spec__selector ?match_labels
    ?(match_expressions = []) () :
    spec__volume_claim_template__spec__selector =
  { match_labels; match_expressions }

let spec__volume_claim_template__spec ?storage_class_name
    ?volume_mode ?volume_name ?(selector = []) ~access_modes
    ~resources () : spec__volume_claim_template__spec =
  {
    access_modes;
    storage_class_name;
    volume_mode;
...
let spec__volume_claim_template ~metadata ~spec () :
    spec__volume_claim_template =
  { metadata; spec }

let spec ?pod_management_policy ?replicas ?revision_history_limit
    ?(persistent_volume_claim_retention_policy = [])
    ?(update_strategy = []) ?(volume_claim_template = [])
    ~service_name ~selector ~template () : spec =
  {
...
let kubernetes_stateful_set_v1 ?id ?wait_for_rollout ?timeouts
    ~metadata ~spec () : kubernetes_stateful_set_v1 =
...
let make ?id ?wait_for_rollout ?timeouts ~metadata ~spec __id =
  let __type = "kubernetes_stateful_set_v1" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_kubernetes_stateful_set_v1
        (kubernetes_stateful_set_v1 ?id ?wait_for_rollout ?timeouts
           ~metadata ~spec ());
    attrs = __attrs;
  }
