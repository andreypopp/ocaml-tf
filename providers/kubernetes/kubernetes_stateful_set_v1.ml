...
let yojson_of_spec__volume_claim_template =
  (function
   | { metadata = v_metadata; spec = v_spec } ->
       ...
       let bnds =
         let arg =
           yojson_of_list yojson_of_spec__volume_claim_template__spec
             v_spec
         in
         ("spec", arg) :: bnds
       in
       ...
       let bnds =
         let arg =
           yojson_of_list
             ...
             v_persistent_volume_claim_retention_policy
         in
         ("persistent_volume_claim_retention_policy", arg) :: bnds
       in
       let bnds =
