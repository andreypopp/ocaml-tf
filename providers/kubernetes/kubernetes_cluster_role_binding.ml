...
let _ = fun (_ : kubernetes_cluster_role_binding) -> ()

let yojson_of_kubernetes_cluster_role_binding =
  (function
   | {
       id = v_id;
       metadata = v_metadata;
...
let _ = yojson_of_kubernetes_cluster_role_binding
...
let make ?id ~metadata ~role_ref ~subject __id =
  let __type = "kubernetes_cluster_role_binding" in
  let __attrs =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_kubernetes_cluster_role_binding
        (kubernetes_cluster_role_binding ?id ~metadata ~role_ref
           ~subject ());
    attrs = __attrs;
  }
