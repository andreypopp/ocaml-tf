...
let _ = fun (_ : kubernetes_mutating_webhook_configuration) -> ()

let yojson_of_kubernetes_mutating_webhook_configuration =
  (function
...
let _ = yojson_of_kubernetes_mutating_webhook_configuration
...
let make ?id ~metadata ~webhook __id =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_kubernetes_mutating_webhook_configuration
        (kubernetes_mutating_webhook_configuration ?id ~metadata
           ~webhook ());
    attrs = __attrs;
  }
