...
let _ = fun (_ : kubernetes_role_binding_v1) -> ()

let yojson_of_kubernetes_role_binding_v1 =
  (function
   | {
       id = v_id;
       metadata = v_metadata;
       ...
       in
       `Assoc bnds
    : kubernetes_role_binding_v1 -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_kubernetes_role_binding_v1
