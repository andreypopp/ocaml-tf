...
let yojson_of_spec =
  (function
   | {
       ...
       in
       let bnds =
         let arg = yojson_of_prop yojson_of_string v_signer_name in
         ("signer_name", arg) :: bnds
       in
       let bnds =
...
let _ = fun (_ : kubernetes_certificate_signing_request_v1) -> ()

let yojson_of_kubernetes_certificate_signing_request_v1 =
  (function
   | {
...
let _ = yojson_of_kubernetes_certificate_signing_request_v1
