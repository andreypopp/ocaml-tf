...
let _ = fun (_ : kubernetes_replication_controller) -> ()

let yojson_of_kubernetes_replication_controller =
  (function
   | {
       id = v_id;
       metadata = v_metadata;
...
let _ = yojson_of_kubernetes_replication_controller
...
let make ?id ?timeouts ~metadata ~spec __id =
  let __type = "kubernetes_replication_controller" in
  let __attrs =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_kubernetes_replication_controller
        (kubernetes_replication_controller ?id ?timeouts ~metadata
           ~spec ());
    attrs = __attrs;
  }
