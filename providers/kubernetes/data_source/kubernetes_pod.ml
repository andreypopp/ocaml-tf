...
let yojson_of_spec__topology_spread_constraint =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_match_label_keys then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
               v_match_label_keys
...
let yojson_of_spec__dns_config =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_searches then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
               v_searches
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_nameservers then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
               v_nameservers
