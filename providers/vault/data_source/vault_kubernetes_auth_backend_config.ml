...
let vault_kubernetes_auth_backend_config ?backend ?disable_iss_validation ?disable_local_ca_jwt ?id ?issuer
  ?kubernetes_ca_cert ?kubernetes_host ?namespace ?pem_keys ?use_annotations_as_alias_metadata () =
  ({
     backend;
...
let make ?backend ?disable_iss_validation ?disable_local_ca_jwt ?id ?issuer ?kubernetes_ca_cert ?kubernetes_host
  ?namespace ?pem_keys ?use_annotations_as_alias_metadata __id =
...
let register ?tf_module ?backend ?disable_iss_validation ?disable_local_ca_jwt ?id ?issuer ?kubernetes_ca_cert
  ?kubernetes_host ?namespace ?pem_keys ?use_annotations_as_alias_metadata __id =
  let (r : _ Tf_core.resource) =
    make ?backend ?disable_iss_validation ?disable_local_ca_jwt ?id ?issuer ?kubernetes_ca_cert ?kubernetes_host
      ?namespace ?pem_keys ?use_annotations_as_alias_metadata __id
  in
