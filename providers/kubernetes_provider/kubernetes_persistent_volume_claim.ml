...
type kubernetes_persistent_volume_claim__spec__selector = {
  ...
  match_expressions :
    kubernetes_persistent_volume_claim__spec__selector__match_expressions
    list;
}
[@@deriving yojson_of]
...
type kubernetes_persistent_volume_claim__spec = {
  ...
  resources :
    kubernetes_persistent_volume_claim__spec__resources list;
  selector : kubernetes_persistent_volume_claim__spec__selector list;
}
[@@deriving yojson_of]
...
type kubernetes_persistent_volume_claim = {
  ...
  timeouts : kubernetes_persistent_volume_claim__timeouts option;
}
[@@deriving yojson_of]
