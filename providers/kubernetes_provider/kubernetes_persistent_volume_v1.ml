...
type kubernetes_persistent_volume_v1__spec__node_affinity__required__node_selector_term = {
  match_expressions :
    kubernetes_persistent_volume_v1__spec__node_affinity__required__node_selector_term__match_expressions
    list;
  match_fields :
    kubernetes_persistent_volume_v1__spec__node_affinity__required__node_selector_term__match_fields
    list;
}
[@@deriving yojson_of]
(** kubernetes_persistent_volume_v1__spec__node_affinity__required__node_selector_term *)
...
[@@deriving yojson_of]
(** kubernetes_persistent_volume_v1__spec__node_affinity__required *)
...
type kubernetes_persistent_volume_v1__spec__persistent_volume_source__ceph_fs = {
  ...
  secret_ref :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__ceph_fs__secret_ref
    list;
}
[@@deriving yojson_of]
...
type kubernetes_persistent_volume_v1__spec__persistent_volume_source__csi = {
  ...
  controller_expand_secret_ref :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__csi__controller_expand_secret_ref
    list;
  controller_publish_secret_ref :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__csi__controller_publish_secret_ref
    list;
  node_publish_secret_ref :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__csi__node_publish_secret_ref
    list;
  node_stage_secret_ref :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__csi__node_stage_secret_ref
    list;
}
[@@deriving yojson_of]
...
type kubernetes_persistent_volume_v1__spec__persistent_volume_source__flex_volume = {
  ...
  secret_ref :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__flex_volume__secret_ref
    list;
}
[@@deriving yojson_of]
...
type kubernetes_persistent_volume_v1__spec__persistent_volume_source__rbd = {
  ...
  secret_ref :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__rbd__secret_ref
    list;
}
[@@deriving yojson_of]
...
type kubernetes_persistent_volume_v1__spec__persistent_volume_source = {
  aws_elastic_block_store :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__aws_elastic_block_store
    list;
  azure_disk :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__azure_disk
    list;
  azure_file :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__azure_file
    list;
  ceph_fs :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__ceph_fs
    list;
  cinder :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__cinder
    list;
  csi :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__csi
    list;
  fc :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__fc
    list;
  flex_volume :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__flex_volume
    list;
  flocker :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__flocker
    list;
  gce_persistent_disk :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__gce_persistent_disk
    list;
  glusterfs :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__glusterfs
    list;
  host_path :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__host_path
    list;
  iscsi :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__iscsi
    list;
  local :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__local
    list;
  nfs :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__nfs
    list;
  photon_persistent_disk :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__photon_persistent_disk
    list;
  quobyte :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__quobyte
    list;
  rbd :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__rbd
    list;
  vsphere_volume :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source__vsphere_volume
    list;
}
[@@deriving yojson_of]
...
type kubernetes_persistent_volume_v1__spec = {
  ...
  claim_ref : kubernetes_persistent_volume_v1__spec__claim_ref list;
  node_affinity :
    kubernetes_persistent_volume_v1__spec__node_affinity list;
  persistent_volume_source :
    kubernetes_persistent_volume_v1__spec__persistent_volume_source
    list;
}
[@@deriving yojson_of]
...
[@@deriving yojson_of]
(** kubernetes_persistent_volume_v1__timeouts *)
...
type kubernetes_persistent_volume_v1 = {
  ...
  timeouts : kubernetes_persistent_volume_v1__timeouts option;
}
[@@deriving yojson_of]
(** kubernetes_persistent_volume_v1 *)

let kubernetes_persistent_volume_v1 ?timeouts ~metadata ~spec
    __resource_id =
