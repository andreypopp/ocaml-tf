...
type kubernetes_pod_disruption_budget__spec__selector = {
  ...
  match_expressions :
    kubernetes_pod_disruption_budget__spec__selector__match_expressions
    list;
}
[@@deriving yojson_of]
(** kubernetes_pod_disruption_budget__spec__selector *)
...
type kubernetes_pod_disruption_budget__spec = {
  ...
  selector : kubernetes_pod_disruption_budget__spec__selector list;
}
[@@deriving yojson_of]
...
let kubernetes_pod_disruption_budget ~metadata ~spec __resource_id =
