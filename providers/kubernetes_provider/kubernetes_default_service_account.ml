...
[@@deriving yojson_of]
(** kubernetes_default_service_account__timeouts *)
...
type kubernetes_default_service_account = {
  ...
  timeouts : kubernetes_default_service_account__timeouts option;
}
[@@deriving yojson_of]
...
let kubernetes_default_service_account
  ...
  Resource.add ~type_:__resource_type ~id:__resource_id
    (yojson_of_kubernetes_default_service_account __resource);
  ()
