...
type kubernetes_cluster_role__aggregation_rule__cluster_role_selectors = {
  ...
  match_expressions :
    kubernetes_cluster_role__aggregation_rule__cluster_role_selectors__match_expressions
    list;
}
[@@deriving yojson_of]
...
type kubernetes_cluster_role__aggregation_rule = {
  cluster_role_selectors :
    kubernetes_cluster_role__aggregation_rule__cluster_role_selectors
    list;
}
[@@deriving yojson_of]
...
let kubernetes_cluster_role ?id ~aggregation_rule ~metadata ~rule
    __resource_id =
  let __resource_type = "kubernetes_cluster_role" in
  let __resource = { id; aggregation_rule; metadata; rule } in
  Resource.add ~type_:__resource_type ~id:__resource_id
    (yojson_of_kubernetes_cluster_role __resource);
  ()
