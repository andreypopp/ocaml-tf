...
Attempting to use a user or basic auth e.g. user:password@ is not allowed. Fragments (#...) and query parameters (?...) are not allowed, either. *)
  service :
    kubernetes_validating_webhook_configuration_v1__webhook__client_config__service
    list;
}
[@@deriving yojson_of]
...
type kubernetes_validating_webhook_configuration_v1__webhook__namespace_selector = {
  ...
  match_expressions :
    kubernetes_validating_webhook_configuration_v1__webhook__namespace_selector__match_expressions
    list;
}
[@@deriving yojson_of]
...
type kubernetes_validating_webhook_configuration_v1__webhook__object_selector = {
  match_labels : (string * string) list option; [@option]
      (** A map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of `match_expressions`, whose key field is key, the operator is In, and the values array contains only value. The requirements are ANDed. *)
  match_expressions :
    kubernetes_validating_webhook_configuration_v1__webhook__object_selector__match_expressions
    list;
}
[@@deriving yojson_of]
...
Defaults to Equivalent *)
  ...
  client_config :
    kubernetes_validating_webhook_configuration_v1__webhook__client_config
    list;
  namespace_selector :
    kubernetes_validating_webhook_configuration_v1__webhook__namespace_selector
    list;
  object_selector :
    kubernetes_validating_webhook_configuration_v1__webhook__object_selector
    list;
  rule :
    kubernetes_validating_webhook_configuration_v1__webhook__rule
    list;
}
[@@deriving yojson_of]
