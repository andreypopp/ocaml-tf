...
type okta_policy_device_assurance_windows = {
  ...
  tpsp_chrome_remote_desktop_app_blocked : bool prop option;
      [@option]
  tpsp_crowd_strike_agent_id : string prop option; [@option]
  tpsp_crowd_strike_customer_id : string prop option; [@option]
  ...
  tpsp_secure_boot_enabled : bool prop option; [@option]
  tpsp_site_isolation_enabled : bool prop option; [@option]
  tpsp_third_party_blocking_enabled : bool prop option; [@option]
  tpsp_windows_machine_domain : string prop option; [@option]
  tpsp_windows_user_domain : string prop option; [@option]
}
[@@deriving_inline yojson_of]

let _ = fun (_ : okta_policy_device_assurance_windows) -> ()

let yojson_of_okta_policy_device_assurance_windows =
  (function
   | {
       ...
       tpsp_crowd_strike_agent_id = v_tpsp_crowd_strike_agent_id;
       tpsp_crowd_strike_customer_id =
         v_tpsp_crowd_strike_customer_id;
       ...
       tpsp_secure_boot_enabled = v_tpsp_secure_boot_enabled;
       tpsp_site_isolation_enabled = v_tpsp_site_isolation_enabled;
       tpsp_third_party_blocking_enabled =
         v_tpsp_third_party_blocking_enabled;
       tpsp_windows_machine_domain = v_tpsp_windows_machine_domain;
       tpsp_windows_user_domain = v_tpsp_windows_user_domain;
     } ->
       let bnds : (string * Ppx_yojson_conv_lib.Yojson.Safe.t) list =
         []
       in
       let bnds =
         match v_tpsp_windows_user_domain with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "tpsp_windows_user_domain", arg in
             bnd :: bnds
       in
       let bnds =
         match v_tpsp_windows_machine_domain with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "tpsp_windows_machine_domain", arg in
             bnd :: bnds
       in
       let bnds =
         match v_tpsp_third_party_blocking_enabled with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_bool v in
             let bnd = "tpsp_third_party_blocking_enabled", arg in
             bnd :: bnds
       in
       let bnds =
       ...
       in
       let bnds =
         match v_tpsp_secure_boot_enabled with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_bool v in
             let bnd = "tpsp_secure_boot_enabled", arg in
             bnd :: bnds
       in
       let bnds =
       ...
       in
       let bnds =
         match v_tpsp_crowd_strike_customer_id with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "tpsp_crowd_strike_customer_id", arg in
             bnd :: bnds
       in
       let bnds =
         match v_tpsp_crowd_strike_agent_id with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "tpsp_crowd_strike_agent_id", arg in
             bnd :: bnds
       in
       let bnds =
...
let _ = yojson_of_okta_policy_device_assurance_windows

[@@@deriving.end]

let okta_policy_device_assurance_windows ?disk_encryption_type
    ?os_version ?screenlock_type ?secure_hardware_present
    ?third_party_signal_providers ?tpsp_browser_version
    ?tpsp_builtin_dns_client_enabled
    ?tpsp_chrome_remote_desktop_app_blocked
    ?tpsp_crowd_strike_agent_id ?tpsp_crowd_strike_customer_id
    ...
    ?tpsp_secure_boot_enabled ?tpsp_site_isolation_enabled
    ?tpsp_third_party_blocking_enabled ?tpsp_windows_machine_domain
    ?tpsp_windows_user_domain ~name () :
    okta_policy_device_assurance_windows =
  {
...
type t = {
  ...
  tpsp_crowd_strike_agent_id : string prop;
  tpsp_crowd_strike_customer_id : string prop;
  ...
  tpsp_secure_boot_enabled : bool prop;
  tpsp_site_isolation_enabled : bool prop;
  tpsp_third_party_blocking_enabled : bool prop;
  tpsp_windows_machine_domain : string prop;
  tpsp_windows_user_domain : string prop;
}
...
let make ?disk_encryption_type ?os_version ?screenlock_type
    ...
    ?tpsp_secure_boot_enabled ?tpsp_site_isolation_enabled
    ?tpsp_third_party_blocking_enabled ?tpsp_windows_machine_domain
    ?tpsp_windows_user_domain ~name __id =
  let __type = "okta_policy_device_assurance_windows" in
  let __attrs =
    ({
       tf_name = __id;
       ...
       tpsp_chrome_remote_desktop_app_blocked =
         Prop.computed __type __id
           "tpsp_chrome_remote_desktop_app_blocked";
       tpsp_crowd_strike_agent_id =
         Prop.computed __type __id "tpsp_crowd_strike_agent_id";
       tpsp_crowd_strike_customer_id =
         Prop.computed __type __id "tpsp_crowd_strike_customer_id";
       tpsp_device_enrollment_domain =
       ...
       tpsp_secure_boot_enabled =
         Prop.computed __type __id "tpsp_secure_boot_enabled";
       tpsp_site_isolation_enabled =
       ...
       tpsp_third_party_blocking_enabled =
         Prop.computed __type __id
           "tpsp_third_party_blocking_enabled";
       tpsp_windows_machine_domain =
         Prop.computed __type __id "tpsp_windows_machine_domain";
       tpsp_windows_user_domain =
         Prop.computed __type __id "tpsp_windows_user_domain";
     }
      : t)
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_okta_policy_device_assurance_windows
        (okta_policy_device_assurance_windows ?disk_encryption_type
           ?os_version ?screenlock_type ?secure_hardware_present
           ?third_party_signal_providers ?tpsp_browser_version
           ?tpsp_builtin_dns_client_enabled
           ?tpsp_chrome_remote_desktop_app_blocked
           ...
           ?tpsp_realtime_url_check_mode
           ?tpsp_safe_browsing_protection_level
           ?tpsp_screen_lock_secured ?tpsp_secure_boot_enabled
           ?tpsp_site_isolation_enabled
           ?tpsp_third_party_blocking_enabled
           ?tpsp_windows_machine_domain ?tpsp_windows_user_domain
           ~name ());
    attrs = __attrs;
  }
