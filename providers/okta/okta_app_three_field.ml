...
let _ = fun (_ : okta_app_three_field) -> ()

let yojson_of_okta_app_three_field =
  (function
   | {
       ...
       button_selector = v_button_selector;
       credentials_scheme = v_credentials_scheme;
       enduser_note = v_enduser_note;
       extra_field_selector = v_extra_field_selector;
       extra_field_value = v_extra_field_value;
       hide_ios = v_hide_ios;
       hide_web = v_hide_web;
       id = v_id;
       label = v_label;
       logo = v_logo;
       password_selector = v_password_selector;
       ...
       username_selector = v_username_selector;
       timeouts = v_timeouts;
     } ->
       let bnds : (string * Ppx_yojson_conv_lib.Yojson.Safe.t) list =
         []
       ...
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string v_username_selector
         in
         ("username_selector", arg) :: bnds
       in
       let bnds =
       ...
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string v_password_selector
         in
         ("password_selector", arg) :: bnds
       in
       let bnds =
         match v_logo with
         | Ppx_yojson_conv_lib.Option.None -> bnds
       ...
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string v_extra_field_value
         in
         ("extra_field_value", arg) :: bnds
       in
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string v_extra_field_selector
         in
         ("extra_field_selector", arg) :: bnds
       in
       let bnds =
       ...
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string v_button_selector
         in
         ("button_selector", arg) :: bnds
       in
       let bnds =
       ...
       in
       `Assoc bnds
    : okta_app_three_field -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_okta_app_three_field
...
let okta_app_three_field ?accessibility_error_redirect_url
    ...
    ~button_selector ~extra_field_selector ~extra_field_value ~label
    ~password_selector ~url ~username_selector () :
...
let make ?accessibility_error_redirect_url
    ...
    ?user_name_template_suffix ?user_name_template_type ?timeouts
    ~button_selector ~extra_field_selector ~extra_field_value ~label
    ~password_selector ~url ~username_selector __id =
  let __type = "okta_app_three_field" in
  let __attrs =
    ({
       tf_name = __id;
       accessibility_error_redirect_url =
       ...
       button_selector = Prop.computed __type __id "button_selector";
       credentials_scheme =
         Prop.computed __type __id "credentials_scheme";
       enduser_note = Prop.computed __type __id "enduser_note";
       extra_field_selector =
         Prop.computed __type __id "extra_field_selector";
       extra_field_value =
         Prop.computed __type __id "extra_field_value";
       ...
       password_selector =
         Prop.computed __type __id "password_selector";
       ...
       username_selector =
         Prop.computed __type __id "username_selector";
     }
      : t)
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_okta_app_three_field
        (okta_app_three_field ?accessibility_error_redirect_url
           ?accessibility_login_redirect_url
           ?accessibility_self_service ?admin_note ?app_links_json
           ?auto_submit_toolbar ?credentials_scheme ?enduser_note
           ?hide_ios ?hide_web ?id ?logo ?reveal_password
           ?shared_password ?shared_username ?status ?url_regex
           ?user_name_template ?user_name_template_push_status
           ?user_name_template_suffix ?user_name_template_type
           ?timeouts ~button_selector ~extra_field_selector
           ~extra_field_value ~label ~password_selector ~url
           ~username_selector ());
    attrs = __attrs;
  }
...
let register ?tf_module ?accessibility_error_redirect_url
  ...
  let (r : _ Tf_core.resource) =
    make ?accessibility_error_redirect_url
      ...
      ?url_regex ?user_name_template ?user_name_template_push_status
      ?user_name_template_suffix ?user_name_template_type ?timeouts
      ~button_selector ~extra_field_selector ~extra_field_value
      ~label ~password_selector ~url ~username_selector __id
  in
