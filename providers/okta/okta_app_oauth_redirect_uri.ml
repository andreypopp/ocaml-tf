...
let _ = fun (_ : okta_app_oauth_redirect_uri) -> ()

let yojson_of_okta_app_oauth_redirect_uri =
  (function
...
let _ = yojson_of_okta_app_oauth_redirect_uri

[@@@deriving.end]

let okta_app_oauth_redirect_uri ?id ~app_id ~uri () :
    okta_app_oauth_redirect_uri =
  { app_id; id; uri }
...
let make ?id ~app_id ~uri __id =
  let __type = "okta_app_oauth_redirect_uri" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_okta_app_oauth_redirect_uri
        (okta_app_oauth_redirect_uri ?id ~app_id ~uri ());
    attrs = __attrs;
  }
