...
let _ = fun (_ : okta_customized_signin_page) -> ()

let yojson_of_okta_customized_signin_page =
  (function
   | {
       brand_id = v_brand_id;
...
let _ = yojson_of_okta_customized_signin_page
...
let okta_customized_signin_page ~brand_id ~page_content
    ~widget_version ~content_security_policy_setting
    ~widget_customizations () : okta_customized_signin_page =
  {
    brand_id;
    page_content;
    widget_version;
...
let make ~brand_id ~page_content ~widget_version
  ...
  let __type = "okta_customized_signin_page" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_okta_customized_signin_page
        (okta_customized_signin_page ~brand_id ~page_content
           ~widget_version ~content_security_policy_setting
           ~widget_customizations ());
    attrs = __attrs;
  }
