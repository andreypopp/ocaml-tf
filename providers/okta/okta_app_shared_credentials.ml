...
let _ = fun (_ : okta_app_shared_credentials) -> ()

let yojson_of_okta_app_shared_credentials =
  (function
   | {
...
let _ = yojson_of_okta_app_shared_credentials
...
let okta_app_shared_credentials ?accessibility_error_redirect_url
    ...
    ?password_field ?preconfigured_app ?redirect_url ?shared_password
    ?shared_username ?status ?url ?url_regex ?user_name_template
    ?user_name_template_push_status ?user_name_template_suffix
    ?user_name_template_type ?username_field ?timeouts ~label () :
    okta_app_shared_credentials =
  {
    accessibility_error_redirect_url;
    accessibility_login_redirect_url;
...
let make ?accessibility_error_redirect_url
    ...
    ?shared_username ?status ?url ?url_regex ?user_name_template
    ?user_name_template_push_status ?user_name_template_suffix
    ?user_name_template_type ?username_field ?timeouts ~label __id =
  let __type = "okta_app_shared_credentials" in
  let __attrs =
    ({
       tf_name = __id;
       accessibility_error_redirect_url =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_okta_app_shared_credentials
        (okta_app_shared_credentials
           ?accessibility_error_redirect_url
           ?accessibility_login_redirect_url
           ...
           ?preconfigured_app ?redirect_url ?shared_password
           ?shared_username ?status ?url ?url_regex
...
let register ?tf_module ?accessibility_error_redirect_url
  ...
  let (r : _ Tf_core.resource) =
    make ?accessibility_error_redirect_url
      ...
      ?admin_note ?app_links_json ?auto_submit_toolbar ?button_field
      ?checkbox ?enduser_note ?hide_ios ?hide_web ?id ?logo
      ?password_field ?preconfigured_app ?redirect_url
      ?shared_password ?shared_username ?status ?url ?url_regex
      ?user_name_template ?user_name_template_push_status
      ?user_name_template_suffix ?user_name_template_type
