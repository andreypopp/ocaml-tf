...
type google_composer_environment__config__node_config = {
  ...
  enable_ip_masq_agent : bool option; [@option]
...
type google_composer_environment__config__private_environment_config = {
  cloud_composer_connection_subnetwork : string option; [@option]
  ...
  cloud_composer_network_ipv4_cidr_block : string option; [@option]
  ...
  cloud_sql_ipv4_cidr_block : string option; [@option]
      (** The CIDR block from which IP range in tenant project will be reserved for Cloud SQL. Needs to be disjoint from web_server_ipv4_cidr_block. *)
  connection_type : string option; [@option]
  ...
  enable_privately_used_public_ips : bool option; [@option]
  ...
  web_server_ipv4_cidr_block : string option; [@option]
...
type google_composer_environment__config__recovery_config__scheduled_snapshots_config = {
  ...
  snapshot_creation_schedule : string option; [@option]
      (** Snapshot schedule, in the unix-cron format. *)
  snapshot_location : string option; [@option]
...
type google_composer_environment__config__software_config = {
  airflow_config_overrides : (string * string) list option; [@option]
  ...
  pypi_packages : (string * string) list option; [@option]
  ...
  scheduler_count : float option; [@option]
...
type google_composer_environment__config__workloads_config__scheduler = {
  count : float option; [@option]  (** The number of schedulers. *)
  cpu : float option; [@option]
      (** CPU request and limit for a single Airflow scheduler replica *)
  memory_gb : float option; [@option]
      (** Memory (GB) request and limit for a single Airflow scheduler replica. *)
  storage_gb : float option; [@option]
...
type google_composer_environment__config__workloads_config__triggerer = {
  count : float;  (** The number of triggerers. *)
  cpu : float;
...
type google_composer_environment__config__workloads_config__worker = {
  ...
  max_count : float option; [@option]
      (** Maximum number of workers for autoscaling. *)
  memory_gb : float option; [@option]
      (** Memory (GB) request and limit for a single Airflow worker replica. *)
  min_count : float option; [@option]
