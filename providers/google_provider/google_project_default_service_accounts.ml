...
let google_project_default_service_accounts ?restore_policy ?timeouts
    ~action ~project __resource_id =
  let __resource_type = "google_project_default_service_accounts" in
  let __resource = { action; project; restore_policy; timeouts } in
