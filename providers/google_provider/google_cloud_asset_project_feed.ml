...
type google_cloud_asset_project_feed__feed_output_config = {
  pubsub_destination :
    google_cloud_asset_project_feed__feed_output_config__pubsub_destination
    list;
}
[@@deriving yojson_of]
...
[@@deriving yojson_of]
(** google_cloud_asset_project_feed__timeouts *)
...
supported asset types. *)
  billing_project : string option; [@option]
...
project will be used. *)
  ...
  timeouts : google_cloud_asset_project_feed__timeouts option;
}
[@@deriving yojson_of]
