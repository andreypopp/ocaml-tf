...
let google_cloudbuildv2_repository ?annotations ?timeouts ~name
    ~parent_connection ~remote_uri __resource_id =
  let __resource_type = "google_cloudbuildv2_repository" in
  let __resource =
    { annotations; name; parent_connection; remote_uri; timeouts }
  in
