...
The syntax of the regular expressions accepted is the syntax accepted by RE2 and described at https://github.com/google/re2/wiki/Syntax *)
  comment_control : string option; [@option]
...
For example, if the repository name is 'test repo', in the URL it would become 'test-repo' as in https://mybitbucket.server/projects/TEST/repos/test-repo. *)
  pull_request :
    google_cloudbuild_trigger__bitbucket_server_trigger_config__pull_request
    list;
  push :
    google_cloudbuild_trigger__bitbucket_server_trigger_config__push
    list;
}
[@@deriving yojson_of]
...
type google_cloudbuild_trigger__build__artifacts__maven_artifacts = {
  artifact_id : string option; [@option]
...
type google_cloudbuild_trigger__build__artifacts__npm_packages = {
  package_path : string option; [@option]
...
this location as a prefix. *)
  paths : string list option; [@option]
      (** Path globs used to match files in the build's workspace. *)
  timing :
    google_cloudbuild_trigger__build__artifacts__objects__timing list;
...
type google_cloudbuild_trigger__build__artifacts = {
  images : string list option; [@option]
...
If any of the images fail to be pushed, the build is marked FAILURE. *)
  maven_artifacts :
    google_cloudbuild_trigger__build__artifacts__maven_artifacts list;
  npm_packages :
    google_cloudbuild_trigger__build__artifacts__npm_packages list;
  objects :
    google_cloudbuild_trigger__build__artifacts__objects list;
  python_packages :
    google_cloudbuild_trigger__build__artifacts__python_packages list;
}
[@@deriving yojson_of]
...
type google_cloudbuild_trigger__build__available_secrets = {
  secret_manager :
    google_cloudbuild_trigger__build__available_secrets__secret_manager
    list;
}
[@@deriving yojson_of]
...
is 1000GB; builds that request more than the maximum are rejected with an error. *)
  dynamic_substitutions : bool option; [@option]
      (** Option to specify whether or not to apply bash style string operations to the substitutions.

NOTE this is always enabled for triggered builds and cannot be overridden in the build configuration file. *)
  env : string list option; [@option]
      (** A list of global environment variable definitions that will exist for all build steps
in this build. If a variable is defined in both globally and in a build step,
the variable will use the build step value.

The elements are of the form KEY=VALUE for the environment variable KEY being given the value VALUE. *)
  log_streaming_option : string option; [@option]
      (** Option to define build log streaming behavior to Google Cloud Storage. Possible values: [STREAM_DEFAULT, STREAM_ON, STREAM_OFF] *)
  logging : string option; [@option]
  ...
  requested_verify_option : string option; [@option]
      (** Requested verifiability options. Possible values: [NOT_VERIFIED, VERIFIED] *)
  secret_env : string list option; [@option]
      (** A list of global environment variables, which are encrypted using a Cloud Key Management
Service crypto key. These values must be specified in the build's Secret. These variables
will be available to all build steps in this build. *)
  source_provenance_hash : string list option; [@option]
      (** Requested hash for SourceProvenance. Possible values: [NONE, SHA256, MD5] *)
  substitution_option : string option; [@option]
...
This field is experimental. *)
  volumes : google_cloudbuild_trigger__build__options__volumes list;
}
[@@deriving yojson_of]
...
type google_cloudbuild_trigger__build__secret = {
  ...
  secret_env : (string * string) list option; [@option]
...
If omitted, the project ID requesting the build is assumed. *)
  ...
  substitutions : (string * string) list option; [@option]
...
type google_cloudbuild_trigger__build__source__storage_source = {
  ...
  generation : string option; [@option]
...
type google_cloudbuild_trigger__build__source = {
  repo_source :
    google_cloudbuild_trigger__build__source__repo_source list;
  storage_source :
    google_cloudbuild_trigger__build__source__storage_source list;
}
[@@deriving yojson_of]
...
type google_cloudbuild_trigger__build__step = {
  allow_exit_codes : float list option; [@option]
      (** Allow this build step to fail without failing the entire build if and
only if the exit code is one of the specified codes.

If 'allowFailure' is also specified, this field will take precedence. *)
  allow_failure : bool option; [@option]
...
for the step's execution. *)
  entrypoint : string option; [@option]
...
completes or the build itself times out. *)
  timing : string option; [@option]
      (** Output only. Stores timing information for executing this
build step. *)
  wait_for : string list option; [@option]
...
have completed successfully. *)
  volumes : google_cloudbuild_trigger__build__step__volumes list;
}
[@@deriving yojson_of]
...
If any of the images fail to be pushed, the build status is marked FAILURE. *)
  logs_bucket : string option; [@option]
      (** Google Cloud Storage bucket where logs should be written.
Logs file names will be of the format ${logsBucket}/log-${build_id}.txt. *)
  queue_ttl : string option; [@option]
...
Default time is ten minutes (600s). *)
  artifacts : google_cloudbuild_trigger__build__artifacts list;
  available_secrets :
    google_cloudbuild_trigger__build__available_secrets list;
  options : google_cloudbuild_trigger__build__options list;
  secret : google_cloudbuild_trigger__build__secret list;
  source : google_cloudbuild_trigger__build__source list;
  step : google_cloudbuild_trigger__build__step list;
}
[@@deriving yojson_of]
(** Contents of the build template. Either a filename or build template must be provided. *)

type google_cloudbuild_trigger__git_file_source = {
  bitbucket_server_config : string option; [@option]
      (** The full resource name of the bitbucket server config.
Format: projects/{project}/locations/{location}/bitbucketServerConfigs/{id}. *)
  github_enterprise_config : string option; [@option]
...
type google_cloudbuild_trigger__github = {
  enterprise_config_resource_name : string option; [@option]
...
https://github.com/googlecloudplatform/cloud-builders is googlecloudplatform. *)
  pull_request :
    google_cloudbuild_trigger__github__pull_request list;
  push : google_cloudbuild_trigger__github__push list;
}
[@@deriving yojson_of]
...
type google_cloudbuild_trigger__repository_event_config = {
  ...
  pull_request :
    google_cloudbuild_trigger__repository_event_config__pull_request
    list;
  push :
    google_cloudbuild_trigger__repository_event_config__push list;
}
[@@deriving yojson_of]
...
Either uri or repository can be specified and is required. *)
  uri : string option; [@option]  (** The URI of the repo. *)
}
[@@deriving yojson_of]
...
[@@deriving yojson_of]
(** google_cloudbuild_trigger__timeouts *)
...
of the ignoredFiles globs, then we do not trigger a build. *)
  include_build_logs : string option; [@option]
      (** Build logs will be sent back to GitHub as part of the checkrun
result.  Values can be INCLUDE_BUILD_LOGS_UNSPECIFIED or
INCLUDE_BUILD_LOGS_WITH_STATUS Possible values: [INCLUDE_BUILD_LOGS_UNSPECIFIED, INCLUDE_BUILD_LOGS_WITH_STATUS] *)
  included_files : string list option; [@option]
      (** ignoredFiles and includedFiles are file glob matches using https://golang.org/pkg/path/filepath/#Match
extended with support for '**'.
...
Format: projects/{PROJECT_ID}/serviceAccounts/{ACCOUNT_ID_OR_EMAIL} *)
  ...
  timeouts : google_cloudbuild_trigger__timeouts option;
  trigger_template :
    google_cloudbuild_trigger__trigger_template list;
