...
type google_bigquery_connection__azure = {
  ...
  federated_application_client_id : string option; [@option]
...
type google_bigquery_connection__cloud_spanner = {
  ...
  use_parallelism : bool option; [@option]
      (** If parallelism should be used when reading from Cloud Spanner. *)
  use_serverless_analytics : bool option; [@option]
...
type google_bigquery_connection__spark__metastore_service_config = {
  metastore_service : string option; [@option]
