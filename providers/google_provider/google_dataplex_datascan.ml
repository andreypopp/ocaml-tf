...
type google_dataplex_datascan__data_profile_spec__exclude_fields = {
  field_names : string list option; [@option]
...
type google_dataplex_datascan__data_profile_spec__post_scan_actions__bigquery_export = {
  results_table : string option; [@option]
...
type google_dataplex_datascan__data_profile_spec = {
  row_filter : string option; [@option]
      (** A filter applied to all rows in a single DataScan job. The filter needs to be a valid SQL expression for a WHERE clause in BigQuery standard SQL syntax. Example: col1 >= 0 AND col2 < 10 *)
  sampling_percent : float option; [@option]
...
type google_dataplex_datascan__data_quality_spec__rules__range_expectation = {
  max_value : string option; [@option]
      (** The maximum column value allowed for a row to pass this validation. At least one of minValue and maxValue need to be provided. *)
  min_value : string option; [@option]
      (** The minimum column value allowed for a row to pass this validation. At least one of minValue and maxValue need to be provided. *)
  strict_max_enabled : bool option; [@option]
      (** Whether each value needs to be strictly lesser than ('<') the maximum, or if equality is allowed.
Only relevant if a maxValue has been defined. Default = false. *)
  strict_min_enabled : bool option; [@option]
...
type google_dataplex_datascan__data_quality_spec__rules__set_expectation = {
  values : string list;  (** Expected values for the column value. *)
}
[@@deriving yojson_of]
...
The maximum length is 1,024 characters. *)
  ...
  ignore_null : bool option; [@option]
