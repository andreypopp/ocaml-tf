...
type google_gke_hub_feature_membership__configmanagement__config_sync__git = {
  ...
  secret_type : string option; [@option]
...
type google_gke_hub_feature_membership__configmanagement__config_sync = {
  metrics_gcp_service_account_email : string option; [@option]
      (** The Email of the Google Cloud Service Account (GSA) used for exporting Config Sync metrics to Cloud Monitoring. The GSA should have the Monitoring Metric Writer(roles/monitoring.metricWriter) IAM role. The Kubernetes ServiceAccount `default` in the namespace `config-management-monitoring` should be bound to the GSA. *)
  prevent_drift : bool option; [@option]
...
type google_gke_hub_feature_membership__configmanagement__hierarchy_controller = {
  enable_hierarchical_resource_quota : bool option; [@option]
      (** Whether hierarchical resource quota is enabled in this cluster. *)
  enable_pod_tree_labels : bool option; [@option]
...
type google_gke_hub_feature_membership__configmanagement__policy_controller = {
  audit_interval_seconds : string option; [@option]
  ...
  template_library_installed : bool option; [@option]
...
type google_gke_hub_feature_membership__mesh = {
  control_plane : string option; [@option]
      (** **DEPRECATED** Whether to automatically manage Service Mesh control planes. Possible values: CONTROL_PLANE_MANAGEMENT_UNSPECIFIED, AUTOMATIC, MANUAL *)
  management : string option; [@option]
...
type google_gke_hub_feature_membership__policycontroller__policy_controller_hub_config = {
  ...
  exemptable_namespaces : string list option; [@option]
      (** The set of namespaces that are excluded from Policy Controller checks. Namespaces do not need to currently exist on the cluster. *)
  install_spec : string option; [@option]
