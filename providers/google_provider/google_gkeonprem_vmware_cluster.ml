...
type google_gkeonprem_vmware_cluster__dataplane_v2 = {
  ...
  dataplane_v2_enabled : bool option; [@option]
      (** Enables Dataplane V2. *)
  windows_dataplane_v2_enabled : bool option; [@option]
...
type google_gkeonprem_vmware_cluster__load_balancer__f5_config = {
  ...
  partition : string option; [@option]
      (** he preexisting partition to be used by the load balancer. T
his partition is usually created for the admin cluster for example:
'my-f5-admin-partition'. *)
  snat_pool : string option; [@option]
...
type google_gkeonprem_vmware_cluster__load_balancer__manual_lb_config = {
  control_plane_node_port : float option; [@option]
      (** NodePort for control plane service. The Kubernetes API server in the admin
cluster is implemented as a Service of type NodePort (ex. 30968). *)
  ingress_http_node_port : float option; [@option]
      (** NodePort for ingress service's http. The ingress service in the admin
cluster is implemented as a Service of type NodePort (ex. 32527). *)
  ingress_https_node_port : float option; [@option]
      (** NodePort for ingress service's https. The ingress service in the admin
cluster is implemented as a Service of type NodePort (ex. 30139). *)
  konnectivity_server_node_port : float option; [@option]
...
type google_gkeonprem_vmware_cluster__load_balancer__vip_config = {
  control_plane_vip : string option; [@option]
      (** The VIP which you previously set aside for the Kubernetes API of this cluster. *)
  ingress_vip : string option; [@option]
...
type google_gkeonprem_vmware_cluster__network_config__control_plane_v2_config__control_plane_ip_block = {
  gateway : string option; [@option]
      (** The network gateway used by the VMware User Cluster. *)
  netmask : string option; [@option]
...
type google_gkeonprem_vmware_cluster__network_config__host_config = {
  dns_search_domains : string list option; [@option]
      (** DNS search domains. *)
  dns_servers : string list option; [@option]  (** DNS servers. *)
  ntp_servers : string list option; [@option]  (** NTP servers. *)
}
[@@deriving yojson_of]
...
type google_gkeonprem_vmware_cluster__upgrade_policy = {
  control_plane_only : bool option; [@option]
...
type google_gkeonprem_vmware_cluster__vcenter = {
  ...
  ca_cert_data : string option; [@option]
      (** Contains the vCenter CA certificate public key for SSL verification. *)
  cluster : string option; [@option]
      (** The name of the vCenter cluster for the user cluster. *)
  datacenter : string option; [@option]
      (** The name of the vCenter datacenter for the user cluster. *)
  datastore : string option; [@option]
      (** The name of the vCenter datastore for the user cluster. *)
  folder : string option; [@option]
      (** The name of the vCenter folder for the user cluster. *)
  resource_pool : string option; [@option]
      (** The name of the vCenter resource pool for the user cluster. *)
  storage_policy_name : string option; [@option]
