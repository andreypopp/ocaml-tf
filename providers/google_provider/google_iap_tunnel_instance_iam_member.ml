...
type google_iap_tunnel_instance_iam_member__condition = {
  description : string option; [@option]  (** description *)
  expression : string;  (** expression *)
  title : string;  (** title *)
}
[@@deriving yojson_of]
(** google_iap_tunnel_instance_iam_member__condition *)

type google_iap_tunnel_instance_iam_member = {
  instance : string;  (** instance *)
  member : string;  (** member *)
  role : string;  (** role *)
  condition : google_iap_tunnel_instance_iam_member__condition list;
}
[@@deriving yojson_of]
(** google_iap_tunnel_instance_iam_member *)

let google_iap_tunnel_instance_iam_member ~instance ~member ~role
