...
type google_cloud_run_service__template__spec__containers__env = {
  ...
  value : string option; [@option]  (** Defaults to . *)
  value_from :
...
in the container registry, such as gcr.io/cloudrun/hello *)
  name : string option; [@option]  (** Name of the container *)
...
type google_cloud_run_service__template__spec = {
  container_concurrency : float option; [@option]
...
false when RevisionName is non-empty. *)
  ...
  revision_name : string option; [@option]
...
type google_cloud_run_service = {
  autogenerate_revision_name : bool option; [@option]
...
let google_cloud_run_service ?autogenerate_revision_name ?timeouts
    ~location ~name ~metadata ~template ~traffic __resource_id =
