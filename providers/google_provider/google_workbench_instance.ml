...
type google_workbench_instance__gce_setup__accelerator_configs = {
  ...
  type_: string option; [@option] [@key "type"] (** Optional. Type of this accelerator. Possible values: [NVIDIA_TESLA_P100, NVIDIA_TESLA_V100, NVIDIA_TESLA_P4, NVIDIA_TESLA_T4, NVIDIA_TESLA_A100, NVIDIA_A100_80GB, NVIDIA_L4, NVIDIA_TESLA_T4_VWS, NVIDIA_TESLA_P100_VWS, NVIDIA_TESLA_P4_VWS] *)
} [@@deriving yojson_of]
...
type google_workbench_instance__gce_setup__boot_disk = {
  disk_encryption: string option; [@option] (** Optional. Input only. Disk encryption method used on the boot and
data disks, defaults to GMEK. Possible values: [GMEK, CMEK] *)
  disk_size_gb: string option; [@option] (** Optional. The size of the boot disk in GB attached to this instance,
up to a maximum of 64000 GB (64 TB). If not specified, this defaults to the
recommended value of 150GB. *)
  disk_type: string option; [@option] (** Optional. Indicates the type of the disk. Possible values: [PD_STANDARD, PD_SSD, PD_BALANCED, PD_EXTREME] *)
  kms_key: string option; [@option] (** 'Optional. The KMS key used to encrypt the disks, only
...
For example: gcr.io/{project_id}/{imageName} *)
  tag: string option; [@option] (** The tag of the container image. If not specified, this defaults to the latest tag. *)
} [@@deriving yojson_of]
(** Use a container image to start the workbench instance. *)

type google_workbench_instance__gce_setup__data_disks = {
  disk_encryption: string option; [@option] (** Optional. Input only. Disk encryption method used on the boot
and data disks, defaults to GMEK. Possible values: [GMEK, CMEK] *)
  disk_size_gb: string option; [@option] (** Optional. The size of the disk in GB attached to this VM instance,
up to a maximum of 64000 GB (64 TB). If not specified, this defaults to
100. *)
  disk_type: string option; [@option] (** Optional. Input only. Indicates the type of the disk. Possible values: [PD_STANDARD, PD_SSD, PD_BALANCED, PD_EXTREME] *)
  kms_key: string option; [@option] (** 'Optional. The KMS key used to encrypt the disks,
...
type google_workbench_instance__gce_setup__network_interfaces = {
  network: string option; [@option] (** Optional. The name of the VPC that this VM instance is in. *)
  nic_type: string option; [@option] (** Optional. The type of vNIC to be used on this interface. This
may be gVNIC or VirtioNet. Possible values: [VIRTIO_NET, GVNIC] *)
  subnet: string option; [@option] (** Optional. The name of the subnet that this VM instance is in. *)
} [@@deriving yojson_of]
(** The network interfaces for the VM. Supports only one interface. *)

type google_workbench_instance__gce_setup__service_accounts = {
  email: string option; [@option] (** Optional. Email address of the service account. *)
  scopes: string list;  (** Output only. The list of scopes to be made available for this
...
type google_workbench_instance__gce_setup__shielded_instance_config = {
  enable_integrity_monitoring: bool option; [@option] (** Optional. Defines whether the VM instance has integrity monitoring
enabled. Enables monitoring and attestation of the boot integrity of the VM
instance. The attestation is performed against the integrity policy baseline.
This baseline is initially derived from the implicitly trusted boot image
when the VM instance is created. Enabled by default. *)
  enable_secure_boot: bool option; [@option] (** Optional. Defines whether the VM instance has Secure Boot enabled.
Secure Boot helps ensure that the system only runs authentic software by verifying
the digital signature of all boot components, and halting the boot process
if signature verification fails. Disabled by default. *)
  enable_vtpm: bool option; [@option] (** Optional. Defines whether the VM instance has the vTPM enabled.
Enabled by default. *)
} [@@deriving yojson_of]
...
type google_workbench_instance__gce_setup__vm_image = {
  family: string option; [@option] (** Optional. Use this VM image family to find the image; the newest
image in this family will be used. *)
  name: string option; [@option] (** Optional. Use VM image name to find the image. *)
  project: string option; [@option] (** The name of the Google Cloud project that this VM image belongs to.
Format: {project_id} *)
} [@@deriving yojson_of]
...
type google_workbench_instance__gce_setup = {
  disable_public_ip: bool option; [@option] (** Optional. If true, no external IP will be assigned to this VM instance. *)
  enable_ip_forwarding: bool option; [@option] (** Optional. Flag to enable ip forwarding or not, default false/off.
https://cloud.google.com/vpc/docs/using-routes#canipforward *)
  machine_type: string option; [@option] (** Optional. The machine type of the VM instance. https://cloud.google.com/compute/docs/machine-resource *)
  metadata: (string * string) list option; [@option] (** Optional. Custom metadata to apply to this instance. *)
  tags: string list option; [@option] (** Optional. The Compute Engine tags to add to instance (see [Tagging
...
the service account users of your VM instance''s service account can use the instance.' *)
  labels: (string * string) list option; [@option] (** Optional. Labels to apply to this instance. These can be later modified
