...
type google_cloud_asset_organization_feed__feed_output_config = {
  pubsub_destination :
    google_cloud_asset_organization_feed__feed_output_config__pubsub_destination
    list;
}
[@@deriving yojson_of]
...
enablement check, quota, and billing. *)
  ...
  timeouts : google_cloud_asset_organization_feed__timeouts option;
}
[@@deriving yojson_of]
...
let google_cloud_asset_organization_feed ?asset_names ?asset_types
  ...
  Resource.add ~type_:__resource_type ~id:__resource_id
    (yojson_of_google_cloud_asset_organization_feed __resource);
  ()
