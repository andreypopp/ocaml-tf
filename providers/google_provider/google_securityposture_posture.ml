...
type google_securityposture_posture__policy_sets__policies__compliance_standards = {
  control : string option; [@option]
      (** Mapping of security controls for the policy. *)
  standard : string option; [@option]
...
type google_securityposture_posture__policy_sets__policies__constraint__org_policy_constraint__policy_rules = {
  allow_all : bool option; [@option]
      (** Setting this to true means that all values are allowed. This field can be set only in policies for list constraints. *)
  deny_all : bool option; [@option]
      (** Setting this to true means that all values are denied. This field can be set only in policies for list constraints. *)
  enforce : bool option; [@option]
...
module detects. *)
  recommendation : string option; [@option]
...
returned by this custom module. *)
  id : string;  (** A server generated id of custom module. *)
  module_enablement_state : string option; [@option]
