...
type google_scc_folder_custom_module__custom_config__custom_output__properties = {
  ...
  value_expression :
    google_scc_folder_custom_module__custom_config__custom_output__properties__value_expression
    list;
}
[@@deriving yojson_of]
...
type google_scc_folder_custom_module__custom_config__custom_output = {
  properties :
    google_scc_folder_custom_module__custom_config__custom_output__properties
    list;
}
[@@deriving yojson_of]
...
this module in the nextSteps property of the finding JSON. *)
  ...
  custom_output :
    google_scc_folder_custom_module__custom_config__custom_output
    list;
  predicate :
    google_scc_folder_custom_module__custom_config__predicate list;
  resource_selector :
    google_scc_folder_custom_module__custom_config__resource_selector
    list;
}
[@@deriving yojson_of]
...
[@@deriving yojson_of]
(** google_scc_folder_custom_module__timeouts *)
...
characters or underscores only. *)
  ...
  folder : string prop;  (** Numerical ID of the parent folder. *)
...
let google_scc_folder_custom_module ?id ?timeouts ~display_name
  ...
  Resource.add ~type_:__resource_type ~id:__resource_id
    (yojson_of_google_scc_folder_custom_module __resource);
  ()
