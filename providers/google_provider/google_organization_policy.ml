...
type google_organization_policy__list_policy = {
  ...
  allow : google_organization_policy__list_policy__allow list;
  deny : google_organization_policy__list_policy__deny list;
}
[@@deriving yojson_of]
...
[@@deriving yojson_of]
(** google_organization_policy__timeouts *)
...
type google_organization_policy = {
  ...
  timeouts : google_organization_policy__timeouts option;
}
[@@deriving yojson_of]
(** google_organization_policy *)

let google_organization_policy ?timeouts ~constraint_ ~org_id
