...
to include directives regarding slower scale down, as described above. *)
  max_scaled_in_replicas :
    google_compute_autoscaler__autoscaling_policy__scale_in_control__max_scaled_in_replicas
    list;
}
[@@deriving yojson_of]
...
allowed. *)
  ...
  load_balancing_utilization :
    google_compute_autoscaler__autoscaling_policy__load_balancing_utilization
    list;
  metric :
    google_compute_autoscaler__autoscaling_policy__metric list;
  scale_in_control :
    google_compute_autoscaler__autoscaling_policy__scale_in_control
    list;
  scaling_schedules :
    google_compute_autoscaler__autoscaling_policy__scaling_schedules
    list;
}
[@@deriving yojson_of]
