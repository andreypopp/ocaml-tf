...
type aws_opsworks_rails_app_layer = {
  app_server : string option; [@option]  (** app_server *)
  ...
  bundler_version : string option; [@option]  (** bundler_version *)
  ...
  manage_bundler : bool option; [@option]  (** manage_bundler *)
  name : string option; [@option]  (** name *)
  passenger_version : string option; [@option]
      (** passenger_version *)
  ruby_version : string option; [@option]  (** ruby_version *)
  rubygems_version : string option; [@option]
      (** rubygems_version *)
...
let aws_opsworks_rails_app_layer ?app_server ?auto_assign_elastic_ips
    ...
    ?rubygems_version ?system_packages ?tags
