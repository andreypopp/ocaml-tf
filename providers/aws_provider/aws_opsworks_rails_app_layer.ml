...
[@@deriving yojson_of]
(** aws_opsworks_rails_app_layer__cloudwatch_configuration__log_streams *)

type aws_opsworks_rails_app_layer__cloudwatch_configuration = {
...
[@@deriving yojson_of]
(** aws_opsworks_rails_app_layer__cloudwatch_configuration *)

type aws_opsworks_rails_app_layer__ebs_volume = {
...
[@@deriving yojson_of]
(** aws_opsworks_rails_app_layer__ebs_volume *)

type aws_opsworks_rails_app_layer__load_based_auto_scaling__downscaling = {
...
[@@deriving yojson_of]
(** aws_opsworks_rails_app_layer__load_based_auto_scaling__downscaling *)

type aws_opsworks_rails_app_layer__load_based_auto_scaling__upscaling = {
  alarms : string prop list option; [@option]  (** alarms *)
  cpu_threshold : float prop option; [@option]  (** cpu_threshold *)
  ignore_metrics_time : float prop option; [@option]
      (** ignore_metrics_time *)
...
[@@deriving yojson_of]
(** aws_opsworks_rails_app_layer__load_based_auto_scaling__upscaling *)

type aws_opsworks_rails_app_layer__load_based_auto_scaling = {
...
[@@deriving yojson_of]
(** aws_opsworks_rails_app_layer__load_based_auto_scaling *)

type aws_opsworks_rails_app_layer = {
  app_server : string prop option; [@option]  (** app_server *)
  ...
  manage_bundler : bool prop option; [@option]  (** manage_bundler *)
  ...
  load_based_auto_scaling :
    aws_opsworks_rails_app_layer__load_based_auto_scaling list;
}
[@@deriving yojson_of]
...
let aws_opsworks_rails_app_layer ?app_server ?auto_assign_elastic_ips
  ...
  let __resource_type = "aws_opsworks_rails_app_layer" in
  let __resource =
    ({
       app_server;
       auto_assign_elastic_ips;
  ...
  Resource.add ~type_:__resource_type ~id:__resource_id
    (yojson_of_aws_opsworks_rails_app_layer __resource);
    ...
    ({
       ...
       instance_shutdown_timeout =
         Prop.computed __resource_type __resource_id
           "instance_shutdown_timeout";
       manage_bundler =
         Prop.computed __resource_type __resource_id "manage_bundler";
       name = Prop.computed __resource_type __resource_id "name";
       passenger_version =
         Prop.computed __resource_type __resource_id
           "passenger_version";
       ruby_version =
         Prop.computed __resource_type __resource_id "ruby_version";
       rubygems_version =
         Prop.computed __resource_type __resource_id
           "rubygems_version";
       stack_id =
