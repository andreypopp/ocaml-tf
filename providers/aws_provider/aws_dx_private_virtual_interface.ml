...
let aws_dx_private_virtual_interface ?dx_gateway_id ?mtu
    ?sitelink_enabled ?tags ?vpn_gateway_id ?timeouts ~address_family
    ~bgp_asn ~connection_id ~name ~vlan __resource_id =
