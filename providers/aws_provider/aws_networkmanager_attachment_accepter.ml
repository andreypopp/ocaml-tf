...
let aws_networkmanager_attachment_accepter ?timeouts ~attachment_id
    ~attachment_type __resource_id =
  let __resource_type = "aws_networkmanager_attachment_accepter" in
  let __resource = { attachment_id; attachment_type; timeouts } in
