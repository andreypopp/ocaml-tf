...
type aws_quicksight_data_set__data_set_usage_configuration = {
  disable_use_as_direct_query_source : bool option; [@option]
      (** disable_use_as_direct_query_source *)
  disable_use_as_imported_source : bool option; [@option]
...
type aws_quicksight_data_set__logical_table_map__data_transforms__tag_column_operation__tags = {
  column_geographic_role : string option; [@option]
...
type aws_quicksight_data_set__logical_table_map__source = {
  ...
  physical_table_id : string option; [@option]
      (** physical_table_id *)
  join_instruction :
    aws_quicksight_data_set__logical_table_map__source__join_instruction
    list;
...
type aws_quicksight_data_set__logical_table_map = {
  ...
  data_transforms :
    aws_quicksight_data_set__logical_table_map__data_transforms list;
...
type aws_quicksight_data_set__physical_table_map = {
  ...
  custom_sql :
    aws_quicksight_data_set__physical_table_map__custom_sql list;
  relational_table :
    aws_quicksight_data_set__physical_table_map__relational_table
    list;
  s3_source :
    aws_quicksight_data_set__physical_table_map__s3_source list;
}
[@@deriving yojson_of]
...
type aws_quicksight_data_set__row_level_permission_tag_configuration__tag_rules = {
  ...
  tag_multi_value_delimiter : string option; [@option]
...
type aws_quicksight_data_set = {
  ...
  column_level_permission_rules :
    aws_quicksight_data_set__column_level_permission_rules list;
  data_set_usage_configuration :
    aws_quicksight_data_set__data_set_usage_configuration list;
  field_folders : aws_quicksight_data_set__field_folders list;
  logical_table_map :
    aws_quicksight_data_set__logical_table_map list;
  permissions : aws_quicksight_data_set__permissions list;
  physical_table_map :
    aws_quicksight_data_set__physical_table_map list;
  refresh_properties :
    aws_quicksight_data_set__refresh_properties list;
  row_level_permission_data_set :
    aws_quicksight_data_set__row_level_permission_data_set list;
...
let aws_quicksight_data_set ?tags ~data_set_id ~import_mode ~name
    ~column_groups ~column_level_permission_rules
    ~data_set_usage_configuration ~field_folders ~logical_table_map
    ~permissions ~physical_table_map ~refresh_properties
    ~row_level_permission_data_set
    ~row_level_permission_tag_configuration __resource_id =
