...
type aws_opsworks_ecs_cluster_layer__cloudwatch_configuration__log_streams = {
...
[@@deriving yojson_of]
(** aws_opsworks_ecs_cluster_layer__cloudwatch_configuration__log_streams *)

type aws_opsworks_ecs_cluster_layer__cloudwatch_configuration = {
...
[@@deriving yojson_of]
(** aws_opsworks_ecs_cluster_layer__cloudwatch_configuration *)

type aws_opsworks_ecs_cluster_layer__ebs_volume = {
...
[@@deriving yojson_of]
(** aws_opsworks_ecs_cluster_layer__ebs_volume *)

type aws_opsworks_ecs_cluster_layer__load_based_auto_scaling__downscaling = {
...
[@@deriving yojson_of]
(** aws_opsworks_ecs_cluster_layer__load_based_auto_scaling__downscaling *)

type aws_opsworks_ecs_cluster_layer__load_based_auto_scaling__upscaling = {
  alarms : string list option; [@option]  (** alarms *)
  cpu_threshold : float option; [@option]  (** cpu_threshold *)
  ignore_metrics_time : float option; [@option]
      (** ignore_metrics_time *)
...
[@@deriving yojson_of]
(** aws_opsworks_ecs_cluster_layer__load_based_auto_scaling__upscaling *)

type aws_opsworks_ecs_cluster_layer__load_based_auto_scaling = {
...
[@@deriving yojson_of]
(** aws_opsworks_ecs_cluster_layer__load_based_auto_scaling *)
...
type aws_opsworks_ecs_cluster_layer = {
  ...
  ecs_cluster_arn : string;  (** ecs_cluster_arn *)
  ...
  cloudwatch_configuration :
    aws_opsworks_ecs_cluster_layer__cloudwatch_configuration list;
  ebs_volume : aws_opsworks_ecs_cluster_layer__ebs_volume list;
  load_based_auto_scaling :
    aws_opsworks_ecs_cluster_layer__load_based_auto_scaling list;
}
[@@deriving yojson_of]
...
let aws_opsworks_ecs_cluster_layer ?auto_assign_elastic_ips
    ...
    ?system_packages ?tags ?use_ebs_optimized_instances
    ~ecs_cluster_arn ~stack_id ~cloudwatch_configuration ~ebs_volume
    ~load_based_auto_scaling __resource_id =
  let __resource_type = "aws_opsworks_ecs_cluster_layer" in
  let __resource =
    {
      auto_assign_elastic_ips;
      auto_assign_public_ips;
  ...
  Resource.add ~type_:__resource_type ~id:__resource_id
    (yojson_of_aws_opsworks_ecs_cluster_layer __resource);
  ()
