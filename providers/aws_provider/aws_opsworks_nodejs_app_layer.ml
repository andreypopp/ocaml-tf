...
type aws_opsworks_nodejs_app_layer__cloudwatch_configuration__log_streams = {
...
[@@deriving yojson_of]
(** aws_opsworks_nodejs_app_layer__cloudwatch_configuration__log_streams *)

type aws_opsworks_nodejs_app_layer__cloudwatch_configuration = {
...
[@@deriving yojson_of]
(** aws_opsworks_nodejs_app_layer__cloudwatch_configuration *)

type aws_opsworks_nodejs_app_layer__ebs_volume = {
...
[@@deriving yojson_of]
(** aws_opsworks_nodejs_app_layer__ebs_volume *)

type aws_opsworks_nodejs_app_layer__load_based_auto_scaling__downscaling = {
...
[@@deriving yojson_of]
(** aws_opsworks_nodejs_app_layer__load_based_auto_scaling__downscaling *)

type aws_opsworks_nodejs_app_layer__load_based_auto_scaling__upscaling = {
  alarms : string list option; [@option]  (** alarms *)
  cpu_threshold : float option; [@option]  (** cpu_threshold *)
  ignore_metrics_time : float option; [@option]
      (** ignore_metrics_time *)
...
[@@deriving yojson_of]
(** aws_opsworks_nodejs_app_layer__load_based_auto_scaling__upscaling *)

type aws_opsworks_nodejs_app_layer__load_based_auto_scaling = {
...
[@@deriving yojson_of]
(** aws_opsworks_nodejs_app_layer__load_based_auto_scaling *)
...
type aws_opsworks_nodejs_app_layer = {
  ...
  nodejs_version : string option; [@option]  (** nodejs_version *)
  ...
  cloudwatch_configuration :
    aws_opsworks_nodejs_app_layer__cloudwatch_configuration list;
  ebs_volume : aws_opsworks_nodejs_app_layer__ebs_volume list;
  load_based_auto_scaling :
    aws_opsworks_nodejs_app_layer__load_based_auto_scaling list;
}
[@@deriving yojson_of]
...
let aws_opsworks_nodejs_app_layer ?auto_assign_elastic_ips
    ...
    ?nodejs_version ?system_packages ?tags
