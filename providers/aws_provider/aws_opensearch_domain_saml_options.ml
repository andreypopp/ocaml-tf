...
[@@deriving yojson_of]
(** aws_opensearch_domain_saml_options__saml_options__idp *)
...
type aws_opensearch_domain_saml_options__saml_options = {
  ...
  idp : aws_opensearch_domain_saml_options__saml_options__idp list;
}
[@@deriving yojson_of]
(** aws_opensearch_domain_saml_options__saml_options *)
...
[@@deriving yojson_of]
(** aws_opensearch_domain_saml_options__timeouts *)

type aws_opensearch_domain_saml_options = {
  domain_name : string;  (** domain_name *)
  saml_options :
    aws_opensearch_domain_saml_options__saml_options list;
  timeouts : aws_opensearch_domain_saml_options__timeouts option;
}
[@@deriving yojson_of]
(** aws_opensearch_domain_saml_options *)

let aws_opensearch_domain_saml_options ?timeouts ~domain_name
