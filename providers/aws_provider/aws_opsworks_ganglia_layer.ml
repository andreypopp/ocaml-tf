...
[@@deriving yojson_of]
(** aws_opsworks_ganglia_layer__cloudwatch_configuration__log_streams *)
...
[@@deriving yojson_of]
(** aws_opsworks_ganglia_layer__cloudwatch_configuration *)
...
[@@deriving yojson_of]
(** aws_opsworks_ganglia_layer__ebs_volume *)
...
[@@deriving yojson_of]
(** aws_opsworks_ganglia_layer__load_based_auto_scaling__downscaling *)
...
[@@deriving yojson_of]
(** aws_opsworks_ganglia_layer__load_based_auto_scaling__upscaling *)
...
[@@deriving yojson_of]
(** aws_opsworks_ganglia_layer__load_based_auto_scaling *)
...
let aws_opsworks_ganglia_layer ?auto_assign_elastic_ips
    ...
    ?system_packages ?tags ?url ?use_ebs_optimized_instances
    ?username ~password ~stack_id ~cloudwatch_configuration
    ~ebs_volume ~load_based_auto_scaling __resource_id =
  let __resource_type = "aws_opsworks_ganglia_layer" in
  let __resource =
    {
      auto_assign_elastic_ips;
      auto_assign_public_ips;
  ...
  Resource.add ~type_:__resource_type ~id:__resource_id
    (yojson_of_aws_opsworks_ganglia_layer __resource);
  ()
