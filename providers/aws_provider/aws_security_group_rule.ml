...
let aws_security_group_rule ?cidr_blocks ?description
    ?ipv6_cidr_blocks ?prefix_list_ids ?self ?timeouts ~from_port
    ~protocol ~security_group_id ~to_port ~type_ __resource_id =
