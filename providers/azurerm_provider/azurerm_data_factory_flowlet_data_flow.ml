...
type azurerm_data_factory_flowlet_data_flow__sink = {
  ...
  flowlet :
    azurerm_data_factory_flowlet_data_flow__sink__flowlet list;
  linked_service :
    azurerm_data_factory_flowlet_data_flow__sink__linked_service list;
...
type azurerm_data_factory_flowlet_data_flow__source = {
  ...
  flowlet :
    azurerm_data_factory_flowlet_data_flow__source__flowlet list;
  linked_service :
    azurerm_data_factory_flowlet_data_flow__source__linked_service
    list;
  rejected_linked_service :
...
let azurerm_data_factory_flowlet_data_flow ?annotations ?description
    ?folder ?script ?script_lines ?timeouts ~data_factory_id ~name
    ~sink ~source ~transformation __resource_id =
  let __resource_type = "azurerm_data_factory_flowlet_data_flow" in
  let __resource =
    {
      annotations;
      data_factory_id;
  ...
  Resource.add ~type_:__resource_type ~id:__resource_id
    (yojson_of_azurerm_data_factory_flowlet_data_flow __resource);
  ()
