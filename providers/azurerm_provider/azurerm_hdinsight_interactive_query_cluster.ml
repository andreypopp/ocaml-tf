...
type azurerm_hdinsight_interactive_query_cluster__metastores = {
  ambari :
    azurerm_hdinsight_interactive_query_cluster__metastores__ambari
    list;
  hive :
...
[@@deriving yojson_of]
(** azurerm_hdinsight_interactive_query_cluster__roles__worker_node__autoscale__recurrence *)

type azurerm_hdinsight_interactive_query_cluster__roles__worker_node__autoscale = {
  capacity :
    azurerm_hdinsight_interactive_query_cluster__roles__worker_node__autoscale__capacity
    list;
  recurrence :
...
[@@deriving yojson_of]
(** azurerm_hdinsight_interactive_query_cluster__roles__zookeeper_node *)

type azurerm_hdinsight_interactive_query_cluster__roles = {
  head_node :
    azurerm_hdinsight_interactive_query_cluster__roles__head_node
    list;
  worker_node :
...
type azurerm_hdinsight_interactive_query_cluster = {
  ...
  compute_isolation :
    ...
    list;
  disk_encryption :
    azurerm_hdinsight_interactive_query_cluster__disk_encryption list;
  extension :
    azurerm_hdinsight_interactive_query_cluster__extension list;
  gateway :
    azurerm_hdinsight_interactive_query_cluster__gateway list;
  metastores :
    azurerm_hdinsight_interactive_query_cluster__metastores list;
  monitor :
    azurerm_hdinsight_interactive_query_cluster__monitor list;
  network :
    azurerm_hdinsight_interactive_query_cluster__network list;
  roles : azurerm_hdinsight_interactive_query_cluster__roles list;
  security_profile :
    azurerm_hdinsight_interactive_query_cluster__security_profile
    list;
  storage_account :
    azurerm_hdinsight_interactive_query_cluster__storage_account list;
  storage_account_gen2 :
    azurerm_hdinsight_interactive_query_cluster__storage_account_gen2
    list;
  timeouts :
    azurerm_hdinsight_interactive_query_cluster__timeouts option;
}
[@@deriving yojson_of]
(** azurerm_hdinsight_interactive_query_cluster *)

let azurerm_hdinsight_interactive_query_cluster ?tags
  ...
  Resource.add ~type_:__resource_type ~id:__resource_id
    (yojson_of_azurerm_hdinsight_interactive_query_cluster __resource);
  ()
