...
type azurerm_resource_policy_remediation__timeouts = {
...
[@@deriving yojson_of]
(** azurerm_resource_policy_remediation__timeouts *)
...
type azurerm_resource_policy_remediation = {
  ...
  timeouts : azurerm_resource_policy_remediation__timeouts option;
}
[@@deriving yojson_of]
(** azurerm_resource_policy_remediation *)

let azurerm_resource_policy_remediation ?failure_percentage
