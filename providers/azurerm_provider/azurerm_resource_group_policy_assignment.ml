...
[@@deriving yojson_of]
(** azurerm_resource_group_policy_assignment__identity *)
...
[@@deriving yojson_of]
(** azurerm_resource_group_policy_assignment__overrides__selectors *)
...
[@@deriving yojson_of]
(** azurerm_resource_group_policy_assignment__overrides *)
...
[@@deriving yojson_of]
(** azurerm_resource_group_policy_assignment__resource_selectors__selectors *)
...
[@@deriving yojson_of]
(** azurerm_resource_group_policy_assignment__resource_selectors *)
...
[@@deriving yojson_of]
(** azurerm_resource_group_policy_assignment__timeouts *)
...
type azurerm_resource_group_policy_assignment = {
  ...
  non_compliance_message :
    ...
    list;
  overrides :
    azurerm_resource_group_policy_assignment__overrides list;
  resource_selectors :
    azurerm_resource_group_policy_assignment__resource_selectors list;
  timeouts :
    azurerm_resource_group_policy_assignment__timeouts option;
}
[@@deriving yojson_of]
...
let azurerm_resource_group_policy_assignment ?description
    ...
    ?timeouts ~name ~policy_definition_id ~resource_group_id
