...
let azurerm_sentinel_data_connector_threat_intelligence
    ?lookback_date ?timeouts ~log_analytics_workspace_id ~name
    __resource_id =
  let __resource_type =
    "azurerm_sentinel_data_connector_threat_intelligence"
  in
  let __resource =
    { log_analytics_workspace_id; lookback_date; name; timeouts }
  in
