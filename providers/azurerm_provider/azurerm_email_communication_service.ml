...
[@@deriving yojson_of]
(** azurerm_email_communication_service__timeouts *)
...
type azurerm_email_communication_service = {
  ...
  timeouts : azurerm_email_communication_service__timeouts option;
}
[@@deriving yojson_of]
(** azurerm_email_communication_service *)

let azurerm_email_communication_service ?tags ?timeouts
