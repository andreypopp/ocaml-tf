...
[@@deriving yojson_of]
(** azurerm_function_app_active_slot__timeouts *)
...
type azurerm_function_app_active_slot = {
  ...
  timeouts : azurerm_function_app_active_slot__timeouts option;
}
[@@deriving yojson_of]
(** azurerm_function_app_active_slot *)

let azurerm_function_app_active_slot ?overwrite_network_config
