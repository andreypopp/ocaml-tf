...
type azurerm_windows_web_app__auth_settings = {
  ...
  facebook : azurerm_windows_web_app__auth_settings__facebook list;
  github : azurerm_windows_web_app__auth_settings__github list;
  google : azurerm_windows_web_app__auth_settings__google list;
  microsoft : azurerm_windows_web_app__auth_settings__microsoft list;
  twitter : azurerm_windows_web_app__auth_settings__twitter list;
}
[@@deriving yojson_of]
...
type azurerm_windows_web_app__auth_settings_v2 = {
  ...
  active_directory_v2 :
    ...
    list;
  apple_v2 :
    azurerm_windows_web_app__auth_settings_v2__apple_v2 list;
  azure_static_web_app_v2 :
    azurerm_windows_web_app__auth_settings_v2__azure_static_web_app_v2
    list;
  custom_oidc_v2 :
    azurerm_windows_web_app__auth_settings_v2__custom_oidc_v2 list;
  facebook_v2 :
    azurerm_windows_web_app__auth_settings_v2__facebook_v2 list;
  github_v2 :
    azurerm_windows_web_app__auth_settings_v2__github_v2 list;
  google_v2 :
    azurerm_windows_web_app__auth_settings_v2__google_v2 list;
  login : azurerm_windows_web_app__auth_settings_v2__login list;
  microsoft_v2 :
    azurerm_windows_web_app__auth_settings_v2__microsoft_v2 list;
  twitter_v2 :
    azurerm_windows_web_app__auth_settings_v2__twitter_v2 list;
}
[@@deriving yojson_of]
...
type azurerm_windows_web_app__logs__http_logs = {
  azure_blob_storage :
    azurerm_windows_web_app__logs__http_logs__azure_blob_storage list;
  file_system :
    azurerm_windows_web_app__logs__http_logs__file_system list;
}
[@@deriving yojson_of]
...
type azurerm_windows_web_app__logs = {
  ...
  http_logs : azurerm_windows_web_app__logs__http_logs list;
}
[@@deriving yojson_of]
...
[@@deriving yojson_of]
(** azurerm_windows_web_app__site_config__auto_heal_setting__trigger *)

type azurerm_windows_web_app__site_config__auto_heal_setting = {
  action :
    azurerm_windows_web_app__site_config__auto_heal_setting__action
    list;
  trigger :
...
type azurerm_windows_web_app__site_config = {
  ...
  auto_heal_setting :
    azurerm_windows_web_app__site_config__auto_heal_setting list;
  cors : azurerm_windows_web_app__site_config__cors list;
  ip_restriction :
    azurerm_windows_web_app__site_config__ip_restriction list;
  scm_ip_restriction :
    azurerm_windows_web_app__site_config__scm_ip_restriction list;
  virtual_application :
    azurerm_windows_web_app__site_config__virtual_application list;
}
[@@deriving yojson_of]
...
type azurerm_windows_web_app = {
  ...
  connection_string :
    azurerm_windows_web_app__connection_string list;
  identity : azurerm_windows_web_app__identity list;
  logs : azurerm_windows_web_app__logs list;
  site_config : azurerm_windows_web_app__site_config list;
  sticky_settings : azurerm_windows_web_app__sticky_settings list;
  storage_account : azurerm_windows_web_app__storage_account list;
  timeouts : azurerm_windows_web_app__timeouts option;
}
[@@deriving yojson_of]
...
type t = {
  ...
  site_credential :
    azurerm_windows_web_app__site_credential list prop;
