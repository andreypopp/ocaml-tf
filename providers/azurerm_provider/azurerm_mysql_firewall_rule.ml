...
[@@deriving yojson_of]
(** azurerm_mysql_firewall_rule__timeouts *)
...
type azurerm_mysql_firewall_rule = {
  ...
  timeouts : azurerm_mysql_firewall_rule__timeouts option;
}
[@@deriving yojson_of]
(** azurerm_mysql_firewall_rule *)

let azurerm_mysql_firewall_rule ?timeouts ~end_ip_address ~name
