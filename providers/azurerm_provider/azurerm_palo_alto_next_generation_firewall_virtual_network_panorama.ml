...
type azurerm_palo_alto_next_generation_firewall_virtual_network_panorama__destination_nat__backend_config = {
  port : float prop;  (** port *)
  public_ip_address : string prop;  (** public_ip_address *)
}
[@@deriving yojson_of]
(** azurerm_palo_alto_next_generation_firewall_virtual_network_panorama__destination_nat__backend_config *)

type azurerm_palo_alto_next_generation_firewall_virtual_network_panorama__destination_nat__frontend_config = {
  port : float prop;  (** port *)
  public_ip_address_id : string prop;  (** public_ip_address_id *)
}
[@@deriving yojson_of]
(** azurerm_palo_alto_next_generation_firewall_virtual_network_panorama__destination_nat__frontend_config *)

type azurerm_palo_alto_next_generation_firewall_virtual_network_panorama__destination_nat = {
...
[@@deriving yojson_of]
(** azurerm_palo_alto_next_generation_firewall_virtual_network_panorama__destination_nat *)

type azurerm_palo_alto_next_generation_firewall_virtual_network_panorama__dns_settings = {
...
[@@deriving yojson_of]
(** azurerm_palo_alto_next_generation_firewall_virtual_network_panorama__dns_settings *)

type azurerm_palo_alto_next_generation_firewall_virtual_network_panorama__network_profile__vnet_configuration = {
...
[@@deriving yojson_of]
(** azurerm_palo_alto_next_generation_firewall_virtual_network_panorama__network_profile__vnet_configuration *)

type azurerm_palo_alto_next_generation_firewall_virtual_network_panorama__network_profile = {
...
type azurerm_palo_alto_next_generation_firewall_virtual_network_panorama__timeouts = {
...
[@@deriving yojson_of]
(** azurerm_palo_alto_next_generation_firewall_virtual_network_panorama__timeouts *)

type azurerm_palo_alto_next_generation_firewall_virtual_network_panorama__panorama = {
