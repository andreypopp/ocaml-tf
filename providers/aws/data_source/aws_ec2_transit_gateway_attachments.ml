...
let _ = fun (_ : aws_ec2_transit_gateway_attachments) -> ()

let yojson_of_aws_ec2_transit_gateway_attachments =
  (function
   | {
       id = v_id;
       tags = v_tags;
...
let _ = yojson_of_aws_ec2_transit_gateway_attachments
...
let aws_ec2_transit_gateway_attachments ?id ?tags ?timeouts ~filter
    () : aws_ec2_transit_gateway_attachments =
...
let make ?id ?tags ?timeouts ~filter __id =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_ec2_transit_gateway_attachments
        (aws_ec2_transit_gateway_attachments ?id ?tags ?timeouts
           ~filter ());
    attrs = __attrs;
  }
