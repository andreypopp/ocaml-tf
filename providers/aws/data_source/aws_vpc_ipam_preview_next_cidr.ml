...
let aws_vpc_ipam_preview_next_cidr ?disallowed_cidrs ?id
    ?netmask_length ?timeouts ~ipam_pool_id () :
    aws_vpc_ipam_preview_next_cidr =
  { disallowed_cidrs; id; ipam_pool_id; netmask_length; timeouts }
...
let make ?disallowed_cidrs ?id ?netmask_length ?timeouts
    ~ipam_pool_id __id =
...
let register ?tf_module ?disallowed_cidrs ?id ?netmask_length
  ...
  let (r : _ Tf_core.resource) =
    make ?disallowed_cidrs ?id ?netmask_length ?timeouts
      ~ipam_pool_id __id
  in
