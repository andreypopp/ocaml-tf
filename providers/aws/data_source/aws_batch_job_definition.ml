  ...
  (function
   | {
       ...
       let bnds =
         ...
         in
         ("resource_requirements", arg) :: bnds
       in
       let bnds =
         let arg =
       ...
       let bnds =
         let arg =
           yojson_of_list
             ...
             v_fargate_platform_configuration
         in
         ("fargate_platform_configuration", arg) :: bnds
       in
       let bnds =
         let arg =
  ...
  (function
   | {
       ...
       let bnds =
         ...
         in
         ("node_range_properties", arg) :: bnds
       in
       let bnds =
