...
let _ = fun (_ : aws_ec2_transit_gateway_vpc_attachments) -> ()

let yojson_of_aws_ec2_transit_gateway_vpc_attachments =
  (function
...
let _ = yojson_of_aws_ec2_transit_gateway_vpc_attachments
...
let aws_ec2_transit_gateway_vpc_attachments ?id ?timeouts ~filter ()
    : aws_ec2_transit_gateway_vpc_attachments =
  { id; filter; timeouts }
...
let make ?id ?timeouts ~filter __id =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_ec2_transit_gateway_vpc_attachments
        (aws_ec2_transit_gateway_vpc_attachments ?id ?timeouts
           ~filter ());
    attrs = __attrs;
  }
