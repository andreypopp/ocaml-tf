...
let _ =
 fun (_ : aws_ec2_local_gateway_virtual_interface_groups) -> ()

let yojson_of_aws_ec2_local_gateway_virtual_interface_groups =
  (function
   | {
       id = v_id;
       tags = v_tags;
...
let _ = yojson_of_aws_ec2_local_gateway_virtual_interface_groups
...
let aws_ec2_local_gateway_virtual_interface_groups ?id ?tags
    ?timeouts ~filter () :
    aws_ec2_local_gateway_virtual_interface_groups =
...
let make ?id ?tags ?timeouts ~filter __id =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_ec2_local_gateway_virtual_interface_groups
        (aws_ec2_local_gateway_virtual_interface_groups ?id ?tags
           ?timeouts ~filter ());
    attrs = __attrs;
  }
