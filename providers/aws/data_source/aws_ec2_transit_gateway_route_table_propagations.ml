...
type aws_ec2_transit_gateway_route_table_propagations = {
...
let _ =
 fun (_ : aws_ec2_transit_gateway_route_table_propagations) -> ()

let yojson_of_aws_ec2_transit_gateway_route_table_propagations =
  (function
   | {
       id = v_id;
...
let _ = yojson_of_aws_ec2_transit_gateway_route_table_propagations
...
let aws_ec2_transit_gateway_route_table_propagations ?id ?timeouts
...
let make ?id ?timeouts ~transit_gateway_route_table_id ~filter __id =
  let __type = "aws_ec2_transit_gateway_route_table_propagations" in
  let __attrs =
    ({
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_ec2_transit_gateway_route_table_propagations
        (aws_ec2_transit_gateway_route_table_propagations ?id
