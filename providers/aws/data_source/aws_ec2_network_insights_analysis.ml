  ...
  (function
   | {
       ...
       let bnds =
         ...
         in
         ("vpc_peering_connection", arg) :: bnds
       in
       let bnds =
         let arg =
       ...
       let bnds =
         let arg =
           yojson_of_list
             ...
             v_transit_gateway_route_table_route
         in
         ("transit_gateway_route_table_route", arg) :: bnds
       in
       let bnds =
         let arg =
           yojson_of_list
         ...
         in
         ("transit_gateway_route_table", arg) :: bnds
       in
       let bnds =
         let arg =
           yojson_of_list
         ...
         in
         ("transit_gateway_attachment", arg) :: bnds
       in
       let bnds =
         let arg =
           yojson_of_list yojson_of_explanations__transit_gateway
             v_transit_gateway
         in
         ("transit_gateway", arg) :: bnds
       in
       let bnds =
         let arg =
           yojson_of_list yojson_of_explanations__subnet_route_table
             v_subnet_route_table
         in
         ("subnet_route_table", arg) :: bnds
       in
       let bnds =
         let arg =
       ...
       let bnds =
         let arg =
           yojson_of_list yojson_of_explanations__security_group_rule
             v_security_group_rule
         in
         ("security_group_rule", arg) :: bnds
       in
       let bnds =
         let arg =
       ...
       let bnds =
         let arg =
           yojson_of_list yojson_of_explanations__route_table_route
             v_route_table_route
         in
         ("route_table_route", arg) :: bnds
       in
       let bnds =
         let arg =
       ...
       let bnds =
         let arg =
           yojson_of_list yojson_of_explanations__network_interface
             v_network_interface
         in
       ...
       let bnds =
         ...
         in
         ("load_balancer_target_groups", arg) :: bnds
       in
       let bnds =
         let arg =
           yojson_of_list
         ...
         in
         ("load_balancer_target_group", arg) :: bnds
       in
       let bnds =
         let arg =
       ...
       let bnds =
         let arg =
           yojson_of_list yojson_of_explanations__internet_gateway
             v_internet_gateway
         in
         ("internet_gateway", arg) :: bnds
       in
       let bnds =
         let arg =
           yojson_of_list yojson_of_explanations__ingress_route_table
             v_ingress_route_table
         in
         ("ingress_route_table", arg) :: bnds
       in
       let bnds =
         let arg =
       ...
       let bnds =
         let arg =
           yojson_of_list
             ...
             v_elastic_load_balancer_listener
         in
         ("elastic_load_balancer_listener", arg) :: bnds
       in
       let bnds =
         let arg = yojson_of_prop yojson_of_string v_direction in
         ("direction", arg) :: bnds
       ...
       let bnds =
         let arg =
           yojson_of_list
             ...
             v_classic_load_balancer_listener
         in
         ("classic_load_balancer_listener", arg) :: bnds
       in
       let bnds =
         let arg =
       ...
       let bnds =
         let arg =
           yojson_of_list yojson_of_explanations__acl_rule v_acl_rule
         in
         ("acl_rule", arg) :: bnds
       in
       let bnds =
...
let yojson_of_forward_path_components =
  (function
   | {
       ...
       let bnds =
         let arg =
           yojson_of_list yojson_of_forward_path_components__subnet
             v_subnet
         in
         ("subnet", arg) :: bnds
       in
       ...
       let bnds =
         let arg =
           yojson_of_list
             yojson_of_forward_path_components__component v_component
         in
         ("component", arg) :: bnds
       in
       let bnds =
       ...
       let bnds =
         let arg =
           yojson_of_list yojson_of_forward_path_components__acl_rule
             v_acl_rule
         in
         ("acl_rule", arg) :: bnds
       in
...
let yojson_of_return_path_components =
  (function
   | {
       ...
       let bnds =
         let arg =
           yojson_of_list yojson_of_return_path_components__vpc v_vpc
         in
         ("vpc", arg) :: bnds
       in
       let bnds =
       ...
       let bnds =
         let arg =
           yojson_of_list yojson_of_return_path_components__component
             v_component
         in
         ("component", arg) :: bnds
       in
       ...
       let bnds =
         let arg =
           yojson_of_list yojson_of_return_path_components__acl_rule
             v_acl_rule
         in
         ("acl_rule", arg) :: bnds
       in
...
let yojson_of_aws_ec2_network_insights_analysis =
  (function
   | {
       id = v_id;
       network_insights_analysis_id = v_network_insights_analysis_id;
       tags = v_tags;
       filter = v_filter;
     } ->
       let bnds : (string * Ppx_yojson_conv_lib.Yojson.Safe.t) list =
       ...
       in
       let bnds =
         match v_network_insights_analysis_id with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "network_insights_analysis_id", arg in
             bnd :: bnds
       in
       let bnds =
         match v_id with
...
let aws_ec2_network_insights_analysis ?id
    ?network_insights_analysis_id ?tags ~filter () :
    aws_ec2_network_insights_analysis =
  { id; network_insights_analysis_id; tags; filter }
...
let make ?id ?network_insights_analysis_id ?tags ~filter __id =
  ...
  let __attrs =
    ({
       ...
       network_insights_analysis_id =
         Prop.computed __type __id "network_insights_analysis_id";
  ...
  in
  {
    ...
    json =
      yojson_of_aws_ec2_network_insights_analysis
        (aws_ec2_network_insights_analysis ?id
           ?network_insights_analysis_id ?tags ~filter ());
    attrs = __attrs;
  }

let register ?tf_module ?id ?network_insights_analysis_id ?tags
    ~filter __id =
  let (r : _ Tf_core.resource) =
    make ?id ?network_insights_analysis_id ?tags ~filter __id
  in
