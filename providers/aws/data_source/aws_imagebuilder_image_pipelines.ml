...
let _ = fun (_ : aws_imagebuilder_image_pipelines) -> ()

let yojson_of_aws_imagebuilder_image_pipelines =
  (function
...
let _ = yojson_of_aws_imagebuilder_image_pipelines

[@@@deriving.end]

let filter ~name ~values () : filter = { name; values }

let aws_imagebuilder_image_pipelines ?id ~filter () :
    aws_imagebuilder_image_pipelines =
  { id; filter }
...
let make ?id ~filter __id =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_imagebuilder_image_pipelines
        (aws_imagebuilder_image_pipelines ?id ~filter ());
    attrs = __attrs;
  }
