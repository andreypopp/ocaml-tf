...
let _ = fun (_ : aws_imagebuilder_container_recipes) -> ()

let yojson_of_aws_imagebuilder_container_recipes =
  (function
...
let _ = yojson_of_aws_imagebuilder_container_recipes

[@@@deriving.end]

let filter ~name ~values () : filter = { name; values }

let aws_imagebuilder_container_recipes ?id ?owner ~filter () :
    aws_imagebuilder_container_recipes =
  { id; owner; filter }
...
let make ?id ?owner ~filter __id =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_imagebuilder_container_recipes
        (aws_imagebuilder_container_recipes ?id ?owner ~filter ());
    attrs = __attrs;
  }
