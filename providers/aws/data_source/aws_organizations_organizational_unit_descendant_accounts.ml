...
let _ =
 fun (_ : aws_organizations_organizational_unit_descendant_accounts) ->
  ()

let yojson_of_aws_organizations_organizational_unit_descendant_accounts
    =
  (function
...
let _ =
  yojson_of_aws_organizations_organizational_unit_descendant_accounts

[@@@deriving.end]

let aws_organizations_organizational_unit_descendant_accounts ?id
    ~parent_id () :
    aws_organizations_organizational_unit_descendant_accounts =
  { id; parent_id }
