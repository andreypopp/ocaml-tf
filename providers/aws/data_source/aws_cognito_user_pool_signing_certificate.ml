...
let _ = fun (_ : aws_cognito_user_pool_signing_certificate) -> ()

let yojson_of_aws_cognito_user_pool_signing_certificate =
  (function
...
let _ = yojson_of_aws_cognito_user_pool_signing_certificate

[@@@deriving.end]

let aws_cognito_user_pool_signing_certificate ?id ~user_pool_id () :
    aws_cognito_user_pool_signing_certificate =
  { id; user_pool_id }
...
let make ?id ~user_pool_id __id =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_cognito_user_pool_signing_certificate
        (aws_cognito_user_pool_signing_certificate ?id ~user_pool_id
           ());
    attrs = __attrs;
  }
