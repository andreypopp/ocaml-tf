...
let _ = fun (_ : aws_opensearchserverless_access_policy) -> ()

let yojson_of_aws_opensearchserverless_access_policy =
  (function
...
let _ = yojson_of_aws_opensearchserverless_access_policy

[@@@deriving.end]

let aws_opensearchserverless_access_policy ~name ~type_ () :
    aws_opensearchserverless_access_policy =
  { name; type_ }
  ...
  in
  {
    ...
    json =
      yojson_of_aws_opensearchserverless_access_policy
        (aws_opensearchserverless_access_policy ~name ~type_ ());
    attrs = __attrs;
  }
