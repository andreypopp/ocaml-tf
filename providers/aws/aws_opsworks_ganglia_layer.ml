...
let _ = fun (_ : aws_opsworks_ganglia_layer) -> ()

let yojson_of_aws_opsworks_ganglia_layer =
  (function
   | {
       ...
       in
       `Assoc bnds
    : aws_opsworks_ganglia_layer -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_aws_opsworks_ganglia_layer
...
let make ?auto_assign_elastic_ips ?auto_assign_public_ips
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_opsworks_ganglia_layer
        (aws_opsworks_ganglia_layer ?auto_assign_elastic_ips
