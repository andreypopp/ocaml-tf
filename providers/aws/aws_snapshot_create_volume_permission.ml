...
let _ = fun (_ : aws_snapshot_create_volume_permission) -> ()

let yojson_of_aws_snapshot_create_volume_permission =
  (function
   | {
...
let _ = yojson_of_aws_snapshot_create_volume_permission
