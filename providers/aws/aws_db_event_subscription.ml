...
let _ = fun (_ : aws_db_event_subscription) -> ()

let yojson_of_aws_db_event_subscription =
  (function
   | {
       enabled = v_enabled;
       ...
       in
       `Assoc bnds
    : aws_db_event_subscription -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_aws_db_event_subscription
