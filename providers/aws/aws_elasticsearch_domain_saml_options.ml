...
let _ = fun (_ : aws_elasticsearch_domain_saml_options) -> ()

let yojson_of_aws_elasticsearch_domain_saml_options =
  (function
   | {
...
let _ = yojson_of_aws_elasticsearch_domain_saml_options
...
let aws_elasticsearch_domain_saml_options ?id ?(saml_options = [])
    ?timeouts ~domain_name () : aws_elasticsearch_domain_saml_options
    =
...
let make ?id ?(saml_options = []) ?timeouts ~domain_name __id =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_elasticsearch_domain_saml_options
        (aws_elasticsearch_domain_saml_options ?id ~saml_options
