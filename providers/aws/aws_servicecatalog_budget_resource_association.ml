...
let _ =
 fun (_ : aws_servicecatalog_budget_resource_association) -> ()

let yojson_of_aws_servicecatalog_budget_resource_association =
  (function
   | {
...
let _ = yojson_of_aws_servicecatalog_budget_resource_association
