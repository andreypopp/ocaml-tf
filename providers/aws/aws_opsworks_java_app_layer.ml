...
type aws_opsworks_java_app_layer = {
  ...
  jvm_type : string prop option; [@option]
  jvm_version : string prop option; [@option]
...
let _ = fun (_ : aws_opsworks_java_app_layer) -> ()

let yojson_of_aws_opsworks_java_app_layer =
  (function
   | {
       app_server = v_app_server;
       app_server_version = v_app_server_version;
       ...
       in
       let bnds =
         match v_jvm_version with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "jvm_version", arg in
             bnd :: bnds
       in
       let bnds =
         match v_jvm_type with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "jvm_type", arg in
             bnd :: bnds
       in
       let bnds =
       ...
       in
       let bnds =
         match v_app_server_version with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "app_server_version", arg in
             bnd :: bnds
       in
       let bnds =
...
let _ = yojson_of_aws_opsworks_java_app_layer
