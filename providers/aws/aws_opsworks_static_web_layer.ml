...
let _ = fun (_ : aws_opsworks_static_web_layer) -> ()

let yojson_of_aws_opsworks_static_web_layer =
  (function
   | {
...
let _ = yojson_of_aws_opsworks_static_web_layer
...
let aws_opsworks_static_web_layer ?auto_assign_elastic_ips
    ...
    ~load_based_auto_scaling () : aws_opsworks_static_web_layer =
  {
...
let make ?auto_assign_elastic_ips ?auto_assign_public_ips
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_opsworks_static_web_layer
        (aws_opsworks_static_web_layer ?auto_assign_elastic_ips
