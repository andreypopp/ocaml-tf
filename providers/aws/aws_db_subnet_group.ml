...
let aws_db_subnet_group ?description ?id ?name ?name_prefix ?tags
    ?tags_all ~subnet_ids () : aws_db_subnet_group =
...
let register ?tf_module ?description ?id ?name ?name_prefix ?tags
  ...
  let __resource_type = "aws_db_subnet_group" in
  let __resource =
    aws_db_subnet_group ?description ?id ?name ?name_prefix ?tags
      ?tags_all ~subnet_ids ()
  in
  Resource.add ?tf_module ~type_:__resource_type ~id:__resource_id
    (yojson_of_aws_db_subnet_group __resource);
