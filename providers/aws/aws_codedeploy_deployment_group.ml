...
let yojson_of_blue_green_deployment_config =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_green_fleet_provisioning_option then
           bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_deployment_ready_option then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_blue_green_deployment_config__deployment_ready_option)
...
let yojson_of_ec2_tag_set =
  (function
   | { ec2_tag_filter = v_ec2_tag_filter } ->
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_ec2_tag_filter then bnds
         else
           let arg =
...
let yojson_of_load_balancer_info__target_group_pair_info__prod_traffic_route
  ...
  (function
   | { listener_arns = v_listener_arns } ->
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_listener_arns then bnds
         else
           let arg =
...
let yojson_of_load_balancer_info__target_group_pair_info =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_test_traffic_route then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_load_balancer_info__target_group_pair_info__test_traffic_route)
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_prod_traffic_route then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_load_balancer_info__target_group_pair_info__prod_traffic_route)
...
let yojson_of_load_balancer_info =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_target_group_pair_info then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_target_group_info then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_elb_info then bnds
         else
           let arg =
...
let yojson_of_trigger_configuration =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_trigger_events then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
               v_trigger_events
...
let yojson_of_aws_codedeploy_deployment_group =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_trigger_configuration then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_on_premises_instance_tag_filter then
           bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_load_balancer_info then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_ecs_service then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_ec2_tag_set then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_deployment_style then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_blue_green_deployment_config then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_alarm_configuration then bnds
         else
           let arg =
