...
type aws_cognito_managed_user_pool_client = {
  ...
  name_pattern : string prop option; [@option]
...
let _ = fun (_ : aws_cognito_managed_user_pool_client) -> ()

let yojson_of_aws_cognito_managed_user_pool_client =
  (function
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_token_validity_units then bnds
           ...
           in
           let bnd = "token_validity_units", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_analytics_configuration then bnds
           ...
           in
           let bnd = "analytics_configuration", arg in
           bnd :: bnds
       in
       let bnds =
       ...
       in
       let bnds =
         match v_name_pattern with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "name_pattern", arg in
             bnd :: bnds
       in
       let bnds =
...
let _ = yojson_of_aws_cognito_managed_user_pool_client
...
let aws_cognito_managed_user_pool_client ?access_token_validity
    ...
    ?(token_validity_units = []) ~user_pool_id () :
    aws_cognito_managed_user_pool_client =
  {
...
let make ?access_token_validity ?allowed_oauth_flows
    ...
    ?refresh_token_validity ?supported_identity_providers
    ?write_attributes ?(analytics_configuration = [])
    ?(token_validity_units = []) ~user_pool_id __id =
  let __type = "aws_cognito_managed_user_pool_client" in
  let __attrs =
    ({
       tf_name = __id;
       access_token_validity =
       ...
       name_pattern = Prop.computed __type __id "name_pattern";
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_cognito_managed_user_pool_client
