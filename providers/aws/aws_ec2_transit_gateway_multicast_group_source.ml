...
let _ =
 fun (_ : aws_ec2_transit_gateway_multicast_group_source) -> ()

let yojson_of_aws_ec2_transit_gateway_multicast_group_source =
  (function
   | {
...
let _ = yojson_of_aws_ec2_transit_gateway_multicast_group_source
