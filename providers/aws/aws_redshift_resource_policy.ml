...
let _ = fun (_ : aws_redshift_resource_policy) -> ()

let yojson_of_aws_redshift_resource_policy =
  (function
...
let _ = yojson_of_aws_redshift_resource_policy

[@@@deriving.end]

let aws_redshift_resource_policy ?id ~policy ~resource_arn () :
    aws_redshift_resource_policy =
...
let make ?id ~policy ~resource_arn __id =
  let __type = "aws_redshift_resource_policy" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_redshift_resource_policy
        (aws_redshift_resource_policy ?id ~policy ~resource_arn ());
    attrs = __attrs;
  }
