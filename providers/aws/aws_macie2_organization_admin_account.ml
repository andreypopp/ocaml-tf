...
let _ = fun (_ : aws_macie2_organization_admin_account) -> ()

let yojson_of_aws_macie2_organization_admin_account =
  (function
...
let _ = yojson_of_aws_macie2_organization_admin_account
