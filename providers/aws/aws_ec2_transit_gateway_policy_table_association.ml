...
let _ =
 fun (_ : aws_ec2_transit_gateway_policy_table_association) -> ()

let yojson_of_aws_ec2_transit_gateway_policy_table_association =
  (function
   | {
       id = v_id;
       ...
       transit_gateway_policy_table_id =
         v_transit_gateway_policy_table_id;
     } ->
       ...
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string
             v_transit_gateway_policy_table_id
         in
         ("transit_gateway_policy_table_id", arg) :: bnds
       in
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string
...
let _ = yojson_of_aws_ec2_transit_gateway_policy_table_association
