...
let aws_quicksight_ingestion ?aws_account_id ~data_set_id
    ~ingestion_id ~ingestion_type __resource_id =
  let __resource_type = "aws_quicksight_ingestion" in
  let __resource =
    ({ aws_account_id; data_set_id; ingestion_id; ingestion_type }
      : aws_quicksight_ingestion)
  in
  ...
  let __resource_attributes =
    ({
       ...
       ingestion_id =
         Prop.computed __resource_type __resource_id "ingestion_id";
       ingestion_status =
         Prop.computed __resource_type __resource_id
           "ingestion_status";
       ingestion_type =
         Prop.computed __resource_type __resource_id "ingestion_type";
     }
      : t)
  in
