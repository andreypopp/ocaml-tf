...
let _ = fun (_ : aws_sns_topic_data_protection_policy) -> ()

let yojson_of_aws_sns_topic_data_protection_policy =
  (function
...
let _ = yojson_of_aws_sns_topic_data_protection_policy
...
let make ?id ~arn ~policy __id =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_sns_topic_data_protection_policy
