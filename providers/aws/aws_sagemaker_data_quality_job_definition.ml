   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_statistics_resource then bnds
           ...
           in
           let bnd = "statistics_resource", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_constraints_resource then bnds
           ...
           in
           let bnd = "constraints_resource", arg in
           bnd :: bnds
       in
       `Assoc bnds
   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_batch_transform_input then bnds
           ...
           in
           let bnd = "batch_transform_input", arg in
           bnd :: bnds
       in
       `Assoc bnds
   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_monitoring_outputs then bnds
           ...
           in
           let bnd = "monitoring_outputs", arg in
           bnd :: bnds
       in
       let bnds =
   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_stopping_condition then bnds
           ...
           in
           let bnd = "stopping_condition", arg in
           bnd :: bnds
       in
       let bnds =
         ...
         if Stdlib.( = ) [] v_data_quality_job_output_config then
           ...
           let arg =
             (yojson_of_list yojson_of_data_quality_job_output_config)
               v_data_quality_job_output_config
           in
           let bnd = "data_quality_job_output_config", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_data_quality_job_input then bnds
           ...
           in
           let bnd = "data_quality_job_input", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_data_quality_baseline_config then bnds
           ...
           in
           let bnd = "data_quality_baseline_config", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_data_quality_app_specification then
           ...
           let arg =
             (yojson_of_list yojson_of_data_quality_app_specification)
               v_data_quality_app_specification
           in
           let bnd = "data_quality_app_specification", arg in
           bnd :: bnds
       in
       let bnds =
