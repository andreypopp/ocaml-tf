...
let yojson_of_task_invocation_parameters__run_command_parameters =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_cloudwatch_config then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_task_invocation_parameters__run_command_parameters__cloudwatch_config)
...
let yojson_of_task_invocation_parameters =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_step_functions_parameters then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_task_invocation_parameters__step_functions_parameters)
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_run_command_parameters then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_lambda_parameters then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_automation_parameters then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_aws_ssm_maintenance_window_task =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_task_invocation_parameters then bnds
         else
           let arg =
