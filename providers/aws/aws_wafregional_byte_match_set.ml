...
let _ = fun (_ : aws_wafregional_byte_match_set) -> ()

let yojson_of_aws_wafregional_byte_match_set =
  (function
   | {
       id = v_id;
       name = v_name;
...
let _ = yojson_of_aws_wafregional_byte_match_set
...
let make ?id ~name ~byte_match_tuples __id =
  let __type = "aws_wafregional_byte_match_set" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_wafregional_byte_match_set
        (aws_wafregional_byte_match_set ?id ~name ~byte_match_tuples
           ());
    attrs = __attrs;
  }
