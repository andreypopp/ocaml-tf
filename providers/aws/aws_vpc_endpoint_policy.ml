...
let _ = fun (_ : aws_vpc_endpoint_policy) -> ()

let yojson_of_aws_vpc_endpoint_policy =
  (function
   | {
       id = v_id;
       policy = v_policy;
       ...
       in
       `Assoc bnds
    : aws_vpc_endpoint_policy -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_aws_vpc_endpoint_policy
