...
let _ =
 fun (_ : aws_servicecatalog_product_portfolio_association) -> ()

let yojson_of_aws_servicecatalog_product_portfolio_association =
  (function
   | {
       ...
       in
       let bnds =
         match v_source_portfolio_id with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "source_portfolio_id", arg in
             bnd :: bnds
       in
       let bnds =
...
let _ = yojson_of_aws_servicecatalog_product_portfolio_association
