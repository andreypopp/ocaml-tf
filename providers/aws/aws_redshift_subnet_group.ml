...
let _ = fun (_ : aws_redshift_subnet_group) -> ()

let yojson_of_aws_redshift_subnet_group =
  (function
   | {
       ...
       in
       `Assoc bnds
    : aws_redshift_subnet_group -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_aws_redshift_subnet_group

[@@@deriving.end]

let aws_redshift_subnet_group ?description ?id ?tags ?tags_all ~name
    ~subnet_ids () : aws_redshift_subnet_group =
...
let make ?description ?id ?tags ?tags_all ~name ~subnet_ids __id =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_redshift_subnet_group
        (aws_redshift_subnet_group ?description ?id ?tags ?tags_all
           ~name ~subnet_ids ());
    attrs = __attrs;
  }
