   ...
   | {
       ...
       let bnds =
         if [] = v_task_logs then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_logging_configuration__task_logs)
               v_task_logs
           in
           let bnd = "task_logs", arg in
           bnd :: bnds
       in
       let bnds =
       ...
       let bnds =
         if [] = v_dag_processing_logs then bnds
           ...
           in
           let bnd = "dag_processing_logs", arg in
           bnd :: bnds
       in
       `Assoc bnds
