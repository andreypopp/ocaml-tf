...
let aws_quicksight_data_set ?aws_account_id ?id ?tags ?tags_all
    ~data_set_id ~import_mode ~name ~column_groups
    ~column_level_permission_rules ~data_set_usage_configuration
    ~field_folders ~logical_table_map ~permissions
    ~physical_table_map ~refresh_properties
    ~row_level_permission_data_set
  ...
  let __resource_attributes =
    ({
       ...
       import_mode =
         Prop.computed __resource_type __resource_id "import_mode";
       name = Prop.computed __resource_type __resource_id "name";
       output_columns =
         Prop.computed __resource_type __resource_id "output_columns";
