...
let aws_quicksight_theme ?aws_account_id ?id ?tags ?tags_all
    ?version_description ?timeouts ~base_theme_id ~name ~theme_id
    ~configuration ~permissions __resource_id =
  ...
  let __resource_attributes =
    ({
       ...
       base_theme_id =
         Prop.computed __resource_type __resource_id "base_theme_id";
       created_time =
       ...
       theme_id =
         Prop.computed __resource_type __resource_id "theme_id";
       version_description =
         Prop.computed __resource_type __resource_id
           "version_description";
       version_number =
