...
type aws_opsworks_haproxy_layer = {
  ...
  stats_enabled : bool prop option; [@option]
  stats_password : string prop;
  stats_url : string prop option; [@option]
  stats_user : string prop option; [@option]
...
let _ = fun (_ : aws_opsworks_haproxy_layer) -> ()

let yojson_of_aws_opsworks_haproxy_layer =
  (function
   | {
       ...
       healthcheck_method = v_healthcheck_method;
       healthcheck_url = v_healthcheck_url;
       id = v_id;
       install_updates_on_boot = v_install_updates_on_boot;
       instance_shutdown_timeout = v_instance_shutdown_timeout;
       name = v_name;
       stack_id = v_stack_id;
       stats_enabled = v_stats_enabled;
       stats_password = v_stats_password;
       stats_url = v_stats_url;
       ...
       in
       let bnds =
         match v_stats_user with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "stats_user", arg in
             bnd :: bnds
       in
       let bnds =
         match v_stats_url with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "stats_url", arg in
             bnd :: bnds
       in
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string v_stats_password
         in
         ("stats_password", arg) :: bnds
       in
       let bnds =
         match v_stats_enabled with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_bool v in
             let bnd = "stats_enabled", arg in
             bnd :: bnds
       in
       let bnds =
       ...
       in
       let bnds =
         match v_healthcheck_url with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "healthcheck_url", arg in
             bnd :: bnds
       in
       let bnds =
         match v_healthcheck_method with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "healthcheck_method", arg in
             bnd :: bnds
       in
       let bnds =
       ...
       in
       `Assoc bnds
    : aws_opsworks_haproxy_layer -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_aws_opsworks_haproxy_layer
...
let make ?auto_assign_elastic_ips ?auto_assign_public_ips
  ...
  let __attrs =
    ({
       ...
       healthcheck_method =
         Prop.computed __type __id "healthcheck_method";
       healthcheck_url = Prop.computed __type __id "healthcheck_url";
       ...
       stats_enabled = Prop.computed __type __id "stats_enabled";
       stats_password = Prop.computed __type __id "stats_password";
       stats_url = Prop.computed __type __id "stats_url";
       stats_user = Prop.computed __type __id "stats_user";
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_opsworks_haproxy_layer
