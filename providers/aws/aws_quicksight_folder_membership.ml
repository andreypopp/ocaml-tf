...
let register ?tf_module ?aws_account_id ~folder_id ~member_id ~member_type __resource_id =
  let __resource_type = "aws_quicksight_folder_membership" in
  let __resource = aws_quicksight_folder_membership ?aws_account_id ~folder_id ~member_id ~member_type () in
  ...
  let __resource_attributes = ({
    ...
    member_id = Prop.computed __resource_type __resource_id "member_id";
    member_type = Prop.computed __resource_type __resource_id "member_type";
  } : t) in
