...
let yojson_of_policy_details__action__cross_region_copy =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_retain_rule then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_policy_details__action__cross_region_copy__retain_rule)
...
let yojson_of_policy_details__action =
  (function
   | { name = v_name; cross_region_copy = v_cross_region_copy } ->
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_cross_region_copy then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_policy_details__event_source__parameters =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_snapshot_owner then bnds
         else
           let arg =
...
let yojson_of_policy_details__schedule__cross_region_copy_rule =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_deprecate_rule then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_policy_details__schedule__cross_region_copy_rule__deprecate_rule)
...
let yojson_of_policy_details__schedule__share_rule =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_target_accounts then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
               v_target_accounts
...
let yojson_of_policy_details__schedule =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_share_rule then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_fast_restore_rule then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_cross_region_copy_rule then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_create_rule then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_policy_details =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_event_source then bnds
         else
           let arg =
...
let yojson_of_aws_dlm_lifecycle_policy =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_policy_details then bnds
         else
           let arg =
