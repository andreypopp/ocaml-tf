  ...
  (function
   | {
       ...
       let bnds =
         ...
         in
         ("ingress_configuration", arg) :: bnds
       in
       let bnds =
         let arg =
           yojson_of_list
  ...
  (function
   | {
       ...
       let bnds =
         ...
         in
         ("code_configuration_values", arg) :: bnds
       in
       let bnds =
         let arg =
  ...
  (function
   | {
       ...
       let bnds =
         ...
         in
         ("observability_configuration", arg) :: bnds
       in
       let bnds =
         let arg =
       ...
       let bnds =
         ...
         in
         ("health_check_configuration", arg) :: bnds
       in
       let bnds =
         let arg =
