...
let yojson_of_sagemaker_pipeline_target =
  (function
   | { pipeline_parameter_list = v_pipeline_parameter_list } ->
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_pipeline_parameter_list then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_aws_cloudwatch_event_target =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_sqs_target then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_sagemaker_pipeline_target then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_run_command_targets then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_redshift_target then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_kinesis_target then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_input_transformer then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_ecs_target then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_batch_target then bnds
         else
           let arg =
