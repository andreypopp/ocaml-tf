...
let _ = fun (_ : aws_opsworks_php_app_layer) -> ()

let yojson_of_aws_opsworks_php_app_layer =
  (function
   | {
       ...
       in
       `Assoc bnds
    : aws_opsworks_php_app_layer -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_aws_opsworks_php_app_layer
...
let aws_opsworks_php_app_layer ?auto_assign_elastic_ips
    ...
    ~load_based_auto_scaling () : aws_opsworks_php_app_layer =
  {
...
let make ?auto_assign_elastic_ips ?auto_assign_public_ips
  ...
  let __type = "aws_opsworks_php_app_layer" in
  let __attrs =
    ({
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_opsworks_php_app_layer
        (aws_opsworks_php_app_layer ?auto_assign_elastic_ips
