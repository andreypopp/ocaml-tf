...
let _ = fun (_ : aws_neptune_event_subscription) -> ()

let yojson_of_aws_neptune_event_subscription =
  (function
   | {
       enabled = v_enabled;
...
let _ = yojson_of_aws_neptune_event_subscription
...
let aws_neptune_event_subscription ?enabled ?event_categories ?id
    ?name ?name_prefix ?source_ids ?source_type ?tags ?tags_all
    ?timeouts ~sns_topic_arn () : aws_neptune_event_subscription =
  {
    enabled;
    event_categories;
    id;
...
let make ?enabled ?event_categories ?id ?name ?name_prefix
    ...
    __id =
  let __type = "aws_neptune_event_subscription" in
  let __attrs =
    ({
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_neptune_event_subscription
        (aws_neptune_event_subscription ?enabled ?event_categories
           ?id ?name ?name_prefix ?source_ids ?source_type ?tags
