...
let _ = fun (_ : aws_opsworks_nodejs_app_layer) -> ()

let yojson_of_aws_opsworks_nodejs_app_layer =
  (function
   | {
       ...
       name = v_name;
       nodejs_version = v_nodejs_version;
       stack_id = v_stack_id;
       ...
       in
       let bnds =
         match v_nodejs_version with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "nodejs_version", arg in
             bnd :: bnds
       in
       let bnds =
         match v_name with
...
let _ = yojson_of_aws_opsworks_nodejs_app_layer
...
let make ?auto_assign_elastic_ips ?auto_assign_public_ips
  ...
  let __type = "aws_opsworks_nodejs_app_layer" in
  let __attrs =
    ({
       ...
       nodejs_version = Prop.computed __type __id "nodejs_version";
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_opsworks_nodejs_app_layer
