...
let _ = fun (_ : aws_transfer_tag) -> ()

let yojson_of_aws_transfer_tag =
  (function
   | {
       id = v_id;
       key = v_key;
       ...
       in
       `Assoc bnds
    : aws_transfer_tag -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_aws_transfer_tag
