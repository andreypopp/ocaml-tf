...
let _ = fun (_ : aws_docdb_global_cluster) -> ()

let yojson_of_aws_docdb_global_cluster =
  (function
   | {
       ...
       in
       `Assoc bnds
    : aws_docdb_global_cluster -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_aws_docdb_global_cluster
