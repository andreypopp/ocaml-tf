...
let register ?tf_module ?aws_account_id ?description ?id ?namespace ~group_name __resource_id =
  let __resource_type = "aws_quicksight_group" in
  let __resource = aws_quicksight_group ?aws_account_id ?description ?id ?namespace ~group_name () in
