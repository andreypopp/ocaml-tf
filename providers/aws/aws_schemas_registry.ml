...
let _ = fun (_ : aws_schemas_registry) -> ()

let yojson_of_aws_schemas_registry =
  (function
   | {
       ...
       in
       `Assoc bnds
    : aws_schemas_registry -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_aws_schemas_registry
