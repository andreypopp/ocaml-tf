...
let aws_quicksight_template_alias ?aws_account_id ~alias_name
    ~template_id ~template_version_number __resource_id =
  ...
  let __resource_attributes =
    ({
       alias_name =
         Prop.computed __resource_type __resource_id "alias_name";
