...
let _ = fun (_ : aws_codebuild_resource_policy) -> ()

let yojson_of_aws_codebuild_resource_policy =
  (function
...
let _ = yojson_of_aws_codebuild_resource_policy
...
let make ?id ~policy ~resource_arn __id =
  let __type = "aws_codebuild_resource_policy" in
  let __attrs =
    ({
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_codebuild_resource_policy
