...
type aws_opsworks_rails_app_layer = {
  app_server : string prop option; [@option]
  ...
  bundler_version : string prop option; [@option]
  ...
  manage_bundler : bool prop option; [@option]
  name : string prop option; [@option]
  passenger_version : string prop option; [@option]
  ruby_version : string prop option; [@option]
  rubygems_version : string prop option; [@option]
...
let _ = fun (_ : aws_opsworks_rails_app_layer) -> ()

let yojson_of_aws_opsworks_rails_app_layer =
  (function
   | {
       app_server = v_app_server;
       ...
       bundler_version = v_bundler_version;
       ...
       manage_bundler = v_manage_bundler;
       name = v_name;
       passenger_version = v_passenger_version;
       ruby_version = v_ruby_version;
       rubygems_version = v_rubygems_version;
       stack_id = v_stack_id;
       ...
       in
       let bnds =
         match v_rubygems_version with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "rubygems_version", arg in
             bnd :: bnds
       in
       let bnds =
       ...
       in
       let bnds =
         match v_passenger_version with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "passenger_version", arg in
             bnd :: bnds
       in
       let bnds =
         match v_name with
       ...
       in
       let bnds =
         match v_manage_bundler with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_bool v in
             let bnd = "manage_bundler", arg in
             bnd :: bnds
       in
       let bnds =
       ...
       in
       let bnds =
         match v_bundler_version with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "bundler_version", arg in
             bnd :: bnds
       in
       let bnds =
       ...
       in
       let bnds =
         match v_app_server with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "app_server", arg in
             bnd :: bnds
       in
       `Assoc bnds
...
let _ = yojson_of_aws_opsworks_rails_app_layer
...
let aws_opsworks_rails_app_layer ?app_server ?auto_assign_elastic_ips
    ?auto_assign_public_ips ?auto_healing ?bundler_version
...
let make ?app_server ?auto_assign_elastic_ips ?auto_assign_public_ips
  ...
  let __attrs =
    ({
       ...
       bundler_version = Prop.computed __type __id "bundler_version";
       custom_configure_recipes =
       ...
       manage_bundler = Prop.computed __type __id "manage_bundler";
       name = Prop.computed __type __id "name";
       passenger_version =
         Prop.computed __type __id "passenger_version";
       ruby_version = Prop.computed __type __id "ruby_version";
       rubygems_version =
         Prop.computed __type __id "rubygems_version";
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_opsworks_rails_app_layer
        (aws_opsworks_rails_app_layer ?app_server
...
let register ?tf_module ?app_server ?auto_assign_elastic_ips
    ?auto_assign_public_ips ?auto_healing ?bundler_version
    ?custom_configure_recipes ?custom_deploy_recipes
    ?custom_instance_profile_arn ?custom_json
    ?custom_security_group_ids ?custom_setup_recipes
