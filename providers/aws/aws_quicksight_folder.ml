...
let register ?tf_module ?aws_account_id ?folder_type ?id ?name ?parent_folder_arn ?tags ?tags_all ?timeouts ~folder_id ~permissions __resource_id =
  let __resource_type = "aws_quicksight_folder" in
  let __resource = aws_quicksight_folder ?aws_account_id ?folder_type ?id ?name ?parent_folder_arn ?tags ?tags_all ?timeouts ~folder_id ~permissions () in
  ...
  let __resource_attributes = ({
    ...
    folder_id = Prop.computed __resource_type __resource_id "folder_id";
    folder_path = Prop.computed __resource_type __resource_id "folder_path";
    folder_type = Prop.computed __resource_type __resource_id "folder_type";
    id = Prop.computed __resource_type __resource_id "id";
    last_updated_time = Prop.computed __resource_type __resource_id "last_updated_time";
    name = Prop.computed __resource_type __resource_id "name";
    parent_folder_arn = Prop.computed __resource_type __resource_id "parent_folder_arn";
