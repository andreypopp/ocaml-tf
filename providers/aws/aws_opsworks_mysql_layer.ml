...
let _ = fun (_ : aws_opsworks_mysql_layer) -> ()

let yojson_of_aws_opsworks_mysql_layer =
  (function
   | {
       ...
       root_password_on_all_instances =
         v_root_password_on_all_instances;
       stack_id = v_stack_id;
       ...
       in
       let bnds =
         match v_root_password_on_all_instances with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_bool v in
             let bnd = "root_password_on_all_instances", arg in
             bnd :: bnds
       in
       let bnds =
       ...
       in
       `Assoc bnds
    : aws_opsworks_mysql_layer -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_aws_opsworks_mysql_layer
...
let aws_opsworks_mysql_layer ?auto_assign_elastic_ips
    ...
    ~stack_id ~ebs_volume () : aws_opsworks_mysql_layer =
  {
...
let make ?auto_assign_elastic_ips ?auto_assign_public_ips
  ...
  let __type = "aws_opsworks_mysql_layer" in
  let __attrs =
    ({
       tf_name = __id;
       ...
       root_password_on_all_instances =
         Prop.computed __type __id "root_password_on_all_instances";
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_opsworks_mysql_layer
        (aws_opsworks_mysql_layer ?auto_assign_elastic_ips
           ...
           ?drain_elb_on_shutdown ?elastic_load_balancer ?id
           ?install_updates_on_boot ?instance_shutdown_timeout ?name
           ?root_password ?root_password_on_all_instances
