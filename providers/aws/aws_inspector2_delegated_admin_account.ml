...
let _ = fun (_ : aws_inspector2_delegated_admin_account) -> ()

let yojson_of_aws_inspector2_delegated_admin_account =
  (function
...
let _ = yojson_of_aws_inspector2_delegated_admin_account
...
let make ?id ?timeouts ~account_id __id =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_inspector2_delegated_admin_account
        (aws_inspector2_delegated_admin_account ?id ?timeouts
           ~account_id ());
    attrs = __attrs;
  }
