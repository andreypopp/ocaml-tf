   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_overrides then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_launch_template_config__overrides)
               v_overrides
           in
...
let yojson_of_aws_spot_fleet_request =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_spot_maintenance_strategies then bnds
         else
           let arg =
             (yojson_of_list yojson_of_spot_maintenance_strategies)
               v_spot_maintenance_strategies
           in
           let bnd = "spot_maintenance_strategies", arg in
           bnd :: bnds
       in
       let bnds =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_launch_specification then bnds
         else
           let arg =
             (yojson_of_list yojson_of_launch_specification)
               v_launch_specification
           in
           let bnd = "launch_specification", arg in
           bnd :: bnds
       in
       let bnds =
