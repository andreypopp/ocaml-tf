...
type schedule__schedule_frequency = {
  ...
  refresh_on_day: schedule__schedule_frequency__refresh_on_day list; [@default []] [@yojson_drop_default Stdlib.( = )]
} [@@deriving_inline yojson_of]
[@@@deriving.end]
...
type schedule = {
  ...
  schedule_frequency: schedule__schedule_frequency list; [@default []] [@yojson_drop_default Stdlib.( = )]
} [@@deriving_inline yojson_of]
[@@@deriving.end]
...
type aws_quicksight_refresh_schedule = {
  ...
  schedule: schedule list; [@default []] [@yojson_drop_default Stdlib.( = )]
} [@@deriving_inline yojson_of]
[@@@deriving.end]
