...
let _ = fun (_ : aws_wafregional_regex_match_set) -> ()

let yojson_of_aws_wafregional_regex_match_set =
  (function
   | {
       id = v_id;
       name = v_name;
...
let _ = yojson_of_aws_wafregional_regex_match_set
...
let aws_wafregional_regex_match_set ?id ~name ~regex_match_tuple () :
    aws_wafregional_regex_match_set =
...
let make ?id ~name ~regex_match_tuple __id =
  let __type = "aws_wafregional_regex_match_set" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_wafregional_regex_match_set
        (aws_wafregional_regex_match_set ?id ~name ~regex_match_tuple
           ());
    attrs = __attrs;
  }
