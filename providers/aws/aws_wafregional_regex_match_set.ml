...
let register ?tf_module ?id ~name ~regex_match_tuple __resource_id =
  let __resource_type = "aws_wafregional_regex_match_set" in
  let __resource =
    aws_wafregional_regex_match_set ?id ~name ~regex_match_tuple ()
  in
  Resource.add ?tf_module ~type_:__resource_type ~id:__resource_id
    (yojson_of_aws_wafregional_regex_match_set __resource);
