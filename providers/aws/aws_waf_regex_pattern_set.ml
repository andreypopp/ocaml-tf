...
let _ = fun (_ : aws_waf_regex_pattern_set) -> ()

let yojson_of_aws_waf_regex_pattern_set =
  (function
   | {
       id = v_id;
       name = v_name;
       ...
       in
       `Assoc bnds
    : aws_waf_regex_pattern_set -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_aws_waf_regex_pattern_set
