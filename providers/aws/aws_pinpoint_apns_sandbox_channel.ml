...
let _ = fun (_ : aws_pinpoint_apns_sandbox_channel) -> ()

let yojson_of_aws_pinpoint_apns_sandbox_channel =
  (function
   | {
...
let _ = yojson_of_aws_pinpoint_apns_sandbox_channel

[@@@deriving.end]

let aws_pinpoint_apns_sandbox_channel ?bundle_id ?certificate
...
let make ?bundle_id ?certificate ?default_authentication_method
    ...
    ~application_id __id =
  let __type = "aws_pinpoint_apns_sandbox_channel" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_pinpoint_apns_sandbox_channel
        (aws_pinpoint_apns_sandbox_channel ?bundle_id ?certificate
