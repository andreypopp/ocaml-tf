   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_filter then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_thing_indexing_configuration__filter)
               v_filter
           in
   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_thing_indexing_configuration then bnds
           ...
           in
           let bnd = "thing_indexing_configuration", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_thing_group_indexing_configuration then
           ...
           let arg =
             (yojson_of_list
               ...
               v_thing_group_indexing_configuration
           in
           let bnd = "thing_group_indexing_configuration", arg in
           bnd :: bnds
       in
       let bnds =
         match v_id with
