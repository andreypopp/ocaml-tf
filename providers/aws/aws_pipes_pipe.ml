...
let yojson_of_enrichment_parameters =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_http_parameters then bnds
         else
           let arg =
             (yojson_of_list
               ...
               v_http_parameters
           in
           let bnd = "http_parameters", arg in
           bnd :: bnds
       in
       let bnds =
...
let yojson_of_source_parameters =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_sqs_queue_parameters then bnds
         else
           let arg =
             (yojson_of_list
           ...
           in
           let bnd = "sqs_queue_parameters", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_self_managed_kafka_parameters then bnds
         else
           let arg =
             (yojson_of_list
               ...
               v_self_managed_kafka_parameters
           in
           let bnd = "self_managed_kafka_parameters", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_rabbitmq_broker_parameters then bnds
         else
           let arg =
             (yojson_of_list
           ...
           in
           let bnd = "rabbitmq_broker_parameters", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_managed_streaming_kafka_parameters then
           bnds
         else
           let arg =
             (yojson_of_list
               ...
               v_managed_streaming_kafka_parameters
           in
           let bnd = "managed_streaming_kafka_parameters", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_kinesis_stream_parameters then bnds
         else
           let arg =
             (yojson_of_list
           ...
           in
           let bnd = "kinesis_stream_parameters", arg in
           bnd :: bnds
       in
       let bnds =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_dynamodb_stream_parameters then bnds
         else
           let arg =
             (yojson_of_list
           ...
           in
           let bnd = "dynamodb_stream_parameters", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_activemq_broker_parameters then bnds
         else
           let arg =
             (yojson_of_list
           ...
           in
           let bnd = "activemq_broker_parameters", arg in
           bnd :: bnds
       in
       `Assoc bnds
...
let yojson_of_target_parameters__batch_job_parameters__container_overrides
  ...
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_resource_requirement then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_target_parameters__batch_job_parameters__container_overrides__resource_requirement)
           ...
           in
           let bnd = "resource_requirement", arg in
           bnd :: bnds
       in
       let bnds =
...
let yojson_of_target_parameters__batch_job_parameters =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_array_properties then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_target_parameters__batch_job_parameters__array_properties)
               v_array_properties
           in
           let bnd = "array_properties", arg in
           bnd :: bnds
       in
       let bnds =
...
let yojson_of_target_parameters__ecs_task_parameters__network_configuration
  ...
  (function
   | { aws_vpc_configuration = v_aws_vpc_configuration } ->
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_aws_vpc_configuration then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_target_parameters__ecs_task_parameters__network_configuration__aws_vpc_configuration)
           ...
           in
           let bnd = "aws_vpc_configuration", arg in
           bnd :: bnds
       in
       `Assoc bnds
    : target_parameters__ecs_task_parameters__network_configuration ->
...
let yojson_of_target_parameters__ecs_task_parameters__overrides__container_override
  ...
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_environment_file then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_target_parameters__ecs_task_parameters__overrides__container_override__environment_file)
               v_environment_file
           in
           let bnd = "environment_file", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_environment then bnds
...
let yojson_of_target_parameters__ecs_task_parameters__overrides =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_inference_accelerator_override then
           bnds
         else
           let arg =
             (yojson_of_list
               ...
               v_inference_accelerator_override
           in
           let bnd = "inference_accelerator_override", arg in
           bnd :: bnds
       in
       let bnds =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_container_override then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_target_parameters__ecs_task_parameters__overrides__container_override)
           ...
           in
           let bnd = "container_override", arg in
           bnd :: bnds
       in
       let bnds =
...
let yojson_of_target_parameters__ecs_task_parameters =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_placement_constraint then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_target_parameters__ecs_task_parameters__placement_constraint)
...
let yojson_of_target_parameters =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_step_function_state_machine_parameters
         then bnds
         else
           let arg =
             (yojson_of_list
               ...
               v_step_function_state_machine_parameters
           in
           let bnd = "step_function_state_machine_parameters", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_sqs_queue_parameters then bnds
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_redshift_data_parameters then bnds
         else
           let arg =
             (yojson_of_list
           ...
           in
           let bnd = "redshift_data_parameters", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_lambda_function_parameters then bnds
         else
           let arg =
             (yojson_of_list
           ...
           in
           let bnd = "lambda_function_parameters", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_kinesis_stream_parameters then bnds
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_eventbridge_event_bus_parameters then
           bnds
         else
           let arg =
             (yojson_of_list
               ...
               v_eventbridge_event_bus_parameters
           in
           let bnd = "eventbridge_event_bus_parameters", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_ecs_task_parameters then bnds
         else
           let arg =
             (yojson_of_list
           ...
           in
           let bnd = "ecs_task_parameters", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_cloudwatch_logs_parameters then bnds
         else
           let arg =
             (yojson_of_list
           ...
           in
           let bnd = "cloudwatch_logs_parameters", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_batch_job_parameters then bnds
         else
           let arg =
             (yojson_of_list
           ...
           in
           let bnd = "batch_job_parameters", arg in
           bnd :: bnds
       in
       let bnds =
         match v_input_template with
...
let yojson_of_aws_pipes_pipe =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_target_parameters then bnds
         else
           let arg =
             (yojson_of_list yojson_of_target_parameters)
               v_target_parameters
           in
           let bnd = "target_parameters", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_source_parameters then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_enrichment_parameters then bnds
         else
           let arg =
             (yojson_of_list yojson_of_enrichment_parameters)
               v_enrichment_parameters
           in
           let bnd = "enrichment_parameters", arg in
           bnd :: bnds
       in
       let bnds =
