...
let aws_quicksight_account_subscription ?active_directory_name
    ?admin_group ?author_group ?aws_account_id ?contact_number
    ?directory_id ?email_address ?first_name ?id ?last_name
    ?reader_group ?realm ?timeouts ~account_name
    ~authentication_method ~edition ~notification_email __resource_id
    =
    ...
    ({
       ...
       active_directory_name =
         Prop.computed __resource_type __resource_id
           "active_directory_name";
       admin_group =
         Prop.computed __resource_type __resource_id "admin_group";
       authentication_method =
         Prop.computed __resource_type __resource_id
           "authentication_method";
       author_group =
         Prop.computed __resource_type __resource_id "author_group";
       aws_account_id =
         Prop.computed __resource_type __resource_id "aws_account_id";
       contact_number =
         Prop.computed __resource_type __resource_id "contact_number";
       directory_id =
       ...
       notification_email =
         Prop.computed __resource_type __resource_id
           "notification_email";
       reader_group =
         Prop.computed __resource_type __resource_id "reader_group";
