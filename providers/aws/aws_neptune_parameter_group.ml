...
let _ = fun (_ : aws_neptune_parameter_group) -> ()

let yojson_of_aws_neptune_parameter_group =
  (function
   | {
...
let _ = yojson_of_aws_neptune_parameter_group
...
let make ?description ?id ?name ?name_prefix ?tags ?tags_all ~family
    ~parameter __id =
  let __type = "aws_neptune_parameter_group" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_aws_neptune_parameter_group
        (aws_neptune_parameter_group ?description ?id ?name
