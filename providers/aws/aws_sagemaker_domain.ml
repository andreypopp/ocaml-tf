...
let yojson_of_domain_settings =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_r_studio_server_pro_domain_settings
         then bnds
         else
           let arg =
             (yojson_of_list
               ...
               v_r_studio_server_pro_domain_settings
           in
           let bnd = "r_studio_server_pro_domain_settings", arg in
           bnd :: bnds
       in
       let bnds =
...
let yojson_of_aws_sagemaker_domain =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_domain_settings then bnds
         else
           let arg =
             (yojson_of_list yojson_of_domain_settings)
               v_domain_settings
           in
           let bnd = "domain_settings", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_default_user_settings then bnds
         else
           let arg =
             (yojson_of_list yojson_of_default_user_settings)
               v_default_user_settings
           in
           let bnd = "default_user_settings", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_default_space_settings then bnds
         else
           let arg =
             (yojson_of_list yojson_of_default_space_settings)
               v_default_space_settings
           in
           let bnd = "default_space_settings", arg in
           bnd :: bnds
       in
       let bnds =
