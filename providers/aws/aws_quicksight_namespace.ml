...
let aws_quicksight_namespace ?aws_account_id ?identity_store ?tags
    ?timeouts ~namespace __resource_id =
  let __resource_type = "aws_quicksight_namespace" in
  let __resource =
    ({ aws_account_id; identity_store; namespace; tags; timeouts }
      : aws_quicksight_namespace)
  in
  ...
  let __resource_attributes =
    ({
       ...
       identity_store =
         Prop.computed __resource_type __resource_id "identity_store";
       namespace =
