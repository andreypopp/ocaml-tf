...
let _ = fun (_ : aws_service_discovery_private_dns_namespace) -> ()

let yojson_of_aws_service_discovery_private_dns_namespace =
  (function
   | {
...
let _ = yojson_of_aws_service_discovery_private_dns_namespace
