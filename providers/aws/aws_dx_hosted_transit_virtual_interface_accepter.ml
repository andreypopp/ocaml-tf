...
let _ =
 fun (_ : aws_dx_hosted_transit_virtual_interface_accepter) -> ()

let yojson_of_aws_dx_hosted_transit_virtual_interface_accepter =
  (function
   | {
...
let _ = yojson_of_aws_dx_hosted_transit_virtual_interface_accepter
