...
let _ = fun (_ : aws_lightsail_static_ip) -> ()

let yojson_of_aws_lightsail_static_ip =
  (function
   | { id = v_id; name = v_name } ->
       ...
       in
       `Assoc bnds
    : aws_lightsail_static_ip -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_aws_lightsail_static_ip
