   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_session_affinity_attributes then bnds
           ...
           in
           let bnd = "session_affinity_attributes", arg in
           bnd :: bnds
       in
       let bnds =
       ...
       let bnds =
         if Stdlib.( = ) [] v_random_steering then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_rules__overrides__random_steering)
               v_random_steering
           in
           let bnd = "random_steering", arg in
           bnd :: bnds
       in
       let bnds =
         ...
         if Stdlib.( = ) [] v_location_strategy then bnds
           ...
           let arg =
             (yojson_of_list
               ...
               v_location_strategy
           in
           let bnd = "location_strategy", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_country_pools then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_rules__overrides__country_pools)
               v_country_pools
           in
           let bnd = "country_pools", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_adaptive_routing then bnds
           ...
           let arg =
             (yojson_of_list
               ...
               v_adaptive_routing
           in
           let bnd = "adaptive_routing", arg in
           bnd :: bnds
       in
       let bnds =
         match v_ttl with
         ...
         if Stdlib.( = ) [] v_default_pool_ids then bnds
           ...
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
               v_default_pool_ids
           in
           let bnd = "default_pool_ids", arg in
           bnd :: bnds
       in
       `Assoc bnds
