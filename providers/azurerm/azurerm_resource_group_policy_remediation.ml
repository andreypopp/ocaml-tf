...
let _ = fun (_ : azurerm_resource_group_policy_remediation) -> ()

let yojson_of_azurerm_resource_group_policy_remediation =
  (function
   | {
...
let _ = yojson_of_azurerm_resource_group_policy_remediation
...
let azurerm_resource_group_policy_remediation ?failure_percentage ?id
    ...
    ~resource_group_id () : azurerm_resource_group_policy_remediation
    =
  {
    failure_percentage;
    id;
...
let make ?failure_percentage ?id ?location_filters
  ...
  let __type = "azurerm_resource_group_policy_remediation" in
  let __attrs =
    ({
       failure_percentage =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_azurerm_resource_group_policy_remediation
        (azurerm_resource_group_policy_remediation
           ?failure_percentage ?id ?location_filters
           ?parallel_deployments ?policy_definition_id
           ?policy_definition_reference_id ?resource_count
           ?resource_discovery_mode ?timeouts ~name
           ~policy_assignment_id ~resource_group_id ());
    attrs = __attrs;
  }
