...
let yojson_of_network_profile__ip_configuration =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_public_ip_address_configuration then
           bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_azurerm_virtual_machine_scale_set =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_storage_profile_os_disk then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_storage_profile_image_reference then
           bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_storage_profile_data_disk then bnds
         else
           let arg =
