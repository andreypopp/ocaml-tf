...
let _ = fun (_ : azurerm_static_site_custom_domain) -> ()

let yojson_of_azurerm_static_site_custom_domain =
  (function
   | {
       domain_name = v_domain_name;
       id = v_id;
       static_site_id = v_static_site_id;
       ...
       in
       let bnds =
         match v_validation_type with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "validation_type", arg in
             bnd :: bnds
       in
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string v_static_site_id
         in
         ("static_site_id", arg) :: bnds
       in
       let bnds =
         match v_id with
         | Ppx_yojson_conv_lib.Option.None -> bnds
...
let _ = yojson_of_azurerm_static_site_custom_domain
