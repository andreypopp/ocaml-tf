...
let yojson_of_azurerm_system_center_virtual_machine_manager_virtual_machine_template
    =
  (function
   | {
...
let _ =
  yojson_of_azurerm_system_center_virtual_machine_manager_virtual_machine_template
...
let azurerm_system_center_virtual_machine_manager_virtual_machine_template
