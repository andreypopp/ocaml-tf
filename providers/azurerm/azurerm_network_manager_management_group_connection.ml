...
let _ =
 fun (_ : azurerm_network_manager_management_group_connection) -> ()

let yojson_of_azurerm_network_manager_management_group_connection =
  (function
   | {
...
let _ = yojson_of_azurerm_network_manager_management_group_connection
