...
let _ = fun (_ : azurerm_kusto_eventhub_data_connection) -> ()

let yojson_of_azurerm_kusto_eventhub_data_connection =
  (function
   | {
...
let _ = yojson_of_azurerm_kusto_eventhub_data_connection
