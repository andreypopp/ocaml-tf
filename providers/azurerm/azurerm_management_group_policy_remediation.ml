...
let _ = fun (_ : azurerm_management_group_policy_remediation) -> ()

let yojson_of_azurerm_management_group_policy_remediation =
  (function
   | {
...
let _ = yojson_of_azurerm_management_group_policy_remediation
