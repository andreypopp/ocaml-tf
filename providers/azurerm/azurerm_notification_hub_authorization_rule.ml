...
let _ = fun (_ : azurerm_notification_hub_authorization_rule) -> ()

let yojson_of_azurerm_notification_hub_authorization_rule =
  (function
   | {
       id = v_id;
       listen = v_listen;
       ...
       notification_hub_name = v_notification_hub_name;
       ...
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string v_notification_hub_name
         in
         ("notification_hub_name", arg) :: bnds
       in
       let bnds =
         let arg =
...
let _ = yojson_of_azurerm_notification_hub_authorization_rule
