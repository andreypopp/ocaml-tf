...
let _ = fun (_ : azurerm_logz_tag_rule) -> ()

let yojson_of_azurerm_logz_tag_rule =
  (function
   | {
       id = v_id;
       ...
       in
       `Assoc bnds
    : azurerm_logz_tag_rule -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_azurerm_logz_tag_rule
