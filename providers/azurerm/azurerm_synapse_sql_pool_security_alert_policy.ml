...
let _ =
 fun (_ : azurerm_synapse_sql_pool_security_alert_policy) -> ()

let yojson_of_azurerm_synapse_sql_pool_security_alert_policy =
  (function
   | {
...
let _ = yojson_of_azurerm_synapse_sql_pool_security_alert_policy
