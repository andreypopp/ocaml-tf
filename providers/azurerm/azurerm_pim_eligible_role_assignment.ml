...
let _ = fun (_ : azurerm_pim_eligible_role_assignment) -> ()

let yojson_of_azurerm_pim_eligible_role_assignment =
  (function
   | {
       id = v_id;
...
let _ = yojson_of_azurerm_pim_eligible_role_assignment
...
let azurerm_pim_eligible_role_assignment ?id ?justification
