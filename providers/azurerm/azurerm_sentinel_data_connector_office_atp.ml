...
let _ = fun (_ : azurerm_sentinel_data_connector_office_atp) -> ()

let yojson_of_azurerm_sentinel_data_connector_office_atp =
  (function
   | {
       id = v_id;
...
let _ = yojson_of_azurerm_sentinel_data_connector_office_atp
...
let make ?id ?tenant_id ?timeouts ~log_analytics_workspace_id ~name
    __id =
  let __type = "azurerm_sentinel_data_connector_office_atp" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_azurerm_sentinel_data_connector_office_atp
        (azurerm_sentinel_data_connector_office_atp ?id ?tenant_id
           ?timeouts ~log_analytics_workspace_id ~name ());
    attrs = __attrs;
  }
