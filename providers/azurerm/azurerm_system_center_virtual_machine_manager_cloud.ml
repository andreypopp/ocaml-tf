...
let _ =
 fun (_ : azurerm_system_center_virtual_machine_manager_cloud) -> ()

let yojson_of_azurerm_system_center_virtual_machine_manager_cloud =
  (function
   | {
       ...
       system_center_virtual_machine_manager_server_inventory_item_id =
         v_system_center_virtual_machine_manager_server_inventory_item_id;
       tags = v_tags;
       timeouts = v_timeouts;
     } ->
       let bnds : (string * Ppx_yojson_conv_lib.Yojson.Safe.t) list =
...
let _ = yojson_of_azurerm_system_center_virtual_machine_manager_cloud
...
let azurerm_system_center_virtual_machine_manager_cloud ?id ?tags
    ?timeouts ~custom_location_id ~location ~name
    ~resource_group_name
    ~system_center_virtual_machine_manager_server_inventory_item_id
    () : azurerm_system_center_virtual_machine_manager_cloud =
  {
...
let make ?id ?tags ?timeouts ~custom_location_id ~location ~name
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_azurerm_system_center_virtual_machine_manager_cloud
        (azurerm_system_center_virtual_machine_manager_cloud ?id
