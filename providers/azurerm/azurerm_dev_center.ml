...
let _ = fun (_ : azurerm_dev_center) -> ()

let yojson_of_azurerm_dev_center =
  (function
   | {
       id = v_id;
       location = v_location;
       ...
       in
       `Assoc bnds
    : azurerm_dev_center -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_azurerm_dev_center
...
let azurerm_dev_center ?id ?tags ?(identity = []) ?timeouts ~location
    ~name ~resource_group_name () : azurerm_dev_center =
  {
    id;
    location;
    name;
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_dev_center
        (azurerm_dev_center ?id ?tags ~identity ?timeouts ~location
