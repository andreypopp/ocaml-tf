...
let _ =
 fun (_ : azurerm_data_factory_linked_service_cosmosdb_mongoapi) ->
  ()

let yojson_of_azurerm_data_factory_linked_service_cosmosdb_mongoapi =
  (function
   | {
       ...
       server_version_is_32_or_higher =
         v_server_version_is_32_or_higher;
       timeouts = v_timeouts;
     } ->
       let bnds : (string * Ppx_yojson_conv_lib.Yojson.Safe.t) list =
         []
       ...
       in
       let bnds =
         match v_server_version_is_32_or_higher with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_bool v in
             let bnd = "server_version_is_32_or_higher", arg in
             bnd :: bnds
       in
       let bnds =
