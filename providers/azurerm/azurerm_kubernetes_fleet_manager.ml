...
type hub_profile = { dns_prefix : string prop }
[@@deriving_inline yojson_of]

let _ = fun (_ : hub_profile) -> ()

let yojson_of_hub_profile =
  (function
   | { dns_prefix = v_dns_prefix } ->
       ...
       in
       let bnds =
         let arg = yojson_of_prop yojson_of_string v_dns_prefix in
         ("dns_prefix", arg) :: bnds
       in
       `Assoc bnds
    : hub_profile -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_hub_profile
...
let _ = fun (_ : azurerm_kubernetes_fleet_manager) -> ()

let yojson_of_azurerm_kubernetes_fleet_manager =
  (function
   | {
       id = v_id;
       location = v_location;
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_hub_profile then bnds
         else
           let arg =
...
let _ = yojson_of_azurerm_kubernetes_fleet_manager
