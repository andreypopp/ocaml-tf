...
let yojson_of_azurerm_mobile_network =
  (function
   | {
       id = v_id;
       location = v_location;
       mobile_country_code = v_mobile_country_code;
       mobile_network_code = v_mobile_network_code;
       name = v_name;
       ...
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string v_mobile_network_code
         in
         ("mobile_network_code", arg) :: bnds
       in
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string v_mobile_country_code
         in
         ("mobile_country_code", arg) :: bnds
       in
       let bnds =
