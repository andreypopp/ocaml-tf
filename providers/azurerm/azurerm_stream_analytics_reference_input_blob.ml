...
let _ = fun (_ : azurerm_stream_analytics_reference_input_blob) -> ()

let yojson_of_azurerm_stream_analytics_reference_input_blob =
  (function
   | {
...
let _ = yojson_of_azurerm_stream_analytics_reference_input_blob
