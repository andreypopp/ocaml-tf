   ...
   | {
       ...
       let bnds =
         if [] = v_schema_linked_service then bnds
           ...
           in
           let bnd = "schema_linked_service", arg in
           bnd :: bnds
       in
       let bnds =
         if [] = v_rejected_linked_service then bnds
           ...
           in
           let bnd = "rejected_linked_service", arg in
           bnd :: bnds
       in
       let bnds =
   ...
   | {
       ...
       let bnds =
         if [] = v_rejected_linked_service then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_source__rejected_linked_service)
               v_rejected_linked_service
           in
           let bnd = "rejected_linked_service", arg in
           bnd :: bnds
...
let _ = fun (_ : azurerm_data_factory_flowlet_data_flow) -> ()

let yojson_of_azurerm_data_factory_flowlet_data_flow =
  (function
   | {
...
let _ = yojson_of_azurerm_data_factory_flowlet_data_flow
