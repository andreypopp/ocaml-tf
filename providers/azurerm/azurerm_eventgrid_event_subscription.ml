...
let yojson_of_advanced_filter =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_string_not_in then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_string_not_ends_with then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_string_not_contains then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_string_not_begins_with then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_string_in then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_string_ends_with then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_string_contains then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_string_begins_with then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_number_not_in_range then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_number_not_in then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_number_less_than_or_equals then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_number_less_than then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_number_in_range then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_number_in then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_number_greater_than_or_equals then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_number_greater_than then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_is_null_or_undefined then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_is_not_null then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_bool_equals then bnds
         else
           let arg =
...
let _ = fun (_ : azurerm_eventgrid_event_subscription) -> ()

let yojson_of_azurerm_eventgrid_event_subscription =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_webhook_endpoint then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_subject_filter then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_storage_queue_endpoint then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_storage_blob_dead_letter_destination
         then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_delivery_property then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_delivery_identity then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_dead_letter_identity then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_azure_function_endpoint then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_advanced_filter then bnds
         else
           let arg =
...
let _ = yojson_of_azurerm_eventgrid_event_subscription
...
let make ?advanced_filtering_on_arrays_enabled ?event_delivery_schema
    ...
    ?(storage_blob_dead_letter_destination = [])
    ?(storage_queue_endpoint = []) ?(subject_filter = []) ?timeouts
    ?(webhook_endpoint = []) ~name ~scope __id =
...
let register ?tf_module ?advanced_filtering_on_arrays_enabled
  ...
  let (r : _ Tf_core.resource) =
    make ?advanced_filtering_on_arrays_enabled ?event_delivery_schema
      ...
      ~subject_filter ?timeouts ~webhook_endpoint ~name ~scope __id
  in
