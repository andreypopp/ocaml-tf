...
let _ = fun (_ : azurerm_subscription_policy_remediation) -> ()

let yojson_of_azurerm_subscription_policy_remediation =
  (function
   | {
...
let _ = yojson_of_azurerm_subscription_policy_remediation
