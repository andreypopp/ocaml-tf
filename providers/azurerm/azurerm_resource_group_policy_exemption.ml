...
let _ = fun (_ : azurerm_resource_group_policy_exemption) -> ()

let yojson_of_azurerm_resource_group_policy_exemption =
  (function
   | {
...
let _ = yojson_of_azurerm_resource_group_policy_exemption
