...
let _ = fun (_ : azurerm_express_route_circuit_authorization) -> ()

let yojson_of_azurerm_express_route_circuit_authorization =
  (function
   | {
...
let _ = yojson_of_azurerm_express_route_circuit_authorization
