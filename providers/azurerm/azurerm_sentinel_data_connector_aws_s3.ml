...
let _ = fun (_ : azurerm_sentinel_data_connector_aws_s3) -> ()

let yojson_of_azurerm_sentinel_data_connector_aws_s3 =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_sqs_urls then bnds
         else
           let arg =
       ...
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string v_destination_table
         in
...
let _ = yojson_of_azurerm_sentinel_data_connector_aws_s3
