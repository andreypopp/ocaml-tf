...
let _ =
 fun (_ : azurerm_data_factory_linked_service_azure_search) -> ()

let yojson_of_azurerm_data_factory_linked_service_azure_search =
  (function
   | {
       ...
       search_service_key = v_search_service_key;
       url = v_url;
       timeouts = v_timeouts;
     } ->
       let bnds : (string * Ppx_yojson_conv_lib.Yojson.Safe.t) list =
       ...
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string v_search_service_key
         in
         ("search_service_key", arg) :: bnds
       in
       let bnds =
...
let _ = yojson_of_azurerm_data_factory_linked_service_azure_search
