...
let _ =
 fun (_ : azurerm_stream_analytics_stream_input_eventhub_v2) -> ()

let yojson_of_azurerm_stream_analytics_stream_input_eventhub_v2 =
  (function
   | {
...
let _ = yojson_of_azurerm_stream_analytics_stream_input_eventhub_v2
