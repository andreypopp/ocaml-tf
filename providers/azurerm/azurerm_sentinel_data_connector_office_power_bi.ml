...
let _ =
 fun (_ : azurerm_sentinel_data_connector_office_power_bi) -> ()

let yojson_of_azurerm_sentinel_data_connector_office_power_bi =
  (function
   | {
       id = v_id;
...
let _ = yojson_of_azurerm_sentinel_data_connector_office_power_bi
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_sentinel_data_connector_office_power_bi
        (azurerm_sentinel_data_connector_office_power_bi ?id
