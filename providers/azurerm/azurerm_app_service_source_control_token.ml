...
let _ = fun (_ : azurerm_app_service_source_control_token) -> ()

let yojson_of_azurerm_app_service_source_control_token =
  (function
   | {
       id = v_id;
       token = v_token;
...
let _ = yojson_of_azurerm_app_service_source_control_token
