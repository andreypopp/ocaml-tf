...
let _ = fun (_ : azurerm_mssql_outbound_firewall_rule) -> ()

let yojson_of_azurerm_mssql_outbound_firewall_rule =
  (function
   | {
       id = v_id;
       name = v_name;
...
let _ = yojson_of_azurerm_mssql_outbound_firewall_rule
