...
let _ = fun (_ : azurerm_iothub_device_update_account) -> ()

let yojson_of_azurerm_iothub_device_update_account =
  (function
   | {
       id = v_id;
       location = v_location;
...
let _ = yojson_of_azurerm_iothub_device_update_account
