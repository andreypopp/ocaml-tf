...
let _ =
 fun (_ : azurerm_network_manager_security_admin_configuration) -> ()

let yojson_of_azurerm_network_manager_security_admin_configuration =
  (function
   | {
       apply_on_network_intent_policy_based_services =
         v_apply_on_network_intent_policy_based_services;
       ...
       in
       let bnds =
         match v_apply_on_network_intent_policy_based_services with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg =
             ...
             in
             let bnd =
               "apply_on_network_intent_policy_based_services", arg
             in
             bnd :: bnds
       in
       `Assoc bnds
