...
let _ = fun (_ : azurerm_automation_variable_string) -> ()

let yojson_of_azurerm_automation_variable_string =
  (function
   | {
...
let _ = yojson_of_azurerm_automation_variable_string
...
let azurerm_automation_variable_string ?description ?encrypted ?id
    ...
    ~resource_group_name () : azurerm_automation_variable_string =
  {
...
let make ?description ?encrypted ?id ?value ?timeouts
  ...
  let __type = "azurerm_automation_variable_string" in
  let __attrs =
    ({
       tf_name = __id;
       automation_account_name =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_azurerm_automation_variable_string
        (azurerm_automation_variable_string ?description ?encrypted
