...
let _ = fun (_ : azurerm_api_management_api_operation_policy) -> ()

let yojson_of_azurerm_api_management_api_operation_policy =
  (function
   | {
...
let _ = yojson_of_azurerm_api_management_api_operation_policy
...
let make ?id ?xml_content ?xml_link ?timeouts ~api_management_name
    ~api_name ~operation_id ~resource_group_name __id =
  let __type = "azurerm_api_management_api_operation_policy" in
  let __attrs =
    ({
       tf_name = __id;
       api_management_name =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_azurerm_api_management_api_operation_policy
