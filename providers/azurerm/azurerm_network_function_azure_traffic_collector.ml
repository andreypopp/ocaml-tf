...
let _ =
 fun (_ : azurerm_network_function_azure_traffic_collector) -> ()

let yojson_of_azurerm_network_function_azure_traffic_collector =
  (function
   | {
       id = v_id;
       location = v_location;
...
let _ = yojson_of_azurerm_network_function_azure_traffic_collector
