...
type logs__http_logs = {
  azure_blob_storage : logs__http_logs__azure_blob_storage list;
      (** azure_blob_storage *)
  file_system : logs__http_logs__file_system list;  (** file_system *)
}
...
type logs = {
  ...
  http_logs : logs__http_logs list;  (** http_logs *)
}
...
type site_config__application_stack = {
  docker_image : string prop;  (** docker_image *)
  docker_image_name : string prop;  (** docker_image_name *)
  docker_image_tag : string prop;  (** docker_image_tag *)
  ...
  go_version : string prop;  (** go_version *)
  java_server : string prop;  (** java_server *)
  java_server_version : string prop;  (** java_server_version *)
  ...
  ruby_version : string prop;  (** ruby_version *)
}
...
val yojson_of_azurerm_linux_web_app : azurerm_linux_web_app -> json
