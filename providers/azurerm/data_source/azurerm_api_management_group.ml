...
let _ = fun (_ : azurerm_api_management_group) -> ()

let yojson_of_azurerm_api_management_group =
  (function
   | {
...
let _ = yojson_of_azurerm_api_management_group

[@@@deriving.end]

let timeouts ?read () : timeouts = { read }

let azurerm_api_management_group ?id ?timeouts ~api_management_name
    ~name ~resource_group_name () : azurerm_api_management_group =
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_api_management_group
        (azurerm_api_management_group ?id ?timeouts
