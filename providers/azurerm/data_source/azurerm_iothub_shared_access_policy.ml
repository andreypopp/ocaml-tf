...
let azurerm_iothub_shared_access_policy ?id ?timeouts ~iothub_name
    ~name ~resource_group_name () :
    azurerm_iothub_shared_access_policy =
  { id; iothub_name; name; resource_group_name; timeouts }
...
let make ?id ?timeouts ~iothub_name ~name ~resource_group_name __id =
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_iothub_shared_access_policy
        (azurerm_iothub_shared_access_policy ?id ?timeouts
           ~iothub_name ~name ~resource_group_name ());
    attrs = __attrs;
  }

let register ?tf_module ?id ?timeouts ~iothub_name ~name
    ~resource_group_name __id =
  let (r : _ Tf_core.resource) =
    make ?id ?timeouts ~iothub_name ~name ~resource_group_name __id
  in
