       ...
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string
             v_private_ip_allocation_method
         in
         ("private_ip_allocation_method", arg) :: bnds
       in
       let bnds =
         let arg =
...
let azurerm_private_dns_resolver_inbound_endpoint ?id ?timeouts ~name
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_private_dns_resolver_inbound_endpoint
        (azurerm_private_dns_resolver_inbound_endpoint ?id ?timeouts
