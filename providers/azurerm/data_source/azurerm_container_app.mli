...
type ingress = {
  ...
  custom_domain : ingress__custom_domain list;  (** custom_domain *)
...
type template__init_container = {
  ...
  cpu : float prop;  (** cpu *)
  env : template__init_container__env list;  (** env *)
...
type template__container = {
  ...
  command : string prop list;  (** command *)
  cpu : float prop;  (** cpu *)
  env : template__container__env list;  (** env *)
  ephemeral_storage : string prop;  (** ephemeral_storage *)
  image : string prop;  (** image *)
...
type template = {
  ...
  container : template__container list;  (** container *)
  ...
  tcp_scale_rule : template__tcp_scale_rule list;
      (** tcp_scale_rule *)
  volume : template__volume list;  (** volume *)
}
