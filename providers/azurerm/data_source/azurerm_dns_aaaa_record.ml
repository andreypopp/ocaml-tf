...
let _ = fun (_ : azurerm_dns_aaaa_record) -> ()

let yojson_of_azurerm_dns_aaaa_record =
  (function
   | {
       id = v_id;
       name = v_name;
       ...
       in
       `Assoc bnds
    : azurerm_dns_aaaa_record -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_azurerm_dns_aaaa_record

[@@@deriving.end]

let timeouts ?read () : timeouts = { read }

let azurerm_dns_aaaa_record ?id ?timeouts ~name ~resource_group_name
    ~zone_name () : azurerm_dns_aaaa_record =
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_dns_aaaa_record
        (azurerm_dns_aaaa_record ?id ?timeouts ~name
