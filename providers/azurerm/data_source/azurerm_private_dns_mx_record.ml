...
type record = { exchange : string prop; preference : float prop }
[@@deriving_inline yojson_of]
...
let yojson_of_record =
  (function
   | { exchange = v_exchange; preference = v_preference } ->
       ...
       in
       let bnds =
         let arg = yojson_of_prop yojson_of_float v_preference in
         ("preference", arg) :: bnds
       in
       let bnds =
...
let _ = fun (_ : azurerm_private_dns_mx_record) -> ()

let yojson_of_azurerm_private_dns_mx_record =
  (function
   | {
       id = v_id;
       name = v_name;
...
let _ = yojson_of_azurerm_private_dns_mx_record

[@@@deriving.end]

let timeouts ?read () : timeouts = { read }

let azurerm_private_dns_mx_record ?id ?name ?timeouts
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_private_dns_mx_record
        (azurerm_private_dns_mx_record ?id ?name ?timeouts
           ~resource_group_name ~zone_name ());
    attrs = __attrs;
  }
