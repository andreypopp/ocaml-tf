...
let _ = fun (_ : azurerm_sql_managed_instance) -> ()

let yojson_of_azurerm_sql_managed_instance =
  (function
   | {
       id = v_id;
       name = v_name;
...
let _ = yojson_of_azurerm_sql_managed_instance

[@@@deriving.end]

let timeouts ?read () : timeouts = { read }

let azurerm_sql_managed_instance ?id ?tags ?timeouts ~name
    ~resource_group_name () : azurerm_sql_managed_instance =
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_sql_managed_instance
        (azurerm_sql_managed_instance ?id ?tags ?timeouts ~name
           ~resource_group_name ());
    attrs = __attrs;
  }
