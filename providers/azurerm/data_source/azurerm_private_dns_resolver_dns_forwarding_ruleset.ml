...
let _ =
 fun (_ : azurerm_private_dns_resolver_dns_forwarding_ruleset) -> ()

let yojson_of_azurerm_private_dns_resolver_dns_forwarding_ruleset =
  (function
   | {
       id = v_id;
       name = v_name;
...
let _ = yojson_of_azurerm_private_dns_resolver_dns_forwarding_ruleset

[@@@deriving.end]

let timeouts ?read () : timeouts = { read }

let azurerm_private_dns_resolver_dns_forwarding_ruleset ?id ?timeouts
