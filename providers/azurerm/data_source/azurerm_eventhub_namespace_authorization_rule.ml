...
let _ = fun (_ : azurerm_eventhub_namespace_authorization_rule) -> ()

let yojson_of_azurerm_eventhub_namespace_authorization_rule =
  (function
   | {
       id = v_id;
       name = v_name;
...
let _ = yojson_of_azurerm_eventhub_namespace_authorization_rule

[@@@deriving.end]

let timeouts ?read () : timeouts = { read }

let azurerm_eventhub_namespace_authorization_rule ?id ?timeouts ~name
...
let make ?id ?timeouts ~name ~namespace_name ~resource_group_name
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_azurerm_eventhub_namespace_authorization_rule
        (azurerm_eventhub_namespace_authorization_rule ?id ?timeouts
