...
let azurerm_logic_app_integration_account ?id ?timeouts ~name
    ~resource_group_name () : azurerm_logic_app_integration_account =
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_logic_app_integration_account
        (azurerm_logic_app_integration_account ?id ?timeouts ~name
           ~resource_group_name ());
    attrs = __attrs;
  }
