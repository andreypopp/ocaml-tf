...
let azurerm_machine_learning_workspace ?id ?timeouts ~name
    ~resource_group_name () : azurerm_machine_learning_workspace =
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_machine_learning_workspace
        (azurerm_machine_learning_workspace ?id ?timeouts ~name
           ~resource_group_name ());
    attrs = __attrs;
  }
