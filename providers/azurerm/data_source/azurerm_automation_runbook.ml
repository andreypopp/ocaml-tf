...
let azurerm_automation_runbook ?id ?timeouts ~automation_account_name
    ~name ~resource_group_name () : azurerm_automation_runbook =
  {
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_automation_runbook
        (azurerm_automation_runbook ?id ?timeouts
