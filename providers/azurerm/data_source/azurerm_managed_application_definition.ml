...
let azurerm_managed_application_definition ?id ?timeouts ~name
    ~resource_group_name () : azurerm_managed_application_definition
    =
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_managed_application_definition
        (azurerm_managed_application_definition ?id ?timeouts ~name
           ~resource_group_name ());
    attrs = __attrs;
  }
