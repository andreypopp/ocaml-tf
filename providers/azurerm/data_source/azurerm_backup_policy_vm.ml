...
let azurerm_backup_policy_vm ?id ?timeouts ~name ~recovery_vault_name
    ~resource_group_name () : azurerm_backup_policy_vm =
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_backup_policy_vm
        (azurerm_backup_policy_vm ?id ?timeouts ~name
