...
let _ = fun (_ : azurerm_private_dns_ptr_record) -> ()

let yojson_of_azurerm_private_dns_ptr_record =
  (function
   | {
       id = v_id;
       name = v_name;
...
let _ = yojson_of_azurerm_private_dns_ptr_record

[@@@deriving.end]

let timeouts ?read () : timeouts = { read }

let azurerm_private_dns_ptr_record ?id ?timeouts ~name
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_private_dns_ptr_record
        (azurerm_private_dns_ptr_record ?id ?timeouts ~name
           ~resource_group_name ~zone_name ());
    attrs = __attrs;
  }
