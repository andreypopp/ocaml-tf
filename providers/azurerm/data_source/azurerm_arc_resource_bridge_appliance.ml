...
let azurerm_arc_resource_bridge_appliance ?id ?timeouts ~name
    ~resource_group_name () : azurerm_arc_resource_bridge_appliance =
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_arc_resource_bridge_appliance
        (azurerm_arc_resource_bridge_appliance ?id ?timeouts ~name
           ~resource_group_name ());
    attrs = __attrs;
  }
