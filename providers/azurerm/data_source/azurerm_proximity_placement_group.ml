...
let azurerm_proximity_placement_group ?id ?timeouts ~name
    ~resource_group_name () : azurerm_proximity_placement_group =
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_proximity_placement_group
        (azurerm_proximity_placement_group ?id ?timeouts ~name
           ~resource_group_name ());
    attrs = __attrs;
  }
