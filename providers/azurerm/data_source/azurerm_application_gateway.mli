...
type http_listener = {
  ...
  host_name : string prop;  (** host_name *)
  host_names : string prop list;  (** host_names *)
  id : string prop;  (** id *)
  name : string prop;  (** name *)
  protocol : string prop;  (** protocol *)
...
type probe = {
  ...
  match_ : probe__match list; [@key "match"]  (** match *)
...
type rewrite_rule_set__rewrite_rule = {
  ...
  url : rewrite_rule_set__rewrite_rule__url list;  (** url *)
}
...
type ssl_policy = {
  cipher_suites : string prop list;  (** cipher_suites *)
  disabled_protocols : string prop list;  (** disabled_protocols *)
...
type ssl_profile = {
  id : string prop;  (** id *)
  name : string prop;  (** name *)
  ssl_policy : ssl_profile__ssl_policy list;  (** ssl_policy *)
...
type url_path_map = {
  ...
  id : string prop;  (** id *)
  name : string prop;  (** name *)
  path_rule : url_path_map__path_rule list;  (** path_rule *)
}
...
type waf_configuration = {
  disabled_rule_group : waf_configuration__disabled_rule_group list;
      (** disabled_rule_group *)
  enabled : bool prop;  (** enabled *)
  exclusion : waf_configuration__exclusion list;  (** exclusion *)
