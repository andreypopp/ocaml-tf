...
let yojson_of_backend_http_settings =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_trusted_root_certificate_names then
           bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
...
let yojson_of_http_listener =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_host_names then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
               v_host_names
...
let yojson_of_ssl_policy =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_disabled_protocols then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_cipher_suites then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
               v_cipher_suites
...
let yojson_of_ssl_profile =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_trusted_client_certificate_names then
           bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
