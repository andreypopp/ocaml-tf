...
let _ = fun (_ : azurerm_automation_variable_object) -> ()

let yojson_of_azurerm_automation_variable_object =
  (function
   | {
...
let _ = yojson_of_azurerm_automation_variable_object

[@@@deriving.end]

let timeouts ?read () : timeouts = { read }

let azurerm_automation_variable_object ?id ?timeouts
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_automation_variable_object
        (azurerm_automation_variable_object ?id ?timeouts
           ~automation_account_name ~name ~resource_group_name ());
    attrs = __attrs;
  }
