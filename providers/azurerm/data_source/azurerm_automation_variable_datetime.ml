...
let _ = fun (_ : azurerm_automation_variable_datetime) -> ()

let yojson_of_azurerm_automation_variable_datetime =
  (function
   | {
...
let _ = yojson_of_azurerm_automation_variable_datetime

[@@@deriving.end]

let timeouts ?read () : timeouts = { read }

let azurerm_automation_variable_datetime ?id ?timeouts
...
let make ?id ?timeouts ~automation_account_name ~name
  ...
  let __type = "azurerm_automation_variable_datetime" in
  let __attrs =
    ({
       tf_name = __id;
       automation_account_name =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_azurerm_automation_variable_datetime
        (azurerm_automation_variable_datetime ?id ?timeouts
           ~automation_account_name ~name ~resource_group_name ());
    attrs = __attrs;
  }
