...
let yojson_of_auth_settings__active_directory =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_allowed_audiences then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
               v_allowed_audiences
...
let yojson_of_auth_settings =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_allowed_external_redirect_urls then
           bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
...
let yojson_of_auth_settings_v2__microsoft_v2 =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_login_scopes then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
               v_login_scopes
...
let yojson_of_auth_settings_v2__active_directory_v2 =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_jwt_allowed_groups then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_jwt_allowed_client_applications then
           bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_allowed_identities then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_allowed_groups then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
               v_allowed_groups
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_allowed_applications then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
...
let yojson_of_auth_settings_v2 =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_excluded_paths then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
               v_excluded_paths
...
let yojson_of_sticky_settings =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_connection_string_names then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_app_setting_names then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
               v_app_setting_names
...
let azurerm_windows_function_app ?id ?timeouts ~name
    ~resource_group_name () : azurerm_windows_function_app =
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_windows_function_app
        (azurerm_windows_function_app ?id ?timeouts ~name
           ~resource_group_name ());
    attrs = __attrs;
  }
