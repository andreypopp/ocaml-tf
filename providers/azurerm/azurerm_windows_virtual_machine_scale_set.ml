...
let _ = fun (_ : azurerm_windows_virtual_machine_scale_set) -> ()

let yojson_of_azurerm_windows_virtual_machine_scale_set =
  (function
   | {
...
let _ = yojson_of_azurerm_windows_virtual_machine_scale_set
