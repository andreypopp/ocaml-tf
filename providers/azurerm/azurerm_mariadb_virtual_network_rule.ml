...
let _ = fun (_ : azurerm_mariadb_virtual_network_rule) -> ()

let yojson_of_azurerm_mariadb_virtual_network_rule =
  (function
   | {
       id = v_id;
       name = v_name;
...
let _ = yojson_of_azurerm_mariadb_virtual_network_rule
