...
let _ =
 fun (_ : azurerm_sentinel_data_connector_office_365_project) -> ()

let yojson_of_azurerm_sentinel_data_connector_office_365_project =
  (function
   | {
       id = v_id;
...
let _ = yojson_of_azurerm_sentinel_data_connector_office_365_project
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_sentinel_data_connector_office_365_project
        (azurerm_sentinel_data_connector_office_365_project ?id
