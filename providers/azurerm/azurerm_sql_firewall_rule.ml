...
let _ = fun (_ : azurerm_sql_firewall_rule) -> ()

let yojson_of_azurerm_sql_firewall_rule =
  (function
   | {
       ...
       in
       `Assoc bnds
    : azurerm_sql_firewall_rule -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_azurerm_sql_firewall_rule
