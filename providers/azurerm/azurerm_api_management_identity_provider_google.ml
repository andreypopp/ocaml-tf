...
let _ =
 fun (_ : azurerm_api_management_identity_provider_google) -> ()

let yojson_of_azurerm_api_management_identity_provider_google =
  (function
   | {
...
let _ = yojson_of_azurerm_api_management_identity_provider_google
...
let make ?id ?timeouts ~api_management_name ~client_id ~client_secret
  ...
  let __type = "azurerm_api_management_identity_provider_google" in
  let __attrs =
    ({
       api_management_name =
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_api_management_identity_provider_google
        (azurerm_api_management_identity_provider_google ?id
