...
let _ = fun (_ : azurerm_storage_sync) -> ()

let yojson_of_azurerm_storage_sync =
  (function
   | {
       id = v_id;
       incoming_traffic_policy = v_incoming_traffic_policy;
       location = v_location;
       name = v_name;
       ...
       in
       let bnds =
         match v_incoming_traffic_policy with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "incoming_traffic_policy", arg in
             bnd :: bnds
       in
       let bnds =
         match v_id with
       ...
       in
       `Assoc bnds
    : azurerm_storage_sync -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_azurerm_storage_sync
