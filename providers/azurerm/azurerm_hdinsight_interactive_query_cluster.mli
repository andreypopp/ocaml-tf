...
val azurerm_hdinsight_interactive_query_cluster :
  ...
  gateway:azurerm_hdinsight_interactive_query_cluster__gateway list ->
  metastores:
    azurerm_hdinsight_interactive_query_cluster__metastores list ->
  monitor:azurerm_hdinsight_interactive_query_cluster__monitor list ->
  network:azurerm_hdinsight_interactive_query_cluster__network list ->
