...
let _ = fun (_ : azurerm_storage_share_directory) -> ()

let yojson_of_azurerm_storage_share_directory =
  (function
   | {
       id = v_id;
       metadata = v_metadata;
       ...
       in
       let bnds =
         match v_storage_share_id with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "storage_share_id", arg in
             bnd :: bnds
       in
       let bnds =
...
let _ = yojson_of_azurerm_storage_share_directory
