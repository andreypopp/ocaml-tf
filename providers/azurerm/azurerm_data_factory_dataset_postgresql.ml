...
let _ = fun (_ : azurerm_data_factory_dataset_postgresql) -> ()

let yojson_of_azurerm_data_factory_dataset_postgresql =
  (function
   | {
...
let _ = yojson_of_azurerm_data_factory_dataset_postgresql
