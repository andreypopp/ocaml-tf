...
let _ = fun (_ : azurerm_application_load_balancer_frontend) -> ()

let yojson_of_azurerm_application_load_balancer_frontend =
  (function
   | {
...
let _ = yojson_of_azurerm_application_load_balancer_frontend
