...
let _ =
 fun (_ : azurerm_postgresql_active_directory_administrator) -> ()

let yojson_of_azurerm_postgresql_active_directory_administrator =
  (function
   | {
       id = v_id;
       login = v_login;
...
let _ = yojson_of_azurerm_postgresql_active_directory_administrator
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_postgresql_active_directory_administrator
        (azurerm_postgresql_active_directory_administrator ?id
           ?timeouts ~login ~object_id ~resource_group_name
