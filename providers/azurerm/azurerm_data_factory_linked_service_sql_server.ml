...
let _ = fun (_ : key_vault_connection_string) -> ()

let yojson_of_key_vault_connection_string =
  (function
   | {
...
let _ = yojson_of_key_vault_connection_string
...
let _ =
 fun (_ : azurerm_data_factory_linked_service_sql_server) -> ()

let yojson_of_azurerm_data_factory_linked_service_sql_server =
  (function
   | {
       ...
       key_vault_connection_string = v_key_vault_connection_string;
...
let _ = yojson_of_azurerm_data_factory_linked_service_sql_server

[@@@deriving.end]

let key_vault_connection_string ~linked_service_name ~secret_name ()
    : key_vault_connection_string =
...
let make ?additional_properties ?annotations ?connection_string
  ...
  let __type = "azurerm_data_factory_linked_service_sql_server" in
  let __attrs =
    ({
       tf_name = __id;
       additional_properties =
    ...
    json =
      yojson_of_azurerm_data_factory_linked_service_sql_server
        (azurerm_data_factory_linked_service_sql_server
           ...
           ?user_name ~key_vault_connection_string
