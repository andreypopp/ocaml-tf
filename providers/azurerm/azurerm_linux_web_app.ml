...
type site_config__application_stack = {
  ...
  dotnet_version : string prop option; [@option]
      (** dotnet_version *)
  go_version : string prop option; [@option]  (** go_version *)
  java_server : string prop option; [@option]  (** java_server *)
...
let site_config ?always_on ?api_definition_url ?api_management_api_id
    ?app_command_line ?auto_heal_enabled
    ?container_registry_managed_identity_client_id
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_linux_web_app
        (azurerm_linux_web_app ?app_settings ?client_affinity_enabled
           ?client_certificate_enabled
           ?client_certificate_exclusion_paths
           ?client_certificate_mode ?enabled
           ?ftp_publish_basic_authentication_enabled ?https_only ?id
