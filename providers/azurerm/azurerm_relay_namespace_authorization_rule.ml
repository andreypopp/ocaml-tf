...
let _ = fun (_ : azurerm_relay_namespace_authorization_rule) -> ()

let yojson_of_azurerm_relay_namespace_authorization_rule =
  (function
   | {
       id = v_id;
       listen = v_listen;
...
let _ = yojson_of_azurerm_relay_namespace_authorization_rule
