...
type schema_column = {
  name : string prop;
  precision : float prop option; [@option]
  scale : float prop option; [@option]
...
let yojson_of_schema_column =
  (function
   | {
       ...
       in
       let bnds =
         match v_precision with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_float v in
             let bnd = "precision", arg in
             bnd :: bnds
       in
       let bnds =
...
let _ = fun (_ : azurerm_data_factory_dataset_snowflake) -> ()

let yojson_of_azurerm_data_factory_dataset_snowflake =
  (function
   | {
...
let _ = yojson_of_azurerm_data_factory_dataset_snowflake
