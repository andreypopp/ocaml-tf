...
let _ = fun (_ : azurerm_virtual_machine_packet_capture) -> ()

let yojson_of_azurerm_virtual_machine_packet_capture =
  (function
   | {
       id = v_id;
...
let _ = yojson_of_azurerm_virtual_machine_packet_capture
