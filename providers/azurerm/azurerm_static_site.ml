...
let _ = fun (_ : azurerm_static_site) -> ()

let yojson_of_azurerm_static_site =
  (function
   | {
       ...
       in
       `Assoc bnds
    : azurerm_static_site -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_azurerm_static_site
