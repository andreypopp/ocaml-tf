...
let azurerm_dns_ns_record ?id ?tags ?timeouts ~name ~records
    ~resource_group_name ~ttl ~zone_name () : azurerm_dns_ns_record =
  {
    id;
    name;
    records;
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_dns_ns_record
        (azurerm_dns_ns_record ?id ?tags ?timeouts ~name ~records
