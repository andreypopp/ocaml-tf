...
let _ =
 fun (_ : azurerm_cosmosdb_postgresql_node_configuration) -> ()

let yojson_of_azurerm_cosmosdb_postgresql_node_configuration =
  (function
   | {
...
let _ = yojson_of_azurerm_cosmosdb_postgresql_node_configuration
