...
let _ = fun (_ : azurerm_mysql_flexible_server_configuration) -> ()

let yojson_of_azurerm_mysql_flexible_server_configuration =
  (function
   | {
       id = v_id;
       name = v_name;
...
let _ = yojson_of_azurerm_mysql_flexible_server_configuration
...
let make ?id ?timeouts ~name ~resource_group_name ~server_name ~value
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_azurerm_mysql_flexible_server_configuration
        (azurerm_mysql_flexible_server_configuration ?id ?timeouts
           ~name ~resource_group_name ~server_name ~value ());
    attrs = __attrs;
  }
