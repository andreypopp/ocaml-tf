...
type component_version = { hadoop : string prop }
...
let yojson_of_component_version =
  (function
   | { hadoop = v_hadoop } ->
       ...
       in
       let bnds =
         let arg = yojson_of_prop yojson_of_string v_hadoop in
         ("hadoop", arg) :: bnds
       in
       `Assoc bnds
...
let _ = fun (_ : roles__edge_node__https_endpoints) -> ()

let yojson_of_roles__edge_node__https_endpoints =
  (function
   | {
       access_modes = v_access_modes;
       destination_port = v_destination_port;
       disable_gateway_auth = v_disable_gateway_auth;
       private_ip_address = v_private_ip_address;
       sub_domain_suffix = v_sub_domain_suffix;
     } ->
       let bnds : (string * Ppx_yojson_conv_lib.Yojson.Safe.t) list =
         []
       in
       let bnds =
         match v_sub_domain_suffix with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "sub_domain_suffix", arg in
             bnd :: bnds
       in
       let bnds =
         match v_private_ip_address with
       ...
       in
       let bnds =
         match v_disable_gateway_auth with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_bool v in
             let bnd = "disable_gateway_auth", arg in
             bnd :: bnds
       in
       let bnds =
...
let _ = yojson_of_roles__edge_node__https_endpoints
...
let _ = fun (_ : roles__edge_node__install_script_action) -> ()

let yojson_of_roles__edge_node__install_script_action =
  (function
...
let _ = yojson_of_roles__edge_node__install_script_action
...
let _ = fun (_ : roles__edge_node__uninstall_script_actions) -> ()

let yojson_of_roles__edge_node__uninstall_script_actions =
  (function
   | { name = v_name; parameters = v_parameters; uri = v_uri } ->
       let bnds : (string * Ppx_yojson_conv_lib.Yojson.Safe.t) list =
         []
...
let _ = yojson_of_roles__edge_node__uninstall_script_actions
...
type roles__edge_node = {
  ...
  install_script_action :
    roles__edge_node__install_script_action list;
      [@default []] [@yojson_drop_default Stdlib.( = )]
...
let _ = fun (_ : roles__edge_node) -> ()

let yojson_of_roles__edge_node =
  (function
   | {
       target_instance_count = v_target_instance_count;
       vm_size = v_vm_size;
       https_endpoints = v_https_endpoints;
       install_script_action = v_install_script_action;
       uninstall_script_actions = v_uninstall_script_actions;
     } ->
       let bnds : (string * Ppx_yojson_conv_lib.Yojson.Safe.t) list =
         []
       in
       let bnds =
         if Stdlib.( = ) [] v_uninstall_script_actions then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_roles__edge_node__uninstall_script_actions)
               v_uninstall_script_actions
           in
           let bnd = "uninstall_script_actions", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_install_script_action then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_roles__edge_node__install_script_action)
               v_install_script_action
           in
           let bnd = "install_script_action", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_https_endpoints then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_roles__edge_node__https_endpoints)
               v_https_endpoints
           in
           let bnd = "https_endpoints", arg in
           bnd :: bnds
       in
       let bnds =
       ...
       in
       `Assoc bnds
    : roles__edge_node -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_roles__edge_node
...
let yojson_of_roles =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_edge_node then bnds
         else
           let arg =
             (yojson_of_list yojson_of_roles__edge_node) v_edge_node
           in
           let bnd = "edge_node", arg in
           bnd :: bnds
       in
       `Assoc bnds
...
let _ = fun (_ : azurerm_hdinsight_hadoop_cluster) -> ()

let yojson_of_azurerm_hdinsight_hadoop_cluster =
  (function
   | {
...
let _ = yojson_of_azurerm_hdinsight_hadoop_cluster

[@@@deriving.end]

let component_version ~hadoop () : component_version = { hadoop }
...
let roles__edge_node__install_script_action ?parameters ~name ~uri ()
    : roles__edge_node__install_script_action =
  { name; parameters; uri }

let roles__edge_node__uninstall_script_actions ?parameters ~name ~uri
    () : roles__edge_node__uninstall_script_actions =
  { name; parameters; uri }
