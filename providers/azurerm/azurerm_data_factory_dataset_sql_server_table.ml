...
let _ = fun (_ : azurerm_data_factory_dataset_sql_server_table) -> ()

let yojson_of_azurerm_data_factory_dataset_sql_server_table =
  (function
   | {
...
let _ = yojson_of_azurerm_data_factory_dataset_sql_server_table
    ...
    json =
      yojson_of_azurerm_data_factory_dataset_sql_server_table
        (azurerm_data_factory_dataset_sql_server_table
           ...
           ?id ?parameters ?table_name ~schema_column ?timeouts
           ~data_factory_id ~linked_service_name ~name ());
    attrs = __attrs;
  }
