...
let yojson_of_azurerm_management_group =
  (function
   | {
       ...
       id = v_id;
       name = v_name;
       parent_management_group_id = v_parent_management_group_id;
       ...
       in
       let bnds =
         match v_parent_management_group_id with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "parent_management_group_id", arg in
             bnd :: bnds
       in
       let bnds =
         match v_name with
