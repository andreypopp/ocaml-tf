   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_restore_policy then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_blob_properties__restore_policy)
               v_restore_policy
           in
       ...
       let bnds =
         if Stdlib.( = ) [] v_delete_retention_policy then bnds
           ...
           in
           let bnd = "delete_retention_policy", arg in
           bnd :: bnds
       in
       let bnds =
         ...
         if Stdlib.( = ) [] v_container_delete_retention_policy then
           ...
           let arg =
             (yojson_of_list
               ...
               v_container_delete_retention_policy
           in
           let bnd = "container_delete_retention_policy", arg in
           bnd :: bnds
       in
       let bnds =
   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_minute_metrics then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_queue_properties__minute_metrics)
               v_minute_metrics
           in
           let bnd = "minute_metrics", arg in
           bnd :: bnds
       in
       let bnds =
   ...
   | {
         ...
         if Stdlib.( = ) [] v_share_properties then bnds
           ...
           let arg =
             (yojson_of_list yojson_of_share_properties)
               v_share_properties
           in
           let bnd = "share_properties", arg in
           bnd :: bnds
       in
       let bnds =
         ...
         if Stdlib.( = ) [] v_queue_properties then bnds
           ...
           let arg =
             (yojson_of_list yojson_of_queue_properties)
               v_queue_properties
           in
           let bnd = "queue_properties", arg in
           bnd :: bnds
       in
       let bnds =
       ...
       let bnds =
         if Stdlib.( = ) [] v_immutability_policy then bnds
           ...
           in
           let bnd = "immutability_policy", arg in
           bnd :: bnds
       in
       let bnds =
         ...
         if Stdlib.( = ) [] v_blob_properties then bnds
           ...
           let arg =
             (yojson_of_list yojson_of_blob_properties)
               v_blob_properties
           in
           let bnd = "blob_properties", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_azure_files_authentication then bnds
           ...
           in
           let bnd = "azure_files_authentication", arg in
           bnd :: bnds
       in
       let bnds =
         match v_tags with
