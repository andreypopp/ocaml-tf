...
let _ =
 fun (_ : azurerm_stream_analytics_output_servicebus_topic) -> ()

let yojson_of_azurerm_stream_analytics_output_servicebus_topic =
  (function
   | {
...
let _ = yojson_of_azurerm_stream_analytics_output_servicebus_topic
