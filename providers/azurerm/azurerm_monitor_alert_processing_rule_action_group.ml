...
let yojson_of_condition =
  (function
   | {
       ...
       in
       let bnds =
         if [] = v_target_resource_group then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if [] = v_monitor_condition then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_alert_rule_name then bnds
         else
           let arg =
...
let yojson_of_azurerm_monitor_alert_processing_rule_action_group =
  (function
   | {
       ...
       in
       let bnds =
         if [] = v_add_action_group_ids then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
               v_add_action_group_ids
           in
           let bnd = "add_action_group_ids", arg in
           bnd :: bnds
       in
       `Assoc bnds
