...
let _ = fun (_ : azurerm_arc_kubernetes_cluster_extension) -> ()

let yojson_of_azurerm_arc_kubernetes_cluster_extension =
  (function
   | {
...
let _ = yojson_of_azurerm_arc_kubernetes_cluster_extension
