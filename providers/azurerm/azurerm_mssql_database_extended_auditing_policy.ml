...
let _ =
 fun (_ : azurerm_mssql_database_extended_auditing_policy) -> ()

let yojson_of_azurerm_mssql_database_extended_auditing_policy =
  (function
   | {
...
let _ = yojson_of_azurerm_mssql_database_extended_auditing_policy
