  ...
  (function
   | {
       ...
       let bnds =
         ...
         in
         ("terminate_notification", arg) :: bnds
       in
       let bnds =
         let arg =
           yojson_of_list yojson_of_spot_restore v_spot_restore
         in
         ("spot_restore", arg) :: bnds
       in
       let bnds =
         let arg =
       ...
       in
       let bnds =
         let arg = yojson_of_list yojson_of_scale_in v_scale_in in
         ("scale_in", arg) :: bnds
       in
       let bnds =
         let arg =
       ...
       let bnds =
         ...
         in
         ("automatic_os_upgrade_policy", arg) :: bnds
       in
       let bnds =
         let arg =
         ...
         in
         ("automatic_instance_repair", arg) :: bnds
       in
       let bnds =
         let arg =
           yojson_of_list yojson_of_admin_ssh_key v_admin_ssh_key
         in
         ("admin_ssh_key", arg) :: bnds
       in
       let bnds =
         let arg =
    ...
    json =
      yojson_of_azurerm_linux_virtual_machine_scale_set
        (azurerm_linux_virtual_machine_scale_set ?admin_password
           ...
           ~additional_capabilities ~admin_ssh_key
           ~automatic_instance_repair ~automatic_os_upgrade_policy
           ~boot_diagnostics ~data_disk ~extension
           ~gallery_application ~gallery_applications ~identity
           ~network_interface ~os_disk ~plan ~rolling_upgrade_policy
...
let register ?tf_module ?admin_password
  ...
  let (r : _ Tf_core.resource) =
    make ?admin_password ?capacity_reservation_group_id
      ...
      ~admin_ssh_key ~automatic_instance_repair
      ~automatic_os_upgrade_policy ~boot_diagnostics ~data_disk
      ~extension ~gallery_application ~gallery_applications ~identity
      ~network_interface ~os_disk ~plan ~rolling_upgrade_policy
      ~scale_in ~secret ~source_image_reference ~spot_restore
      ~terminate_notification ~termination_notification __id
  in
