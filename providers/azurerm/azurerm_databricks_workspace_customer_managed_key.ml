...
let _ =
 fun (_ : azurerm_databricks_workspace_customer_managed_key) -> ()

let yojson_of_azurerm_databricks_workspace_customer_managed_key =
  (function
   | {
       id = v_id;
...
let _ = yojson_of_azurerm_databricks_workspace_customer_managed_key
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_databricks_workspace_customer_managed_key
        (azurerm_databricks_workspace_customer_managed_key ?id
