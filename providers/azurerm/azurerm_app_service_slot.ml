...
let _ = fun (_ : azurerm_app_service_slot) -> ()

let yojson_of_azurerm_app_service_slot =
  (function
   | {
       ...
       in
       `Assoc bnds
    : azurerm_app_service_slot -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_azurerm_app_service_slot
