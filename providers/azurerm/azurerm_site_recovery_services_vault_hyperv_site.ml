...
let _ =
 fun (_ : azurerm_site_recovery_services_vault_hyperv_site) -> ()

let yojson_of_azurerm_site_recovery_services_vault_hyperv_site =
  (function
   | {
       id = v_id;
       name = v_name;
...
let _ = yojson_of_azurerm_site_recovery_services_vault_hyperv_site
