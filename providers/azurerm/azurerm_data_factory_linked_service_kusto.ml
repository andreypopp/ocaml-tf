...
let _ = fun (_ : azurerm_data_factory_linked_service_kusto) -> ()

let yojson_of_azurerm_data_factory_linked_service_kusto =
  (function
   | {
       ...
       kusto_endpoint = v_kusto_endpoint;
       name = v_name;
       ...
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string v_kusto_endpoint
         in
         ("kusto_endpoint", arg) :: bnds
       in
       let bnds =
         let arg =
...
let _ = yojson_of_azurerm_data_factory_linked_service_kusto
