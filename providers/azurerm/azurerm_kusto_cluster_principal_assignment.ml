...
let _ = fun (_ : azurerm_kusto_cluster_principal_assignment) -> ()

let yojson_of_azurerm_kusto_cluster_principal_assignment =
  (function
   | {
...
let _ = yojson_of_azurerm_kusto_cluster_principal_assignment
