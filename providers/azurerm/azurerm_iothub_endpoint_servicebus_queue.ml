...
let _ = fun (_ : azurerm_iothub_endpoint_servicebus_queue) -> ()

let yojson_of_azurerm_iothub_endpoint_servicebus_queue =
  (function
   | {
...
let _ = yojson_of_azurerm_iothub_endpoint_servicebus_queue
