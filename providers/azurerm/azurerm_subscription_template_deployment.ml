...
let _ = fun (_ : azurerm_subscription_template_deployment) -> ()

let yojson_of_azurerm_subscription_template_deployment =
  (function
   | {
...
let _ = yojson_of_azurerm_subscription_template_deployment
