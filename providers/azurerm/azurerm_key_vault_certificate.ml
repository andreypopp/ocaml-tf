...
let yojson_of_certificate_policy =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_x509_certificate_properties then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_secret_properties then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_lifetime_action then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_key_properties then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_issuer_parameters then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_azurerm_key_vault_certificate =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_certificate_policy then bnds
         else
           let arg =
