...
let _ = fun (_ : azurerm_dev_center_project) -> ()

let yojson_of_azurerm_dev_center_project =
  (function
   | {
       ...
       id = v_id;
       location = v_location;
       maximum_dev_boxes_per_user = v_maximum_dev_boxes_per_user;
       name = v_name;
       ...
       in
       let bnds =
         match v_maximum_dev_boxes_per_user with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_float v in
             let bnd = "maximum_dev_boxes_per_user", arg in
             bnd :: bnds
       in
       let bnds =
       ...
       in
       `Assoc bnds
    : azurerm_dev_center_project -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_azurerm_dev_center_project
