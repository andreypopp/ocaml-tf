...
let _ = fun (_ : azurerm_storage_mover) -> ()

let yojson_of_azurerm_storage_mover =
  (function
   | {
       ...
       in
       `Assoc bnds
    : azurerm_storage_mover -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_azurerm_storage_mover
