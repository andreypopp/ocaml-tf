...
let _ = fun (_ : azurerm_data_factory_linked_service_odbc) -> ()

let yojson_of_azurerm_data_factory_linked_service_odbc =
  (function
   | {
...
let _ = yojson_of_azurerm_data_factory_linked_service_odbc
