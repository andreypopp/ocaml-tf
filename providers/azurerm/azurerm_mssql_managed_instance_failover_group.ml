...
let _ = fun (_ : azurerm_mssql_managed_instance_failover_group) -> ()

let yojson_of_azurerm_mssql_managed_instance_failover_group =
  (function
   | {
       id = v_id;
       location = v_location;
...
let _ = yojson_of_azurerm_mssql_managed_instance_failover_group
