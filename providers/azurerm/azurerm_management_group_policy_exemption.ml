...
let _ = fun (_ : azurerm_management_group_policy_exemption) -> ()

let yojson_of_azurerm_management_group_policy_exemption =
  (function
   | {
...
let _ = yojson_of_azurerm_management_group_policy_exemption
...
let make ?description ?display_name ?expires_on ?id ?metadata
    ?policy_definition_reference_ids ?timeouts ~exemption_category
    ~management_group_id ~name ~policy_assignment_id __id =
  let __type = "azurerm_management_group_policy_exemption" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_azurerm_management_group_policy_exemption
