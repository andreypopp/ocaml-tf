...
let yojson_of_azurerm_system_center_virtual_machine_manager_virtual_network
    =
  (function
   | {
...
let _ =
  yojson_of_azurerm_system_center_virtual_machine_manager_virtual_network
...
let azurerm_system_center_virtual_machine_manager_virtual_network ?id
