...
let _ =
 fun (_ : azurerm_billing_account_cost_management_export) -> ()

let yojson_of_azurerm_billing_account_cost_management_export =
  (function
   | {
       active = v_active;
...
let _ = yojson_of_azurerm_billing_account_cost_management_export
