...
let _ =
 fun (_ : azurerm_api_management_openid_connect_provider) -> ()

let yojson_of_azurerm_api_management_openid_connect_provider =
  (function
   | {
       ...
       id = v_id;
       metadata_endpoint = v_metadata_endpoint;
       name = v_name;
       ...
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string v_metadata_endpoint
         in
         ("metadata_endpoint", arg) :: bnds
       in
       let bnds =
         match v_id with
         | Ppx_yojson_conv_lib.Option.None -> bnds
...
let _ = yojson_of_azurerm_api_management_openid_connect_provider
