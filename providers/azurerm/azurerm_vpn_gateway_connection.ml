...
let yojson_of_traffic_selector_policy =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_remote_address_ranges then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_local_address_ranges then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
...
let yojson_of_vpn_link =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_custom_bgp_address then bnds
         else
           let arg =
...
let yojson_of_azurerm_vpn_gateway_connection =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_vpn_link then bnds
         else
           let arg =
