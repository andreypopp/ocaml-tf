...
let _ = fun (_ : azurerm_virtual_machine_extension) -> ()

let yojson_of_azurerm_virtual_machine_extension =
  (function
   | {
...
let _ = yojson_of_azurerm_virtual_machine_extension
...
let make ?auto_upgrade_minor_version ?automatic_upgrade_enabled
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_azurerm_virtual_machine_extension
        (azurerm_virtual_machine_extension
