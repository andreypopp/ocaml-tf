...
let _ = fun (_ : azurerm_data_factory_linked_service_snowflake) -> ()

let yojson_of_azurerm_data_factory_linked_service_snowflake =
  (function
   | {
...
let _ = yojson_of_azurerm_data_factory_linked_service_snowflake
...
let make ?additional_properties ?annotations ?description ?id
    ...
    ~connection_string ~data_factory_id ~name ~key_vault_password
    __id =
  let __type = "azurerm_data_factory_linked_service_snowflake" in
  let __attrs =
    ({
       additional_properties =
