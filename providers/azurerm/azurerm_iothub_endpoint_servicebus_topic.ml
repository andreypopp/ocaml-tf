...
let _ = fun (_ : azurerm_iothub_endpoint_servicebus_topic) -> ()

let yojson_of_azurerm_iothub_endpoint_servicebus_topic =
  (function
   | {
...
let _ = yojson_of_azurerm_iothub_endpoint_servicebus_topic
...
let make ?authentication_type ?connection_string ?endpoint_uri
  ...
  let __type = "azurerm_iothub_endpoint_servicebus_topic" in
  let __attrs =
    ({
       tf_name = __id;
       authentication_type =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_azurerm_iothub_endpoint_servicebus_topic
        (azurerm_iothub_endpoint_servicebus_topic
