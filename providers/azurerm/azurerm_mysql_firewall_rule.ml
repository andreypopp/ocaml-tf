...
let _ = fun (_ : azurerm_mysql_firewall_rule) -> ()

let yojson_of_azurerm_mysql_firewall_rule =
  (function
   | {
...
let _ = yojson_of_azurerm_mysql_firewall_rule
...
let make ?id ?timeouts ~end_ip_address ~name ~resource_group_name
  ...
  let __type = "azurerm_mysql_firewall_rule" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_azurerm_mysql_firewall_rule
        (azurerm_mysql_firewall_rule ?id ?timeouts ~end_ip_address
