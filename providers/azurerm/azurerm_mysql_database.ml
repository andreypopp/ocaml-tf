...
let _ = fun (_ : azurerm_mysql_database) -> ()

let yojson_of_azurerm_mysql_database =
  (function
   | {
       charset = v_charset;
       ...
       in
       `Assoc bnds
    : azurerm_mysql_database -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_azurerm_mysql_database
