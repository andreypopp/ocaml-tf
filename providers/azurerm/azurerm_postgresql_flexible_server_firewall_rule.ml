...
let _ =
 fun (_ : azurerm_postgresql_flexible_server_firewall_rule) -> ()

let yojson_of_azurerm_postgresql_flexible_server_firewall_rule =
  (function
   | {
...
let _ = yojson_of_azurerm_postgresql_flexible_server_firewall_rule
