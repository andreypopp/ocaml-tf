...
let _ =
 fun (_ : azurerm_sentinel_alert_rule_threat_intelligence) -> ()

let yojson_of_azurerm_sentinel_alert_rule_threat_intelligence =
  (function
   | {
...
let _ = yojson_of_azurerm_sentinel_alert_rule_threat_intelligence
