...
let _ =
 fun (_ : azurerm_network_interface_nat_rule_association) -> ()

let yojson_of_azurerm_network_interface_nat_rule_association =
  (function
   | {
       id = v_id;
       ip_configuration_name = v_ip_configuration_name;
       nat_rule_id = v_nat_rule_id;
       ...
       in
       let bnds =
         let arg = yojson_of_prop yojson_of_string v_nat_rule_id in
         ("nat_rule_id", arg) :: bnds
       in
       let bnds =
         let arg =
...
let _ = yojson_of_azurerm_network_interface_nat_rule_association
