...
let _ = fun (_ : azurerm_api_management_product_group) -> ()

let yojson_of_azurerm_api_management_product_group =
  (function
   | {
...
let _ = yojson_of_azurerm_api_management_product_group
...
let make ?id ?timeouts ~api_management_name ~group_name ~product_id
    ~resource_group_name __id =
  let __type = "azurerm_api_management_product_group" in
  let __attrs =
    ({
       tf_name = __id;
       api_management_name =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_azurerm_api_management_product_group
...
let register ?tf_module ?id ?timeouts ~api_management_name
    ~group_name ~product_id ~resource_group_name __id =
  let (r : _ Tf_core.resource) =
    make ?id ?timeouts ~api_management_name ~group_name ~product_id
      ~resource_group_name __id
  in
