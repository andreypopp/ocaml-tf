...
let _ =
 fun (_ : azurerm_nat_gateway_public_ip_prefix_association) -> ()

let yojson_of_azurerm_nat_gateway_public_ip_prefix_association =
  (function
   | {
       id = v_id;
...
let _ = yojson_of_azurerm_nat_gateway_public_ip_prefix_association
