...
type azurerm_data_factory_linked_service_azure_file_storage = {
  ...
  file_share : string prop option; [@option]
...
let _ =
 fun (_ : azurerm_data_factory_linked_service_azure_file_storage) ->
  ()

let yojson_of_azurerm_data_factory_linked_service_azure_file_storage
    =
  (function
   | {
       ...
       in
       let bnds =
         match v_file_share with
         | Ppx_yojson_conv_lib.Option.None -> bnds
         | Ppx_yojson_conv_lib.Option.Some v ->
             let arg = yojson_of_prop yojson_of_string v in
             let bnd = "file_share", arg in
             bnd :: bnds
       in
       let bnds =
