...
let _ = fun (_ : azurerm_subscription_cost_management_export) -> ()

let yojson_of_azurerm_subscription_cost_management_export =
  (function
   | {
       active = v_active;
       id = v_id;
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_export_data_storage_location then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_export_data_options then bnds
         else
           let arg =
...
let _ = yojson_of_azurerm_subscription_cost_management_export
...
let make ?active ?id ?timeouts ~name ~recurrence_period_end_date
    ~recurrence_period_start_date ~recurrence_type ~subscription_id
    ~export_data_options ~export_data_storage_location __id =
  let __type = "azurerm_subscription_cost_management_export" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_azurerm_subscription_cost_management_export
        (azurerm_subscription_cost_management_export ?active ?id
           ?timeouts ~name ~recurrence_period_end_date
           ~recurrence_period_start_date ~recurrence_type
           ~subscription_id ~export_data_options
           ~export_data_storage_location ());
    attrs = __attrs;
  }
