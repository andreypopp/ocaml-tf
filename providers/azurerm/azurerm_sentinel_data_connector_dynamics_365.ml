...
let _ = fun (_ : azurerm_sentinel_data_connector_dynamics_365) -> ()

let yojson_of_azurerm_sentinel_data_connector_dynamics_365 =
  (function
   | {
       id = v_id;
...
let _ = yojson_of_azurerm_sentinel_data_connector_dynamics_365
...
let make ?id ?tenant_id ?timeouts ~log_analytics_workspace_id ~name
    __id =
  let __type = "azurerm_sentinel_data_connector_dynamics_365" in
  let __attrs =
    ({
  ...
  in
  {
    ...
    json =
      yojson_of_azurerm_sentinel_data_connector_dynamics_365
        (azurerm_sentinel_data_connector_dynamics_365 ?id ?tenant_id
           ?timeouts ~log_analytics_workspace_id ~name ());
    attrs = __attrs;
  }
