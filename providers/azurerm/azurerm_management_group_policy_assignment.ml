...
let _ = fun (_ : azurerm_management_group_policy_assignment) -> ()

let yojson_of_azurerm_management_group_policy_assignment =
  (function
   | {
...
let _ = yojson_of_azurerm_management_group_policy_assignment
