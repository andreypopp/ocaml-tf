...
let _ = fun (_ : azurerm_express_route_port_authorization) -> ()

let yojson_of_azurerm_express_route_port_authorization =
  (function
   | {
       express_route_port_name = v_express_route_port_name;
       id = v_id;
       name = v_name;
       ...
       let bnds =
         let arg =
           yojson_of_prop yojson_of_string v_express_route_port_name
         in
         ("express_route_port_name", arg) :: bnds
       in
       `Assoc bnds
    : azurerm_express_route_port_authorization ->
      Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_azurerm_express_route_port_authorization
