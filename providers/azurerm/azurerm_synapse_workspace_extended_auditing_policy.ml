...
let _ =
 fun (_ : azurerm_synapse_workspace_extended_auditing_policy) -> ()

let yojson_of_azurerm_synapse_workspace_extended_auditing_policy =
  (function
   | {
       id = v_id;
...
let _ = yojson_of_azurerm_synapse_workspace_extended_auditing_policy
