...
let _ = fun (_ : google_secret_manager_secret_iam_binding) -> ()

let yojson_of_google_secret_manager_secret_iam_binding =
  (function
   | {
       id = v_id;
       members = v_members;
...
let _ = yojson_of_google_secret_manager_secret_iam_binding
