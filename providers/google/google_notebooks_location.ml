...
let _ = fun (_ : google_notebooks_location) -> ()

let yojson_of_google_notebooks_location =
  (function
   | {
       id = v_id;
       name = v_name;
       ...
       in
       `Assoc bnds
    : google_notebooks_location -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_google_notebooks_location
