...
let _ =
 fun (_ : google_access_context_manager_access_policy_iam_member) ->
  ()

let yojson_of_google_access_context_manager_access_policy_iam_member
    =
  (function
   | {
       id = v_id;
...
let make ?id ~member ~name ~role ~condition __id =
  let __type =
    "google_access_context_manager_access_policy_iam_member"
  in
  let __attrs =
...
let register ?tf_module ?id ~member ~name ~role ~condition __id =
  let (r : _ Tf_core.resource) =
    make ?id ~member ~name ~role ~condition __id
  in
