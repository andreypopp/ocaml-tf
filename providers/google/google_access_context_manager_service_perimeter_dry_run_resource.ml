...
type google_access_context_manager_service_perimeter_dry_run_resource = {
...
let yojson_of_google_access_context_manager_service_perimeter_dry_run_resource
    =
  (function
   | {
       id = v_id;
...
let _ =
  yojson_of_google_access_context_manager_service_perimeter_dry_run_resource

[@@@deriving.end]

let timeouts ?create ?delete () : timeouts = { create; delete }

let google_access_context_manager_service_perimeter_dry_run_resource
    ?id ?timeouts ~perimeter_name ~resource () :
    google_access_context_manager_service_perimeter_dry_run_resource
    =
