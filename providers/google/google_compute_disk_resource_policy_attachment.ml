...
let _ =
 fun (_ : google_compute_disk_resource_policy_attachment) -> ()

let yojson_of_google_compute_disk_resource_policy_attachment =
  (function
   | {
       disk = v_disk;
       id = v_id;
...
let _ = yojson_of_google_compute_disk_resource_policy_attachment
