...
let _ = fun (_ : google_healthcare_dataset_iam_binding) -> ()

let yojson_of_google_healthcare_dataset_iam_binding =
  (function
   | {
...
let _ = yojson_of_google_healthcare_dataset_iam_binding
