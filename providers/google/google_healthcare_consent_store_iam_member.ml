...
let _ = fun (_ : google_healthcare_consent_store_iam_member) -> ()

let yojson_of_google_healthcare_consent_store_iam_member =
  (function
   | {
...
let _ = yojson_of_google_healthcare_consent_store_iam_member
