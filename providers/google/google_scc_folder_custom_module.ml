...
let _ = fun (_ : google_scc_folder_custom_module) -> ()

let yojson_of_google_scc_folder_custom_module =
  (function
   | {
...
let _ = yojson_of_google_scc_folder_custom_module
...
let google_scc_folder_custom_module ?id ?timeouts ~display_name
    ~enablement_state ~folder ~custom_config () :
    google_scc_folder_custom_module =
  {
    display_name;
    enablement_state;
...
let make ?id ?timeouts ~display_name ~enablement_state ~folder
    ~custom_config __id =
  let __type = "google_scc_folder_custom_module" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_google_scc_folder_custom_module
        (google_scc_folder_custom_module ?id ?timeouts ~display_name
           ~enablement_state ~folder ~custom_config ());
    attrs = __attrs;
  }

let register ?tf_module ?id ?timeouts ~display_name ~enablement_state
    ~folder ~custom_config __id =
  let (r : _ Tf_core.resource) =
    make ?id ?timeouts ~display_name ~enablement_state ~folder
      ~custom_config __id
  in
