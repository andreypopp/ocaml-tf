...
let _ =
 fun (_ : google_secure_source_manager_instance_iam_member) -> ()

let yojson_of_google_secure_source_manager_instance_iam_member =
  (function
   | {
       id = v_id;
...
let _ = yojson_of_google_secure_source_manager_instance_iam_member
