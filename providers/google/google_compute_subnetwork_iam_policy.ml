...
let make ?id ?project ?region ~policy_data ~subnetwork __id =
...
let register ?tf_module ?id ?project ?region ~policy_data ~subnetwork
    __id =
  let (r : _ Tf_core.resource) =
    make ?id ?project ?region ~policy_data ~subnetwork __id
  in
