...
let _ = fun (_ : google_cloud_run_v2_service_iam_member) -> ()

let yojson_of_google_cloud_run_v2_service_iam_member =
  (function
   | {
       id = v_id;
       location = v_location;
...
let _ = yojson_of_google_cloud_run_v2_service_iam_member
