...
let _ = fun (_ : google_data_fusion_instance_iam_policy) -> ()

let yojson_of_google_data_fusion_instance_iam_policy =
  (function
   | {
       id = v_id;
       name = v_name;
...
let _ = yojson_of_google_data_fusion_instance_iam_policy
