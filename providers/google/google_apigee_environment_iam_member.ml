...
let _ = fun (_ : google_apigee_environment_iam_member) -> ()

let yojson_of_google_apigee_environment_iam_member =
  (function
   | {
       env_id = v_env_id;
       id = v_id;
...
let _ = yojson_of_google_apigee_environment_iam_member
