...
let _ = fun (_ : google_organization_policy) -> ()

let yojson_of_google_organization_policy =
  (function
   | {
       ...
       in
       `Assoc bnds
    : google_organization_policy -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_google_organization_policy
