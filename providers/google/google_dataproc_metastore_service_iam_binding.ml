...
let _ = fun (_ : google_dataproc_metastore_service_iam_binding) -> ()

let yojson_of_google_dataproc_metastore_service_iam_binding =
  (function
   | {
       id = v_id;
       location = v_location;
...
let _ = yojson_of_google_dataproc_metastore_service_iam_binding
