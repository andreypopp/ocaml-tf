...
let _ = fun (_ : google_gke_backup_backup_plan_iam_binding) -> ()

let yojson_of_google_gke_backup_backup_plan_iam_binding =
  (function
   | {
       id = v_id;
       location = v_location;
...
let _ = yojson_of_google_gke_backup_backup_plan_iam_binding
...
let make ?id ?location ?project ?(condition = []) ~members ~name
    ~role __id =
  let __type = "google_gke_backup_backup_plan_iam_binding" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_google_gke_backup_backup_plan_iam_binding
        (google_gke_backup_backup_plan_iam_binding ?id ?location
