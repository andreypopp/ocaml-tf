...
let _ =
 fun (_ : google_network_security_address_group_iam_member) -> ()

let yojson_of_google_network_security_address_group_iam_member =
  (function
   | {
       id = v_id;
       location = v_location;
...
let _ = yojson_of_google_network_security_address_group_iam_member
...
let make ?id ?location ?project ?(condition = []) ~member ~name ~role
    __id =
  let __type = "google_network_security_address_group_iam_member" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    json =
      yojson_of_google_network_security_address_group_iam_member
        (google_network_security_address_group_iam_member ?id
