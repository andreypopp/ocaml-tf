   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_encryption_key_value then bnds
           ...
           in
           let bnd = "encryption_key_value", arg in
           bnd :: bnds
       in
       let bnds =
   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_ssh_client_cert_pass then bnds
           ...
           in
           let bnd = "ssh_client_cert_pass", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_ssh_client_cert then bnds
           ...
           let arg =
             (yojson_of_list
               ...
               v_ssh_client_cert
           in
           let bnd = "ssh_client_cert", arg in
           bnd :: bnds
       in
       let bnds =
   ...
   | {
         ...
         if Stdlib.( = ) [] v_oauth2_jwt_bearer then bnds
           ...
           let arg =
             (yojson_of_list yojson_of_auth_config__oauth2_jwt_bearer)
               v_oauth2_jwt_bearer
           in
           let bnd = "oauth2_jwt_bearer", arg in
           bnd :: bnds
       in
       let bnds =
       ...
       let bnds =
         if Stdlib.( = ) [] v_oauth2_auth_code_flow then bnds
           ...
           in
           let bnd = "oauth2_auth_code_flow", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_additional_variable then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_auth_config__additional_variable)
               v_additional_variable
           in
           let bnd = "additional_variable", arg in
           bnd :: bnds
       in
       let bnds =
   ...
   | { key = v_key; destination = v_destination } ->
       ...
       let bnds =
         if Stdlib.( = ) [] v_destination then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_destination_config__destination)
               v_destination
           in
         ...
         if Stdlib.( = ) [] v_registration_destination_config then
           ...
           let arg =
             (yojson_of_list
               ...
               v_registration_destination_config
           in
           let bnd = "registration_destination_config", arg in
           bnd :: bnds
       in
       let bnds =
   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_private_server_certificate then bnds
           ...
           in
           let bnd = "private_server_certificate", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_client_private_key_pass then bnds
           ...
           in
           let bnd = "client_private_key_pass", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_client_private_key then bnds
           ...
           in
           let bnd = "client_private_key", arg in
           bnd :: bnds
       in
       let bnds =
       ...
       let bnds =
         if Stdlib.( = ) [] v_additional_variable then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_ssl_config__additional_variable)
               v_additional_variable
           in
           let bnd = "additional_variable", arg in
           bnd :: bnds
         ...
         if Stdlib.( = ) [] v_eventing_config then bnds
           ...
           let arg =
             (yojson_of_list yojson_of_eventing_config)
               v_eventing_config
           in
           let bnd = "eventing_config", arg in
           bnd :: bnds
       in
       let bnds =
         ...
         if Stdlib.( = ) [] v_config_variable then bnds
           ...
           let arg =
             (yojson_of_list yojson_of_config_variable)
               v_config_variable
           in
           let bnd = "config_variable", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_auth_config then bnds
