...
type google_scc_management_project_security_health_analytics_custom_module = {
...
let yojson_of_google_scc_management_project_security_health_analytics_custom_module
    =
  (function
   | {
...
let _ =
  yojson_of_google_scc_management_project_security_health_analytics_custom_module
...
let google_scc_management_project_security_health_analytics_custom_module
    ?display_name ?enablement_state ?id ?location ?project
...
let make ?display_name ?enablement_state ?id ?location ?project
    ?(custom_config = []) ?timeouts __id =
  let __type =
    "google_scc_management_project_security_health_analytics_custom_module"
  in
  let __attrs =
...
let register ?tf_module ?display_name ?enablement_state ?id ?location
    ?project ?(custom_config = []) ?timeouts __id =
  let (r : _ Tf_core.resource) =
    make ?display_name ?enablement_state ?id ?location ?project
      ~custom_config ?timeouts __id
  in
