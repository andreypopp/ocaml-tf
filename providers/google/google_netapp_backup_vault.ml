...
let _ = fun (_ : google_netapp_backup_vault) -> ()

let yojson_of_google_netapp_backup_vault =
  (function
   | {
       ...
       in
       `Assoc bnds
    : google_netapp_backup_vault -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_google_netapp_backup_vault
