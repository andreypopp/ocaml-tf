...
let _ = fun (_ : google_privateca_ca_pool_iam_binding) -> ()

let yojson_of_google_privateca_ca_pool_iam_binding =
  (function
   | {
       ca_pool = v_ca_pool;
       id = v_id;
...
let _ = yojson_of_google_privateca_ca_pool_iam_binding
