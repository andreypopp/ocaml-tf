...
let _ =
 fun (_ : google_dataproc_autoscaling_policy_iam_binding) -> ()

let yojson_of_google_dataproc_autoscaling_policy_iam_binding =
  (function
   | {
       id = v_id;
       location = v_location;
...
let _ = yojson_of_google_dataproc_autoscaling_policy_iam_binding
