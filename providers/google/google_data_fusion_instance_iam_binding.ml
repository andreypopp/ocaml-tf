...
let _ = fun (_ : google_data_fusion_instance_iam_binding) -> ()

let yojson_of_google_data_fusion_instance_iam_binding =
  (function
   | {
       id = v_id;
       members = v_members;
...
let _ = yojson_of_google_data_fusion_instance_iam_binding
