...
let _ = fun (_ : google_clouddeploy_target_iam_policy) -> ()

let yojson_of_google_clouddeploy_target_iam_policy =
  (function
   | {
       id = v_id;
       location = v_location;
...
let _ = yojson_of_google_clouddeploy_target_iam_policy
