...
let _ = fun (_ : google_tags_tag_binding) -> ()

let yojson_of_google_tags_tag_binding =
  (function
   | {
       id = v_id;
       parent = v_parent;
       ...
       in
       `Assoc bnds
    : google_tags_tag_binding -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_google_tags_tag_binding
