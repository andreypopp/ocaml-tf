...
let yojson_of_cluster_config__auxiliary_node_groups__node_group =
  (function
   | { roles = v_roles; node_group_config = v_node_group_config } ->
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_node_group_config then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_cluster_config__auxiliary_node_groups__node_group__node_group_config)
               v_node_group_config
           in
           let bnd = "node_group_config", arg in
           bnd :: bnds
       in
       let bnds =
  ...
  (function
   | { node_group_id = v_node_group_id; node_group = v_node_group }
     ->
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_node_group then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_cluster_config__preemptible_worker_config__instance_flexibility_policy
  ...
  (function
   | { instance_selection_list = v_instance_selection_list } ->
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_instance_selection_list then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_cluster_config__preemptible_worker_config__instance_flexibility_policy__instance_selection_list)
           ...
           in
           let bnd = "instance_selection_list", arg in
           bnd :: bnds
       in
       `Assoc bnds
    : cluster_config__preemptible_worker_config__instance_flexibility_policy ->
...
let yojson_of_cluster_config__preemptible_worker_config =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_instance_flexibility_policy then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_cluster_config__preemptible_worker_config__instance_flexibility_policy)
           ...
           in
           let bnd = "instance_flexibility_policy", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_disk_config then bnds
   ...
   | {
       ...
       let bnds =
         if Stdlib.( = ) [] v_software_config then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_cluster_config__software_config)
               v_software_config
           in
       ...
       let bnds =
         if Stdlib.( = ) [] v_security_config then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_cluster_config__security_config)
               v_security_config
           in
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_preemptible_worker_config then bnds
         else
           let arg =
             (yojson_of_list
           ...
           in
           let bnd = "preemptible_worker_config", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_metastore_config then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_cluster_config__metastore_config)
               v_metastore_config
           in
           let bnd = "metastore_config", arg in
           bnd :: bnds
       in
       let bnds =
       ...
       let bnds =
         if Stdlib.( = ) [] v_lifecycle_config then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_cluster_config__lifecycle_config)
               v_lifecycle_config
           in
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_initialization_action then bnds
         else
           let arg =
             (yojson_of_list
           ...
           in
           let bnd = "initialization_action", arg in
           bnd :: bnds
       in
       let bnds =
       ...
       let bnds =
         if Stdlib.( = ) [] v_endpoint_config then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_cluster_config__endpoint_config)
               v_endpoint_config
           in
       ...
       let bnds =
         if Stdlib.( = ) [] v_encryption_config then bnds
           ...
           let arg =
             (yojson_of_list
                yojson_of_cluster_config__encryption_config)
               v_encryption_config
           in
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_dataproc_metric_config then bnds
         else
           let arg =
             (yojson_of_list
           ...
           in
           let bnd = "dataproc_metric_config", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_auxiliary_node_groups then bnds
         else
           let arg =
             (yojson_of_list
           ...
           in
           let bnd = "auxiliary_node_groups", arg in
           bnd :: bnds
       in
       let bnds =
...
let yojson_of_virtual_cluster_config__kubernetes_cluster_config__gke_cluster_config
  ...
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_node_pool_target then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_virtual_cluster_config__kubernetes_cluster_config__gke_cluster_config__node_pool_target)
               v_node_pool_target
           in
           let bnd = "node_pool_target", arg in
           bnd :: bnds
       in
       let bnds =
...
let yojson_of_virtual_cluster_config__kubernetes_cluster_config =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_kubernetes_software_config then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_virtual_cluster_config__kubernetes_cluster_config__kubernetes_software_config)
           ...
           in
           let bnd = "kubernetes_software_config", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_gke_cluster_config then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_virtual_cluster_config__kubernetes_cluster_config__gke_cluster_config)
           ...
           in
           let bnd = "gke_cluster_config", arg in
           bnd :: bnds
       in
       let bnds =
...
let yojson_of_virtual_cluster_config =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_kubernetes_cluster_config then bnds
         else
           let arg =
             (yojson_of_list
           ...
           in
           let bnd = "kubernetes_cluster_config", arg in
           bnd :: bnds
       in
       let bnds =
         if Stdlib.( = ) [] v_auxiliary_services_config then bnds
         else
           let arg =
             (yojson_of_list
           ...
           in
           let bnd = "auxiliary_services_config", arg in
           bnd :: bnds
       in
       let bnds =
         match v_staging_bucket with
...
let yojson_of_google_dataproc_cluster =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_virtual_cluster_config then bnds
         else
           let arg =
             (yojson_of_list yojson_of_virtual_cluster_config)
               v_virtual_cluster_config
           in
           let bnd = "virtual_cluster_config", arg in
           bnd :: bnds
       in
       let bnds =
