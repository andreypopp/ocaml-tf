...
let google_iap_tunnel_dest_group_iam_policy ?id ?project ?region
    ...
    google_iap_tunnel_dest_group_iam_policy =
  { dest_group; id; policy_data; project; region }
...
let make ?id ?project ?region ~dest_group ~policy_data __id =
...
let register ?tf_module ?id ?project ?region ~dest_group ~policy_data
    __id =
  let (r : _ Tf_core.resource) =
    make ?id ?project ?region ~dest_group ~policy_data __id
  in
