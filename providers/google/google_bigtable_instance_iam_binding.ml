...
let _ = fun (_ : google_bigtable_instance_iam_binding) -> ()

let yojson_of_google_bigtable_instance_iam_binding =
  (function
   | {
       id = v_id;
       instance = v_instance;
...
let _ = yojson_of_google_bigtable_instance_iam_binding
...
let google_bigtable_instance_iam_binding ?id ?project ~instance
...
let make ?id ?project ~instance ~members ~role ~condition __id =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_google_bigtable_instance_iam_binding
        (google_bigtable_instance_iam_binding ?id ?project ~instance
           ~members ~role ~condition ());
    attrs = __attrs;
  }
