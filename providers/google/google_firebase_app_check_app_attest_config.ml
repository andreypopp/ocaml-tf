...
let _ = fun (_ : google_firebase_app_check_app_attest_config) -> ()

let yojson_of_google_firebase_app_check_app_attest_config =
  (function
   | {
       app_id = v_app_id;
       id = v_id;
...
let _ = yojson_of_google_firebase_app_check_app_attest_config
