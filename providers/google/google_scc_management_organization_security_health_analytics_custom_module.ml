...
type google_scc_management_organization_security_health_analytics_custom_module = {
...
let yojson_of_google_scc_management_organization_security_health_analytics_custom_module
    =
  (function
   | {
...
let _ =
  yojson_of_google_scc_management_organization_security_health_analytics_custom_module
...
let google_scc_management_organization_security_health_analytics_custom_module
    ?display_name ?enablement_state ?id ?location
    ?(custom_config = []) ?timeouts ~organization () :
    google_scc_management_organization_security_health_analytics_custom_module
    =
  {
    display_name;
...
let make ?display_name ?enablement_state ?id ?location
    ?(custom_config = []) ?timeouts ~organization __id =
  let __type =
    "google_scc_management_organization_security_health_analytics_custom_module"
  in
  let __attrs =
