...
let _ = fun (_ : google_compute_region_disk_iam_policy) -> ()

let yojson_of_google_compute_region_disk_iam_policy =
  (function
   | {
       id = v_id;
       name = v_name;
...
let _ = yojson_of_google_compute_region_disk_iam_policy
...
let make ?id ?project ?region ~name ~policy_data __id =
  let __type = "google_compute_region_disk_iam_policy" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_google_compute_region_disk_iam_policy
        (google_compute_region_disk_iam_policy ?id ?project ?region
           ~name ~policy_data ());
    attrs = __attrs;
  }
