...
let _ = fun (_ : google_iap_app_engine_service_iam_binding) -> ()

let yojson_of_google_iap_app_engine_service_iam_binding =
  (function
   | {
       app_id = v_app_id;
       id = v_id;
...
let _ = yojson_of_google_iap_app_engine_service_iam_binding
