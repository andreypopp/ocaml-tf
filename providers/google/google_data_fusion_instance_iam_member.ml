...
let _ = fun (_ : google_data_fusion_instance_iam_member) -> ()

let yojson_of_google_data_fusion_instance_iam_member =
  (function
   | {
       id = v_id;
       member = v_member;
...
let _ = yojson_of_google_data_fusion_instance_iam_member
