...
let _ = fun (_ : google_bigtable_instance_iam_policy) -> ()

let yojson_of_google_bigtable_instance_iam_policy =
  (function
   | {
       id = v_id;
       instance = v_instance;
...
let _ = yojson_of_google_bigtable_instance_iam_policy

[@@@deriving.end]

let google_bigtable_instance_iam_policy ?id ?project ~instance
    ~policy_data () : google_bigtable_instance_iam_policy =
...
let make ?id ?project ~instance ~policy_data __id =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_google_bigtable_instance_iam_policy
        (google_bigtable_instance_iam_policy ?id ?project ~instance
           ~policy_data ());
    attrs = __attrs;
  }
