...
let yojson_of_control_plane =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_replica_placements then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_control_plane__replica_placements)
               v_replica_placements
           in
           let bnd = "replica_placements", arg in
           bnd :: bnds
       in
       let bnds =
...
let yojson_of_google_container_azure_cluster =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_azure_services_authentication then bnds
         else
           let arg =
             (yojson_of_list yojson_of_azure_services_authentication)
               v_azure_services_authentication
           in
           let bnd = "azure_services_authentication", arg in
           bnd :: bnds
       in
       let bnds =
