...
let _ = fun (_ : google_compute_firewall_policy_association) -> ()

let yojson_of_google_compute_firewall_policy_association =
  (function
   | {
...
let _ = yojson_of_google_compute_firewall_policy_association
