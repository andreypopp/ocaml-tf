...
let _ =
 fun (_ : google_privateca_certificate_template_iam_member) -> ()

let yojson_of_google_privateca_certificate_template_iam_member =
  (function
   | {
...
let _ = yojson_of_google_privateca_certificate_template_iam_member
