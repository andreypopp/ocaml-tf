...
let yojson_of_inspect_job__actions__deidentify =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_transformation_details_storage_config
         then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_transformation_config then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_inspect_job__actions__deidentify__transformation_config)
...
let yojson_of_inspect_job__actions =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_save_findings then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_publish_to_stackdriver then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_publish_summary_to_cscc then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_publish_findings_to_cloud_data_catalog
         then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_job_notification_emails then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_inspect_job__storage_config__big_query_options =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_included_fields then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_inspect_job__storage_config__big_query_options__included_fields)
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_identifying_fields then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_inspect_job__storage_config__big_query_options__identifying_fields)
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_excluded_fields then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_inspect_job__storage_config__big_query_options__excluded_fields)
...
let yojson_of_inspect_job__storage_config__cloud_storage_options__file_set
  ...
  (function
   | { url = v_url; regex_file_set = v_regex_file_set } ->
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_regex_file_set then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_inspect_job__storage_config__cloud_storage_options__file_set__regex_file_set)
...
let yojson_of_inspect_job__storage_config__cloud_storage_options =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_file_set then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_inspect_job__storage_config__cloud_storage_options__file_set)
...
let yojson_of_inspect_job__storage_config__datastore_options =
  (function
   | { kind = v_kind; partition_id = v_partition_id } ->
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_partition_id then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_inspect_job__storage_config__datastore_options__partition_id)
...
let yojson_of_inspect_job__storage_config__hybrid_options =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_table_options then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_inspect_job__storage_config__hybrid_options__table_options)
...
let yojson_of_inspect_job__storage_config__timespan_config =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_timestamp_field then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_inspect_job__storage_config__timespan_config__timestamp_field)
...
let yojson_of_inspect_job__storage_config =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_timespan_config then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_hybrid_options then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_datastore_options then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_cloud_storage_options then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_big_query_options then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_google_data_loss_prevention_job_trigger =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_inspect_job then bnds
         else
           let arg =
