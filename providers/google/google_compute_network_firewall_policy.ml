...
let _ = fun (_ : google_compute_network_firewall_policy) -> ()

let yojson_of_google_compute_network_firewall_policy =
  (function
   | {
...
let _ = yojson_of_google_compute_network_firewall_policy
