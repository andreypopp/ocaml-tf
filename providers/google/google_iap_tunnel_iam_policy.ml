...
let _ = fun (_ : google_iap_tunnel_iam_policy) -> ()

let yojson_of_google_iap_tunnel_iam_policy =
  (function
   | { id = v_id; policy_data = v_policy_data; project = v_project }
     ->
...
let _ = yojson_of_google_iap_tunnel_iam_policy
...
let make ?id ?project ~policy_data __id =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_google_iap_tunnel_iam_policy
        (google_iap_tunnel_iam_policy ?id ?project ~policy_data ());
    attrs = __attrs;
  }
