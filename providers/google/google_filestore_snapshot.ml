...
let _ = fun (_ : google_filestore_snapshot) -> ()

let yojson_of_google_filestore_snapshot =
  (function
   | {
       ...
       in
       `Assoc bnds
    : google_filestore_snapshot -> Ppx_yojson_conv_lib.Yojson.Safe.t)

let _ = yojson_of_google_filestore_snapshot
