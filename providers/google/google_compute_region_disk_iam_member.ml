...
let _ = fun (_ : google_compute_region_disk_iam_member) -> ()

let yojson_of_google_compute_region_disk_iam_member =
  (function
   | {
       id = v_id;
       member = v_member;
...
let _ = yojson_of_google_compute_region_disk_iam_member
...
let make ?id ?project ?region ~member ~name ~role ~condition __id =
  let __type = "google_compute_region_disk_iam_member" in
  let __attrs =
    ({
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_google_compute_region_disk_iam_member
        (google_compute_region_disk_iam_member ?id ?project ?region
           ~member ~name ~role ~condition ());
    attrs = __attrs;
  }
