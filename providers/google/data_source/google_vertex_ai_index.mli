...
type metadata__config__algorithm_config = {
  brute_force_config: metadata__config__algorithm_config__brute_force_config list; [@default []] [@yojson_drop_default Stdlib.( = )] (** brute_force_config *)
  tree_ah_config: metadata__config__algorithm_config__tree_ah_config list; [@default []] [@yojson_drop_default Stdlib.( = )] (** tree_ah_config *)
}
type metadata__config = {
  algorithm_config: metadata__config__algorithm_config list; [@default []] [@yojson_drop_default Stdlib.( = )] (** algorithm_config *)
...
type metadata = {
  config: metadata__config list; [@default []] [@yojson_drop_default Stdlib.( = )] (** config *)
