...
type template__spec__volumes__secret = {
  ...
  items : template__spec__volumes__secret__items list;  (** items *)
  secret_name : string prop;  (** secret_name *)
}

type template__spec__volumes = {
  name : string prop;  (** name *)
  secret : template__spec__volumes__secret list;  (** secret *)
}
...
type template__spec__containers = {
  ...
  env : template__spec__containers__env list;  (** env *)
  ...
  liveness_probe : template__spec__containers__liveness_probe list;
      (** liveness_probe *)
  name : string prop;  (** name *)
  ports : template__spec__containers__ports list;  (** ports *)
...
type template__spec = {
  ...
  containers : template__spec__containers list;  (** containers *)
  service_account_name : string prop;  (** service_account_name *)
  serving_state : string prop;  (** serving_state *)
  timeout_seconds : float prop;  (** timeout_seconds *)
  volumes : template__spec__volumes list;  (** volumes *)
}
...
type template = {
  metadata : template__metadata list;  (** metadata *)
  spec : template__spec list;  (** spec *)
}
