...
let _ = fun (_ : google_data_catalog_taxonomy_iam_policy) -> ()

let yojson_of_google_data_catalog_taxonomy_iam_policy =
  (function
   | {
       id = v_id;
       project = v_project;
...
let _ = yojson_of_google_data_catalog_taxonomy_iam_policy

[@@@deriving.end]

let google_data_catalog_taxonomy_iam_policy ?id ?project ?region
    ~taxonomy () : google_data_catalog_taxonomy_iam_policy =
...
let make ?id ?project ?region ~taxonomy __id =
...
let register ?tf_module ?id ?project ?region ~taxonomy __id =
  let (r : _ Tf_core.resource) =
    make ?id ?project ?region ~taxonomy __id
  in
