...
let _ = fun (_ : google_compute_network_endpoint_group) -> ()

let yojson_of_google_compute_network_endpoint_group =
  (function
   | {
       id = v_id;
       name = v_name;
...
let _ = yojson_of_google_compute_network_endpoint_group

[@@@deriving.end]

let google_compute_network_endpoint_group ?id ?name ?project
    ?self_link ?zone () : google_compute_network_endpoint_group =
  ...
  in
  {
    ...
    json =
      yojson_of_google_compute_network_endpoint_group
        (google_compute_network_endpoint_group ?id ?name ?project
           ?self_link ?zone ());
    attrs = __attrs;
  }
