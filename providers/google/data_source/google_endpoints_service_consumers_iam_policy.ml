...
let make ?id ~consumer_project ~service_name __id =
...
let register ?tf_module ?id ~consumer_project ~service_name __id =
  let (r : _ Tf_core.resource) =
    make ?id ~consumer_project ~service_name __id
  in
