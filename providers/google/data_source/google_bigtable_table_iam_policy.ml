...
let google_bigtable_table_iam_policy ?id ?project ~instance ~table ()
    : google_bigtable_table_iam_policy =
  { id; instance; project; table }
...
let make ?id ?project ~instance ~table __id =
...
let register ?tf_module ?id ?project ~instance ~table __id =
  let (r : _ Tf_core.resource) =
    make ?id ?project ~instance ~table __id
  in
