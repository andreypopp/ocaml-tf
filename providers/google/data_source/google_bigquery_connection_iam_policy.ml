...
let google_bigquery_connection_iam_policy ?id ?location ?project
    ~connection_id () : google_bigquery_connection_iam_policy =
  { connection_id; id; location; project }
...
let make ?id ?location ?project ~connection_id __id =
...
let register ?tf_module ?id ?location ?project ~connection_id __id =
  let (r : _ Tf_core.resource) =
    make ?id ?location ?project ~connection_id __id
  in
