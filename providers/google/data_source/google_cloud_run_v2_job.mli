...
type template__template__volumes = {
  cloud_sql_instance :
    template__template__volumes__cloud_sql_instance list;
      (** cloud_sql_instance *)
  name : string prop;  (** name *)
  secret : template__template__volumes__secret list;  (** secret *)
}
...
type template__template__containers = {
  ...
  env : template__template__containers__env list;  (** env *)
  image : string prop;  (** image *)
  name : string prop;  (** name *)
  ports : template__template__containers__ports list;  (** ports *)
...
type template__template = {
  ...
  volumes : template__template__volumes list;  (** volumes *)
  vpc_access : template__template__vpc_access list;  (** vpc_access *)
}
...
type template = {
  ...
  template : template__template list;  (** template *)
}
