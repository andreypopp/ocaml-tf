...
let google_data_catalog_entry_group_iam_policy ?id ?project ?region
    ~entry_group () : google_data_catalog_entry_group_iam_policy =
...
let make ?id ?project ?region ~entry_group __id =
...
let register ?tf_module ?id ?project ?region ~entry_group __id =
  let (r : _ Tf_core.resource) =
    make ?id ?project ?region ~entry_group __id
  in
