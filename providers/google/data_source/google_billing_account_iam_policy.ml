...
let _ = fun (_ : google_billing_account_iam_policy) -> ()

let yojson_of_google_billing_account_iam_policy =
  (function
   | { billing_account_id = v_billing_account_id; id = v_id } ->
...
let _ = yojson_of_google_billing_account_iam_policy
...
let make ?id ~billing_account_id __id =
...
let register ?tf_module ?id ~billing_account_id __id =
  let (r : _ Tf_core.resource) = make ?id ~billing_account_id __id in
