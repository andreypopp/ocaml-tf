...
let yojson_of_google_sourcerepo_repository_iam_policy =
  (function
   | { id = v_id; project = v_project; repository = v_repository } ->
...
let google_sourcerepo_repository_iam_policy ?id ?project ~repository
    () : google_sourcerepo_repository_iam_policy =
...
let make ?id ?project ~repository __id =
...
let register ?tf_module ?id ?project ~repository __id =
  let (r : _ Tf_core.resource) =
    make ?id ?project ~repository __id
  in
