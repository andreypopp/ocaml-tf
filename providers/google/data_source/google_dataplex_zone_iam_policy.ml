...
let google_dataplex_zone_iam_policy ?id ?location ?project
    ~dataplex_zone ~lake () : google_dataplex_zone_iam_policy =
  { dataplex_zone; id; lake; location; project }
...
let make ?id ?location ?project ~dataplex_zone ~lake __id =
...
let register ?tf_module ?id ?location ?project ~dataplex_zone ~lake
  ...
  let (r : _ Tf_core.resource) =
    make ?id ?location ?project ~dataplex_zone ~lake __id
  in
