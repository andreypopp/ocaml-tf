...
let google_iap_web_backend_service_iam_policy ?id ?project
    ~web_backend_service () :
    google_iap_web_backend_service_iam_policy =
  { id; project; web_backend_service }
...
let make ?id ?project ~web_backend_service __id =
...
let register ?tf_module ?id ?project ~web_backend_service __id =
  let (r : _ Tf_core.resource) =
    make ?id ?project ~web_backend_service __id
  in
