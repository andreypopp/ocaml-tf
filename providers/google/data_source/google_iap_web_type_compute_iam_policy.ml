...
let _ = fun (_ : google_iap_web_type_compute_iam_policy) -> ()

let yojson_of_google_iap_web_type_compute_iam_policy =
  (function
...
let _ = yojson_of_google_iap_web_type_compute_iam_policy

[@@@deriving.end]

let google_iap_web_type_compute_iam_policy ?id ?project () :
    google_iap_web_type_compute_iam_policy =
  { id; project }
