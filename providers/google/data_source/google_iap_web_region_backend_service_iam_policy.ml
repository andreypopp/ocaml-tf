...
let google_iap_web_region_backend_service_iam_policy ?id ?project
    ?region ~web_region_backend_service () :
    google_iap_web_region_backend_service_iam_policy =
  { id; project; region; web_region_backend_service }
...
let make ?id ?project ?region ~web_region_backend_service __id =
    ...
    json =
      yojson_of_google_iap_web_region_backend_service_iam_policy
        (google_iap_web_region_backend_service_iam_policy ?id
           ?project ?region ~web_region_backend_service ());
    attrs = __attrs;
  }
...
let register ?tf_module ?id ?project ?region
  ...
  let (r : _ Tf_core.resource) =
    make ?id ?project ?region ~web_region_backend_service __id
  in
