...
let _ =
 fun (_ : google_bigquery_datapolicy_data_policy_iam_policy) -> ()

let yojson_of_google_bigquery_datapolicy_data_policy_iam_policy =
  (function
   | {
...
let _ = yojson_of_google_bigquery_datapolicy_data_policy_iam_policy

[@@@deriving.end]

let google_bigquery_datapolicy_data_policy_iam_policy ?id ?location
    ?project ~data_policy_id () :
    google_bigquery_datapolicy_data_policy_iam_policy =
...
let make ?id ?location ?project ~data_policy_id __id =
    ...
    json =
      yojson_of_google_bigquery_datapolicy_data_policy_iam_policy
        (google_bigquery_datapolicy_data_policy_iam_policy ?id
           ?location ?project ~data_policy_id ());
    attrs = __attrs;
  }

let register ?tf_module ?id ?location ?project ~data_policy_id __id =
  let (r : _ Tf_core.resource) =
    make ?id ?location ?project ~data_policy_id __id
  in
