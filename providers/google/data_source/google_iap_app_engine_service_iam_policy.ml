...
let _ = fun (_ : google_iap_app_engine_service_iam_policy) -> ()

let yojson_of_google_iap_app_engine_service_iam_policy =
  (function
   | {
       app_id = v_app_id;
       id = v_id;
...
let _ = yojson_of_google_iap_app_engine_service_iam_policy

[@@@deriving.end]

let google_iap_app_engine_service_iam_policy ?id ?project ~app_id
    ~service () : google_iap_app_engine_service_iam_policy =
  { app_id; id; project; service }
...
let make ?id ?project ~app_id ~service __id =
...
let register ?tf_module ?id ?project ~app_id ~service __id =
  let (r : _ Tf_core.resource) =
    make ?id ?project ~app_id ~service __id
  in
