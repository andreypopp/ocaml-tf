...
let _ = fun (_ : google_sourcerepo_repository_iam_binding) -> ()

let yojson_of_google_sourcerepo_repository_iam_binding =
  (function
   | {
       id = v_id;
       members = v_members;
...
let _ = yojson_of_google_sourcerepo_repository_iam_binding
