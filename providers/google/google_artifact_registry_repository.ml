...
let yojson_of_google_artifact_registry_repository =
  (function
   | {
       ...
       in
       let bnds =
         if [] = v_virtual_repository_config then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_remote_repository_config then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_cleanup_policies then bnds
         else
           let arg =
