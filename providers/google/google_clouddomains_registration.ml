...
let yojson_of_contact_settings__admin_contact =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_postal_address then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_contact_settings =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_technical_contact then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_dns_settings__custom_dns =
  (function
   | { name_servers = v_name_servers; ds_records = v_ds_records } ->
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_ds_records then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_dns_settings =
  (function
   | { custom_dns = v_custom_dns; glue_records = v_glue_records } ->
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_glue_records then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_custom_dns then bnds
         else
           let arg =
...
let yojson_of_google_clouddomains_registration =
  (function
   | {
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_yearly_price then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_management_settings then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if Stdlib.( = ) [] v_contact_settings then bnds
         else
           let arg =
