...
let _ = fun (_ : google_iap_web_type_compute_iam_member) -> ()

let yojson_of_google_iap_web_type_compute_iam_member =
  (function
   | {
       id = v_id;
       member = v_member;
...
let _ = yojson_of_google_iap_web_type_compute_iam_member
...
let google_iap_web_type_compute_iam_member ?id ?project ~member ~role
    ~condition () : google_iap_web_type_compute_iam_member =
...
let make ?id ?project ~member ~role ~condition __id =
  let __type = "google_iap_web_type_compute_iam_member" in
  let __attrs =
    ({
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_google_iap_web_type_compute_iam_member
        (google_iap_web_type_compute_iam_member ?id ?project ~member
           ~role ~condition ());
    attrs = __attrs;
  }
