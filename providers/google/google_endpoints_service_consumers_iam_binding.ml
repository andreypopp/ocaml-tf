...
let _ =
 fun (_ : google_endpoints_service_consumers_iam_binding) -> ()

let yojson_of_google_endpoints_service_consumers_iam_binding =
  (function
   | {
...
let _ = yojson_of_google_endpoints_service_consumers_iam_binding
