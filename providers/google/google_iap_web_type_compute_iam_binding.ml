...
let _ = fun (_ : google_iap_web_type_compute_iam_binding) -> ()

let yojson_of_google_iap_web_type_compute_iam_binding =
  (function
   | {
       id = v_id;
       members = v_members;
...
let _ = yojson_of_google_iap_web_type_compute_iam_binding
