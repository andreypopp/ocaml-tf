...
let yojson_of_addons_config =
  (function
   | {
       ...
       in
       let bnds =
         if [] = v_network_policy_config then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if [] = v_http_load_balancing then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if [] = v_horizontal_pod_autoscaling then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if [] = v_gke_backup_agent_config then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if [] = v_gcs_fuse_csi_driver_config then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if [] = v_gcp_filestore_csi_driver_config then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if [] = v_gce_persistent_disk_csi_driver_config then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_addons_config__gce_persistent_disk_csi_driver_config)
       ...
       in
       let bnds =
         if [] = v_dns_cache_config then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if [] = v_config_connector_config then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if [] = v_cloudrun_config then bnds
         else
           let arg =
...
let yojson_of_cluster_autoscaling =
  (function
   | {
       ...
       in
       let bnds =
         if [] = v_resource_limits then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if [] = v_auto_provisioning_defaults then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_ip_allocation_policy__additional_pod_ranges_config =
  (function
   | { pod_range_names = v_pod_range_names } ->
       ...
       in
       let bnds =
         if [] = v_pod_range_names then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
               v_pod_range_names
...
let yojson_of_ip_allocation_policy =
  (function
   | {
       ...
       in
       let bnds =
         if [] = v_additional_pod_ranges_config then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_logging_config =
  (function
   | { enable_components = v_enable_components } ->
       ...
       in
       let bnds =
         if [] = v_enable_components then bnds
         else
           let arg =
             (yojson_of_list (yojson_of_prop yojson_of_string))
               v_enable_components
...
let yojson_of_maintenance_policy__maintenance_exclusion =
  (function
   | {
       ...
       in
       let bnds =
         if [] = v_exclusion_options then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_maintenance_policy__maintenance_exclusion__exclusion_options)
...
let yojson_of_maintenance_policy =
  (function
   | {
       ...
       in
       let bnds =
         if [] = v_maintenance_exclusion then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if [] = v_daily_maintenance_window then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_master_auth =
  (function
   | { client_certificate_config = v_client_certificate_config } ->
       ...
       in
       let bnds =
         if [] = v_client_certificate_config then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_monitoring_config =
  (function
   | {
       ...
       in
       let bnds =
         if [] = v_managed_prometheus then bnds
         else
           let arg =
             (yojson_of_list
       ...
       in
       let bnds =
         if [] = v_advanced_datapath_observability_config then bnds
         else
           let arg =
             (yojson_of_list
                yojson_of_monitoring_config__advanced_datapath_observability_config)
...
let yojson_of_node_pool_defaults =
  (function
   | { node_config_defaults = v_node_config_defaults } ->
       ...
       in
       let bnds =
         if [] = v_node_config_defaults then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_private_cluster_config =
  (function
   | {
       ...
       in
       let bnds =
         if [] = v_master_global_access_config then bnds
         else
           let arg =
             (yojson_of_list
...
let yojson_of_google_container_cluster =
  (function
   | {
       ...
       in
       let bnds =
         if [] = v_workload_identity_config then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_vertical_pod_autoscaling then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_service_external_ips_config then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_resource_usage_export_config then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_release_channel then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_private_cluster_config then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_node_pool_defaults then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_node_pool_auto_config then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_mesh_certificates then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_ip_allocation_policy then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_identity_service_config then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_gateway_api_config then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_enable_k8s_beta_apis then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_default_snat_status then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_cost_management_config then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_cluster_autoscaling then bnds
         else
           let arg =
       ...
       in
       let bnds =
         if [] = v_authenticator_groups_config then bnds
         else
           let arg =
