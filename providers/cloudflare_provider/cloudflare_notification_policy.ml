...
type cloudflare_notification_policy__filters = {
  ...
  affected_components : string list option; [@option]
  ...
  alert_trigger_preferences : string list option; [@option]
      (** Alert trigger preferences. Example: `slo`. *)
  enabled : string list option; [@option]
      (** State of the pool to alert on. *)
  environment : string list option; [@option]
      (** Environment of pages. Available values: `ENVIRONMENT_PREVIEW`, `ENVIRONMENT_PRODUCTION`. *)
  event : string list option; [@option]
      (** Pages event to alert. Available values: `EVENT_DEPLOYMENT_STARTED`, `EVENT_DEPLOYMENT_FAILED`, `EVENT_DEPLOYMENT_SUCCESS`. *)
  event_source : string list option; [@option]
      (** Source configuration to alert on for pool or origin. *)
  event_type : string list option; [@option]
      (** Stream event type to alert on. *)
  group_by : string list option; [@option]  (** Alert grouping. *)
  health_check_id : string list option; [@option]
      (** Identifier health check. Required when using `filters.0.status`. *)
  incident_impact : string list option; [@option]
  ...
  input_id : string list option; [@option]
      (** Stream input id to alert on. *)
  limit : string list option; [@option]
      (** A numerical limit. Example: `100`. *)
  megabits_per_second : string list option; [@option]
      (** Megabits per second threshold for dos alert. *)
  new_health : string list option; [@option]
      (** Health status to alert on for pool or origin. *)
  new_status : string list option; [@option]
      (** Tunnel health status to alert on. *)
  packets_per_second : string list option; [@option]
      (** Packets per second threshold for dos alert. *)
  pool_id : string list option; [@option]
      (** Load balancer pool identifier. *)
  product : string list option; [@option]
      (** Product name. Available values: `worker_requests`, `worker_durable_objects_requests`, `worker_durable_objects_duration`, `worker_durable_objects_data_transfer`, `worker_durable_objects_stored_data`, `worker_durable_objects_storage_deletes`, `worker_durable_objects_storage_writes`, `worker_durable_objects_storage_reads`. *)
  project_id : string list option; [@option]
      (** Identifier of pages project. *)
  protocol : string list option; [@option]
      (** Protocol to alert on for dos. *)
  requests_per_second : string list option; [@option]
      (** Requests per second threshold for dos alert. *)
  selectors : string list option; [@option]
      (** Selectors for alert. Valid options depend on the alert type. *)
  services : string list option; [@option]  (** services *)
  slo : string list option; [@option]
      (** A numerical limit. Example: `99.9`. *)
  status : string list option; [@option]  (** Status to alert on. *)
  target_hostname : string list option; [@option]
      (** Target host to alert on for dos. *)
  target_zone_name : string list option; [@option]
      (** Target domain to alert on. *)
  tunnel_id : string list option; [@option]
      (** Tunnel IDs to alert on. *)
  where : string list option; [@option]  (** Filter for alert. *)
