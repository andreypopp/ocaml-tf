...
type cloudflare_certificate_pack__validation_records = {
  cname_name : string option; [@option]  (** cname_name *)
  cname_target : string option; [@option]  (** cname_target *)
  emails : string list option; [@option]  (** emails *)
  http_body : string option; [@option]  (** http_body *)
  http_url : string option; [@option]  (** http_url *)
  txt_name : string option; [@option]  (** txt_name *)
  txt_value : string option; [@option]  (** txt_value *)
}
[@@deriving yojson_of]
...
type cloudflare_certificate_pack = {
  ...
  cloudflare_branding : bool option; [@option]
  ...
  wait_for_active_status : bool option; [@option]
