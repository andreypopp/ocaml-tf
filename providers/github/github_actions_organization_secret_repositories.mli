...
val github_actions_organization_secret_repositories :
  ?id:string prop ->
...
val yojson_of_github_actions_organization_secret_repositories :
  github_actions_organization_secret_repositories -> json
