...
type github_codespaces_organization_secret_repositories = {
...
let _ =
 fun (_ : github_codespaces_organization_secret_repositories) -> ()

let yojson_of_github_codespaces_organization_secret_repositories =
  (function
   | {
       id = v_id;
...
let _ = yojson_of_github_codespaces_organization_secret_repositories

[@@@deriving.end]

let github_codespaces_organization_secret_repositories ?id
...
let make ?id ~secret_name ~selected_repository_ids __id =
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_github_codespaces_organization_secret_repositories
        (github_codespaces_organization_secret_repositories ?id
           ~secret_name ~selected_repository_ids ());
    attrs = __attrs;
  }
