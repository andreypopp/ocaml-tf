...
let _ =
 fun (_ : github_actions_organization_secret_repositories) -> ()

let yojson_of_github_actions_organization_secret_repositories =
  (function
   | {
       id = v_id;
...
let _ = yojson_of_github_actions_organization_secret_repositories

[@@@deriving.end]

let github_actions_organization_secret_repositories ?id ~secret_name
...
let make ?id ~secret_name ~selected_repository_ids __id =
  let __type = "github_actions_organization_secret_repositories" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_github_actions_organization_secret_repositories
        (github_actions_organization_secret_repositories ?id
