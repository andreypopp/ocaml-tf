...
val github_actions_organization_secrets :
  ?id:string prop -> unit -> github_actions_organization_secrets

val yojson_of_github_actions_organization_secrets :
  github_actions_organization_secrets -> json
