...
val github_actions_organization_registration_token :
  ?id:string prop ->
  unit ->
  github_actions_organization_registration_token

val yojson_of_github_actions_organization_registration_token :
  github_actions_organization_registration_token -> json
