...
let _ = fun (_ : github_actions_environment_variables) -> ()

let yojson_of_github_actions_environment_variables =
  (function
   | {
...
let _ = yojson_of_github_actions_environment_variables

[@@@deriving.end]

let github_actions_environment_variables ?full_name ?id ?name
    ~environment () : github_actions_environment_variables =
...
let make ?full_name ?id ?name ~environment __id =
  let __type = "github_actions_environment_variables" in
  let __attrs =
    ({
       tf_name = __id;
  ...
  in
  {
    ...
    type_ = __type;
    json =
      yojson_of_github_actions_environment_variables
        (github_actions_environment_variables ?full_name ?id ?name
           ~environment ());
    attrs = __attrs;
  }
