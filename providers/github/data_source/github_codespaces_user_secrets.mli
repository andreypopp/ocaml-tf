...
val github_codespaces_user_secrets :
  ?id:string prop -> unit -> github_codespaces_user_secrets

val yojson_of_github_codespaces_user_secrets :
  github_codespaces_user_secrets -> json
